...
def _get_vectorstore_from_retriever(retriever) -> Generator[Resource, None, None]:
    ...
    if _isinstance_with_multiple_modules(
        ...
        ["databricks_langchain", "langchain_community.vectorstores", "langchain.vectorstores"],
    ):
    ...
    if _isinstance_with_multiple_modules(
        ...
        ["databricks_langchain", "langchain_community.embeddings", "langchain.embeddings"],
    ):
...
def _extract_databricks_dependencies_from_chat_model(chat_model) -> Generator[Resource, None, None]:
    if _isinstance_with_multiple_modules(
        chat_model,
        "ChatDatabricks",
        ["databricks_langchain", "langchain_databricks.chat_models", "langchain_community.chat_models"],
    ):
