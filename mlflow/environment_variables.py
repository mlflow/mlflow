...
#: Time-to-live in seconds for cached prompts in the prompt cache.
#: After this time, cached prompts will be considered stale and refreshed on next access.
#: Set to 0 to disable caching entirely.
#: (default: ``60``)
MLFLOW_PROMPT_CACHE_TTL_SECONDS = _EnvironmentVariable("MLFLOW_PROMPT_CACHE_TTL_SECONDS", int, 60)
