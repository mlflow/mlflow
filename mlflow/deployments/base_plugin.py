...
class BasePlugin(abc.ABC):
    ...
    def create(self, model_uri, flavor=None, **kwargs):
        ...
        :py:func:`deployments.create_deployment <mlflow.deployments.create_deployment>`.
    ...
    def delete(self, deployment_id, **kwargs):
        """
        This function will be called by
        :py:func:`deployments.delete_deployment <mlflow.deployments.delete_deployment>`.
    ...
    def update(self, deployment_id, model_uri=None, flavor=None, **kwargs):
        """
        This function will be called by
        :py:func:`deployments.update_deployment <mlflow.deployments.update_deployment>`.
        ...
        :param kwargs: The keyword arguments either parsed from the CLI options or passed by the
                       user specifically using the python API
        :return: dict, A python dictionary with key ``flavor``. This is useful if user doesn't
                        pass the flavor and mlflow inferred it
        """
        pass
    ...
    def list(self, **kwargs):
        """
        This function will be called by
        :py:func:`deployments.list_deployments <mlflow.deployments.list_deployments>`.
    ...
    def describe(self, deployment_id, **kwargs):
        """
        This function will be called by
        :py:func:`deployments.describe_deployment <mlflow.deployments.describe_deployment>`.
