# Specifies the timeout for the DatabricksDeploymentClient APIs to declare a request has timed out
MLFLOW_DATABRICKS_DEPLOYMENT_CLIENT_REQUEST_TIMEOUT_SECONDS = 300

# Abridged retryable error codes for DatabricksDeploymentClient.
...
MLFLOW_DATABRICKS_DEPLOYMENT_CLIENT_REQUEST_RETRY_CODES = frozenset(
    [
