...
func registerMlflowServiceRoutes(service MlflowService, app *fiber.App) {
	app.Get("/api/v2.0/mlflow/getExperimentByName//mlflow/experiments/get-by-name", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/createExperiment//mlflow/experiments/create", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/searchExperiments//mlflow/experiments/search", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/searchExperiments//mlflow/experiments/search", func(ctx *fiber.Ctx) error {
		var input *protos.SearchExperiments
		if err := ctx.QueryParser(&input); err != nil {
			return err
		}
	...
	app.Get("/api/v2.0/mlflow/getExperiment//mlflow/experiments/get", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/deleteExperiment//mlflow/experiments/delete", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/restoreExperiment//mlflow/experiments/restore", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/updateExperiment//mlflow/experiments/update", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/createRun//mlflow/runs/create", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/updateRun//mlflow/runs/update", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/deleteRun//mlflow/runs/delete", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/restoreRun//mlflow/runs/restore", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/logMetric//mlflow/runs/log-metric", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/logParam//mlflow/runs/log-parameter", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/setExperimentTag//mlflow/experiments/set-experiment-tag", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/setTag//mlflow/runs/set-tag", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/deleteTag//mlflow/runs/delete-tag", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/getRun//mlflow/runs/get", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/searchRuns//mlflow/runs/search", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/listArtifacts//mlflow/artifacts/list", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/getMetricHistory//mlflow/metrics/get-history", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/getMetricHistoryBulkInterval//mlflow/metrics/get-history-bulk-interval", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/logBatch//mlflow/runs/log-batch", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/logModel//mlflow/runs/log-model", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/logInputs//mlflow/runs/log-inputs", func(ctx *fiber.Ctx) error {
...
func registerModelRegistryServiceRoutes(service ModelRegistryService, app *fiber.App) {
	app.Post("/api/v2.0/mlflow/createRegisteredModel//mlflow/registered-models/create", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/renameRegisteredModel//mlflow/registered-models/rename", func(ctx *fiber.Ctx) error {
	...
	app.Patch("/api/v2.0/mlflow/updateRegisteredModel//mlflow/registered-models/update", func(ctx *fiber.Ctx) error {
	...
	app.Delete("/api/v2.0/mlflow/deleteRegisteredModel//mlflow/registered-models/delete", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/getRegisteredModel//mlflow/registered-models/get", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/searchRegisteredModels//mlflow/registered-models/search", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/getLatestVersions//mlflow/registered-models/get-latest-versions", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/getLatestVersions//mlflow/registered-models/get-latest-versions", func(ctx *fiber.Ctx) error {
		var input *protos.GetLatestVersions
		if err := ctx.QueryParser(&input); err != nil {
			return err
		}
	...
	app.Post("/api/v2.0/mlflow/createModelVersion//mlflow/model-versions/create", func(ctx *fiber.Ctx) error {
	...
	app.Patch("/api/v2.0/mlflow/updateModelVersion//mlflow/model-versions/update", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/transitionModelVersionStage//mlflow/model-versions/transition-stage", func(ctx *fiber.Ctx) error {
	...
	app.Delete("/api/v2.0/mlflow/deleteModelVersion//mlflow/model-versions/delete", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/getModelVersion//mlflow/model-versions/get", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/searchModelVersions//mlflow/model-versions/search", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/getModelVersionDownloadUri//mlflow/model-versions/get-download-uri", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/setRegisteredModelTag//mlflow/registered-models/set-tag", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/setModelVersionTag//mlflow/model-versions/set-tag", func(ctx *fiber.Ctx) error {
	...
	app.Delete("/api/v2.0/mlflow/deleteRegisteredModelTag//mlflow/registered-models/delete-tag", func(ctx *fiber.Ctx) error {
	...
	app.Delete("/api/v2.0/mlflow/deleteModelVersionTag//mlflow/model-versions/delete-tag", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/setRegisteredModelAlias//mlflow/registered-models/alias", func(ctx *fiber.Ctx) error {
	...
	app.Delete("/api/v2.0/mlflow/deleteRegisteredModelAlias//mlflow/registered-models/alias", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/getModelVersionByAlias//mlflow/registered-models/alias", func(ctx *fiber.Ctx) error {
...
func registerMlflowArtifactsServiceRoutes(service MlflowArtifactsService, app *fiber.App) {
	app.Get("/api/v2.0/mlflow/downloadArtifact//mlflow-artifacts/artifacts/:path", func(ctx *fiber.Ctx) error {
	...
	app.Put("/api/v2.0/mlflow/uploadArtifact//mlflow-artifacts/artifacts/:path", func(ctx *fiber.Ctx) error {
	...
	app.Get("/api/v2.0/mlflow/listArtifacts//mlflow-artifacts/artifacts", func(ctx *fiber.Ctx) error {
	...
	app.Delete("/api/v2.0/mlflow/deleteArtifact//mlflow-artifacts/artifacts/:path", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/createMultipartUpload//mlflow-artifacts/mpu/create/:path", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/completeMultipartUpload//mlflow-artifacts/mpu/complete/:path", func(ctx *fiber.Ctx) error {
	...
	app.Post("/api/v2.0/mlflow/abortMultipartUpload//mlflow-artifacts/mpu/abort/:path", func(ctx *fiber.Ctx) error {
