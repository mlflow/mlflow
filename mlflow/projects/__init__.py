...
from mlflow.projects.utils import (
    _get_storage_dir, fetch_project, create_run, load_project
)
...
_MLFLOW_INTERNAL_RUN_ID_CONFIG = "_mlflow_internal_run_id"
...
def _run(uri, experiment_id, entry_point="main", version=None, parameters=None,
    ...
    project.get_entry_point(entry_point).validate_parameters(parameters)
    _validate_execution_environment(project, backend_name)

    if backend_name == "local" and _MLFLOW_INTERNAL_RUN_ID_CONFIG in backend_config:
        active_run = mlflow.get_run(backend_config[_MLFLOW_INTERNAL_RUN_ID_CONFIG])
    else:
        active_run = create_run(uri, experiment_id, work_dir, version, entry_point, parameters)
...
def run(uri, entry_point="main", version=None, parameters=None,
    ...
    if backend == "databricks":
        ...
        backend_config[_MLFLOW_INTERNAL_RUN_ID_CONFIG] = run_id
