...
MLFLOW_SUPPORTED_BACKENDS = ["local", "azure", "databricks", "kubernetes"]
...
def _run(uri, experiment_id, entry_point="main", version=None, parameters=None,
         backend_type=None, backend_config=None, use_conda=True,
    ...
    if backend_type == "local" or backend_type is None:
        ...
        CurrentProjectBackend = DatabricksBackend
    elif backend_type == "kubernetes":
        from mlflow.projects.kubernetes import KubernetesBackend
        CurrentProjectBackend = KubernetesBackend
    elif backend_type == "azure":
        from mlflow.projects.azure_backend import AzureBackend
        CurrentProjectBackend = AzureBackend
    else:
...
def run(uri, entry_point="main", version=None, parameters=None,
    ...
    submitted_run_obj = _run(
        ...
        parameters=parameters, backend_type=backend, backend_config=cluster_spec_dict,
