...
from mlflow.projects.utils import (
    ...
    fetch_and_validate, get_or_create_run, log_project_params_and_tags
)
...
def _run(uri, experiment_id, entry_point="main", version=None, parameters=None,
    ...
    """
    project, work_dir = fetch_and_validate(uri, version, entry_point, parameters)
    ...
    if backend:
        ...
        tracking.MlflowClient().set_tag(run_id, MLFLOW_PROJECT_BACKEND,
                                        backend.name)
        return backend.run(run_id=run_id, project_uri=uri, entry_point=entry_point,
                           params=parameters, backend_config=backend_config,
