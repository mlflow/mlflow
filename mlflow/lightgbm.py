...
def autolog(log_input_example=False, log_model_signature=True):
    ...
    def train(*args, **kwargs):
        ...
        # train_data must exist as the original train function already ran successfully
        train_data = args[1] if len(args) > 1 else kwargs.get("train_set")
        ...
        try:
            ...
            input_example_info = getattr(train_data, "input_example_info", None)
