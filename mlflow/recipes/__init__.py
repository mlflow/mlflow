...
- **Recipe templates**: `Predefined templates <../../recipes#recipe-templates>`_ for common ML
  tasks, such as `regression modeling <../../recipes#regression-template>`_, enable you to get
  started quickly and focus on building great models, eliminating the large amount of boilerplate
  code that is traditionally required to curate datasets, engineer features, train & tune models,
  and package models for production deployment.
...
- **Production-ready structure**: The modular, git-integrated `recipe structure
  <../../recipes#recipe-templates-key-concept>`_ dramatically simplifies the handoff from
...
For more information, see the `MLflow Recipes overview <../../recipes>`_.
"""
