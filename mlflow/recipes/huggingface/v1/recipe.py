"""
.. _mlflow-huggingface-recipe:

The MLflow Huggingface Recipe is an MLflow Recipe for developing binary huggingface
models.
The huggingface recipe is designed for developing models using huggingface
frameworks, such as the ``seek2seek`` API from huggingface.
The :py:class:`HuggingfaceRecipe API Documentation <HuggingfaceRecipe>` provides
...
The recipe steps are defined as follows:
   ...
   .. _mlflow-huggingface-recipe-split-step:
   ...
   .. _mlflow-huggingface-recipe-train-step:
...
@experimental
class HuggingfaceRecipe(_BaseRecipe):
    """
    A recipe for developing high-quality huggingface models. The recipe is designed for
    ...
    **ingest_scoring** -> **predict**
    ...
    .. code-block:: python
        ...
        os.chdir("~/mlp-huggingface-template")
        huggingface_recipe = Recipe(profile="local")
        # Display a visual overview of the recipe graph
        huggingface_recipe.inspect()
        # Run the full recipe
        huggingface_recipe.run()
        ...
        huggingface_recipe.inspect(step="train")
        ...
        huggingface_recipe.inspect(step="evaluate")
    """
    ...
    def run(self, step: str = None) -> None:
        ...
        :param step: String name of the step to run within the huggingface recipe. The step and
        ...
        .. code-block:: python
            ...
            huggingface_recipe.run(step="train")
            ...
            huggingface_recipe.run(step="register")
    ...
    def get_artifact(self, artifact_name: str) -> Optional[Any]:
        ...
        :py:func:`HuggingfaceRecipe.inspect()`.
        ...
        .. code-block:: python
            ...
            huggingface_recipe = Recipe(profile="local")
            huggingface_recipe.run()
            train_df: pd.DataFrame = huggingface_recipe.get_artifact("training_data")
            trained_model: PyFuncModel = huggingface_recipe.get_artifact("model")
        """
    ...
    def clean(self, step: str = None) -> None:
        ...
        .. code-block:: python
            ...
            huggingface_recipe.clean(step="transform")
            # Run the 'split' step; outputs are still cached because 'split' precedes
            # 'transform' & 'train'
            huggingface_recipe.run(step="split")
    ...
    def inspect(self, step: str = None) -> None:
        ...
        .. code-block:: python
            ...
            huggingface_recipe.inspect(step="transform")
        """
