...
from mlflow.utils.logging_utils import suppress_logs_in_modules, suppress_logs_in_thread
...
class TelemetryClient:
    ...
    def _update_backend_store(self):
        ...
        # Explicitly suppress logs generated by alembic and mlflow's db migration
        # scripts, so we don't impact logs from other threads.
        # TODO: we can remove the scripts module after we clean up the logs in them
        with suppress_logs_in_modules(
            [
                "alembic.runtime.migration",
                "89d4b8295536_create_latest_metrics_table_py",
                "2b4d017a5e9b_add_model_registry_tables_to_db_py",
            ]
        ):
