...
def autolog(
    ...
    :param disable_for_unsupported_versions: If ``True``, disable autologging for versions of xgboost that have not been tested against this version of the MLflow client or are incompatible.
    """
    import xgboost
    import numpy as np
