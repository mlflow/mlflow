...
class SpanAttributeKey:
    ...
    # Agent identity attributes set by ResponsesAgent when AgentAttribute is defined.
    AGENT_NAME = "mlflow.agent.name"
    AGENT_DESCRIPTION = "mlflow.agent.description"
    AGENT_VERSION = "mlflow.agent.version"
