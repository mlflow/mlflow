...
class SpanAttributeKey:
    ...
    # This attribute is used to store the prompt name when load_prompt/register_prompt is called
    # within an active span.
    PROMPT_NAME = "mlflow.prompt.name"
    # This attribute is used to store the prompt version when load_prompt/register_prompt is called
    # within an active span.
    PROMPT_VERSION = "mlflow.prompt.version"
