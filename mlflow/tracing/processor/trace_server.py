...
class TraceServerSpanProcessor(SimpleSpanProcessor):
    """
    Defines custom hooks to be executed when a span is started or ended (before exporting).

    This processor is used when the tracing destination is Databricks Trace Server using
    the IngestApi.
    """
    ...
    def on_start(self, span: OTelSpan, parent_context: Optional[Context] = None):
        ...
        if span._parent is None:
            trace_info = TraceInfo(
                ...
                experiment_id=None,  # TraceServer doesn't associate with experiments
