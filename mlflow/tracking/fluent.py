...
def log_artifact(
    ...
    Args:
        ...
        client: :py:class:`MlflowClient <mlflow.client.MlflowClient>`
            The client to use for logging the artifact. The client's tracking and registry URIs
...
def log_artifacts(
    ...
    Args:
        ...
        client: :py:class:`MlflowClient <mlflow.client.MlflowClient>`
            The client to use for logging artifacts. The client's tracking and registry URIs
            will be used. Default None to use the global URIs.
