...
def search_logged_models(
    ...
    Args:
        ...
        datasets: List of dictionaries to specify datasets on which to apply the metrics filter clauses. 
            For example, a filter string with `metrics.accuracy > 0.9` and dataset with name "test_dataset"
