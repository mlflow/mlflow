...
class MlflowClient:
    ...
    def search_prompts(
        ...
        if version is not None:
            # When version is specified, always return PagedList[Prompt] for consistency
            prompts = []
            ...
            # OSS only: Convert PromptInfo to Prompt objects (existing behavior for backward compatibility)
            prompts = []
            for result in search_results:
