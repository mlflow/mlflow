...
from mlflow.utils.workspace_context import clear_workspace, set_current_workspace
...
def set_workspace(workspace: str | None) -> None:
    ...
    with _workspace_lock:
        ...
        # Persist to the env var as well so subprocesses launched from this session inherit
        # the same workspace, matching how set_tracking_uri() updates MLFLOW_TRACKING_URI.
