...
def log_explanation(predict_function, features, artifact_path=None):
    ...
    of artifacts containing the following items generated by `SHAP`_ (SHapley Additive exPlanations):
    ...
    :param features:
        ...
        .. note::
            Background data for `shap.KernelExplainer`_ is generated by subsumpling ``features``
