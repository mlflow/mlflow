...
def log_explanation(predict_function, features, artifact_path=None):
    ...
    :param features: A matrix of features to compute SHAP values with. The provided features should
        have shape (# samples, # features), and can be either a numpy array, pandas DataFrame.
