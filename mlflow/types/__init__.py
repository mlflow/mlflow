...
if not IS_TRACING_SDK_ONLY:
    try:
        ...
        # numpy is not available (e.g. mlflow-skinny without numpy installed).
        # Schema/DataType types are unavailable, but tracing and autolog features
        # that do not require numpy (e.g. mlflow.anthropic.autolog) will still work.
        pass
