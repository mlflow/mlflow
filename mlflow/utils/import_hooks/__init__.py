...
def discover_post_import_hooks(group):
    ...
    if sys.version_info.major > 2 and sys.version_info.minor > 8:
        from importlib.resources import files  # pylint: disable=builtin-import
        ...
        from importlib.resources import contents  # pylint: disable=builtin-import
...
class ImportHookFinder:
    ...
    def find_module(self, fullname, path=None):
        ...
        try:
            ...
            # post import hooks.
            try:
                import importlib.util  # pylint: disable=builtin-import
