...
ACTIVATE_SCHEDULER = click.option("--activate-scheduler", is_flag=True,
                                  help="If specified, will activate periodic jobs ran by the"
                                       " server. You also need to specify a configuration file"
                                       " using --scheduler-configuration to chose which job"
                                       " you wish to activate and their configuration.")
