...
def assessment_to_proto(assessment: Assessment) -> pb.Assessment:
    ...
    trace_identifier.trace_id = trace_id
    assessment_proto.trace_identifier.CopyFrom(trace_identifier)
