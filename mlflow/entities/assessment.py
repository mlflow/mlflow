...
class Assessment(_MlflowObject):
    """
    An Assessment is an abstraction for annotating a trace.
    ...
    Args:
        ...
        trace_id: The ID of the trace associated with the assessment. If unset, the assessment
            is not associated with any trace.
        ...
        assessment_id: The ID of the assessment, generated in the backend.
    ...
    # Optional; if not set, the assessment is not associated with a trace
    trace_id: Optional[str] = None
    # One of expectation, feedback required
    expectation: Optional[Expectation] = None
    feedback: Optional[Feedback] = None
    # Generic fields applicable to all assessments
    rationale: Optional[str] = None
    metadata: Optional[dict[str, str]] = None
    error: Optional[AssessmentError] = None
    span_id: Optional[str] = None
    # NB: These fields are generated by the backend when logging an assessment.
