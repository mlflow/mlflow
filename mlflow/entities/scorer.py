...
class ScorerVersion(_MlflowObject):
    ...
    Args:
        ...
        sample_rate (float): The fraction of data to sample for scoring (0.0 to 1.0).
            Default is 0.0.
    ...
    def sample_rate(self):
        """
        The fraction of data to sample for scoring.

        Returns:
            float: A value between 0.0 and 1.0 representing the sampling rate.
                  Default is 0.0 which means no sampling (use all data).
        """
