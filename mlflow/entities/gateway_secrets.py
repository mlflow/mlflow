...
class GatewaySecretInfo(_MlflowObject):
    ...
    Args:
        ...
        allowlisted_models: Optional list of {provider, model} dicts the user has allowlisted
            for this key. Display/selection metadata only; never used for authentication.
    ...
    def to_proto(self):
        ...
        if self.allowlisted_models:
            # GatewayAllowlistedModel is added to service.proto in this change but
            # service_pb2 is regenerated by CI (protoc), so ty can't see it yet.
            from mlflow.protos.service_pb2 import (
                GatewayAllowlistedModel,  # ty: ignore[unresolved-import]
            )
