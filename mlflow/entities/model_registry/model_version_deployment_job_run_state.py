...
class ModelVersionDeploymentJobRunState:
    ...
    NO_VALID_DEPLOYMENT_JOB_FOUND = ProtoModelVersionDeploymentJobState.DeploymentJobRunState.Value("NO_VALID_DEPLOYMENT_JOB_FOUND")
    ...
    _STRING_TO_STATE = {k: ProtoModelVersionDeploymentJobState.DeploymentJobRunState.Value(k) for k in ProtoModelVersionDeploymentJobState.DeploymentJobRunState.keys()}
