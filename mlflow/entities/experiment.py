...
from mlflow.protos.service_pb2 import Experiment as ProtoExperiment, ExperimentTag as ProtoExperimentTag
...
class Experiment(_MLflowObject):
    ...
    def from_proto(cls, proto):
        experiment = cls(proto.experiment_id, proto.name, proto.artifact_location, proto.lifecycle_stage)
    ...
    def to_proto(self):
        ...
        experiment.tags.extend([ProtoExperimentTag(key=key, value=val) for key, val in self._tags.items()])
        return experiment
