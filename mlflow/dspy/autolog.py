...
def autolog(
    ...
    disable: bool = False,
    silent: bool = False,
    auto_logged_model_creation: bool = True,
):
    """
    ...
    Args:
        ...
        auto_logged_model_creation: If ``True``, automatically create a LoggedModel when the model
    ...
    def patch_module(original, self, *args, **kwargs):
        ...
        elif not _MODEL_TRACKER._is_active_model_id_set and auto_logged_model_creation:
