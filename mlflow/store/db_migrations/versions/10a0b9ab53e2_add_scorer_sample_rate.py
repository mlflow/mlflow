"""Add sample_rate and filter_string columns to scorer_versions table

This migration adds sample_rate and filter_string columns to the scorer_versions table
...
The default values (0.0 for sample_rate, NULL for filter_string) ensure backward
