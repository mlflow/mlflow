...
class RestWorkspaceStore(AbstractStore):
    ...
    def create_workspace(self, workspace: Workspace) -> Workspace:
        ...
        if response.status_code in (400, 409):
            ...
            if response.status_code == 409 or error_code == "RESOURCE_ALREADY_EXISTS":
                message = data.get("message") or f"Workspace '{workspace.name}' already exists."
                raise MlflowException(message, RESOURCE_ALREADY_EXISTS)
