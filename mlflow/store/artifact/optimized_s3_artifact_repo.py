...
class OptimizedS3ArtifactRepository(CloudArtifactRepository):
    ...
    def __init__(
        ...
        print("in s3 artifact repo")
        self._region_name = self._get_region_name()
        print(f"region name = {self._region_name}")
    ...
    def _get_region_name(self):
        ...
        try:
            ...
            if _BUCKET_REGION in head_bucket_resp:
                print(f"returning region {head_bucket_resp[_BUCKET_REGION]}")
            ...
            if (
                ...
                print(f"returning region from metadata {head_bucket_resp[_RESPONSE_METADATA][_HTTP_HEADERS][_HTTP_HEADER_BUCKET_REGION]}")
