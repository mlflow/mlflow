...
from mlflow.store.artifact.s3_artifact_repo import S3ArtifactRepository, _get_s3_artifact_repository
...
_artifact_repository_registry.register("s3", _get_s3_artifact_repository())
