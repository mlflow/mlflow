...
class UnityCatalogModelsArtifactRepository(ArtifactRepository):
    ...
    def __init__(self, artifact_uri, registry_uri):
        ...
        print(f"UnityCatalogModelsArtifactRepository: In __init__, about to initialize client with registry URI {self.registry_uri}")
        self.client = MlflowClient(registry_uri=self.registry_uri)
        print("UnityCatalogModelsArtifactRepository: Initialized client, getting model name and version from URI")
