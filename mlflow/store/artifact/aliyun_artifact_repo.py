...
class AliyunArtifactRepository(ArtifactRepository):
    ...
    def log_artifact(self, local_file, artifact_path=None):
        ...
        oss_bucket.put_object_from_file(dest_path, local_file)
    ...
    def log_artifacts(self, local_dir, artifact_path=None):
        ...
        for (root, _, filenames) in os.walk(local_dir):
            ...
            for f in filenames:
                oss_bucket.put_object_from_file(posixpath.join(upload_path, f), os.path.join(root, f))
    ...
    def list_artifacts(self, path=None):
        ...
        oss_bucket = self._get_oss_bucket(bucket)
        results = oss2.ObjectIterator(oss_bucket, prefix=prefix, delimiter = '/')
    ...
    def _download_file(self, remote_file_path, local_path):
        ...
        oss_bucket = self._get_oss_bucket(bucket)
        print(oss_full_path)
        oss_bucket.get_object_to_file(oss_full_path, local_path)
