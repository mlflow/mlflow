...
from mlflow.utils.uri import append_to_uri_path, resolve_local_uri_if_relative
...
class FileStore(AbstractStore):
    ...
    def __init__(self, root_directory=None, artifact_root_uri=None):
        ...
        if artifact_root_uri is None:
            ...
            self.artifact_root_uri = resolve_local_uri_if_relative(artifact_root_uri)
    ...
    def _create_experiment_with_id(self, name, experiment_id, artifact_uri, tags):
        if artifact_uri is None:
            ...
            artifact_root_uri = resolve_local_uri_if_relative(artifact_uri)
        resolved_artifact_uri = append_to_uri_path(artifact_root_uri, str(experiment_id))
        self._check_root_dir()
