...
class SqlScorerVersion(Base):
    ...
    """
    sample_rate = Column(sa.types.Float(precision=53), nullable=False, default=0.0)
    """
    Sample rate: `Float`. Default value is 0.0. Represents the fraction of data to sample.
    """
