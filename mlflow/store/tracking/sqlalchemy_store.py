...
class SqlAlchemyStore(AbstractStore):
    ...
    def query_trace_metrics(
        ...
        validate_query_trace_metrics_params(view_type, metric_name, aggregation_types, dimensions)

        if time_granularity and (start_time_ms is None or end_time_ms is None):
            raise MlflowException.invalid_parameter_value(
                "start_time_ms and end_time_ms are required if time_granularity is set"
            )
