...
class SqlAlchemyStore(AbstractStore):
    ...
    def start_trace(
        ...
        with self.ManagedSessionMaker() as session:
            ...
            # tags could contain special tag='request_id' to make it possible to override `request_id`
            # from Python tests in other stores like GO store. Filter it from here.
            del tags["request_id"]
