...
class TracesDemoGenerator(BaseDemoGenerator):
    ...
    def _create_rag_trace(
        ...
        # Set trace metadata directly on the trace manager
        trace_manager = InMemoryTraceManager.get_instance()
        trace_manager.set_trace_metadata(root.trace_id, DEMO_VERSION_TAG, version)
        trace_manager.set_trace_metadata(root.trace_id, DEMO_TRACE_TYPE_TAG, "rag")
    ...
    def _create_agent_trace(
        ...
        trace_manager = InMemoryTraceManager.get_instance()
        trace_manager.set_trace_metadata(root.trace_id, DEMO_VERSION_TAG, version)
        trace_manager.set_trace_metadata(root.trace_id, DEMO_TRACE_TYPE_TAG, "agent")
    ...
    def _create_prompt_trace(
        ...
        trace_manager = InMemoryTraceManager.get_instance()
        trace_manager.set_trace_metadata(root.trace_id, DEMO_VERSION_TAG, version)
        trace_manager.set_trace_metadata(root.trace_id, DEMO_TRACE_TYPE_TAG, "prompt")
    ...
    def _create_session_turn_trace(
        ...
        # Set trace metadata directly on the trace manager
        trace_manager = InMemoryTraceManager.get_instance()
        trace_manager.set_trace_metadata(
            root.trace_id, TraceMetadataKey.TRACE_SESSION, versioned_session_id
        )
        trace_manager.set_trace_metadata(
            root.trace_id, TraceMetadataKey.TRACE_USER, trace_def.session_user or "user"
        )
        trace_manager.set_trace_metadata(root.trace_id, DEMO_VERSION_TAG, version)
        trace_manager.set_trace_metadata(root.trace_id, DEMO_TRACE_TYPE_TAG, "session")
