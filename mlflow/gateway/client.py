...
class MlflowGatewayClient:
    ...
    def set_limits(self, route: str, limits: List[Dict[str, Any]]) -> LimitsConfig:
        ...
        :param limits: Limits (Array of dictionary) to set on the route. Each limit is defined by a dictionary representing the limit details to be associated with the route.
        ...
        :return: The returned data structure is a serialized representation of the `Limit` data structure, giving information about the renwal_period, key, and calls.
    ...
    def get_limits(self, route: str) -> LimitsConfig:
        ...
        :return: The returned data structure is a serialized representation of the `Limit` data
            structure, giving information about the renwal_period, key, and calls.
