...
@commands.command(
    short_help=("Register an MLflow model with Azure ML and build an Azure ML"
...
@experimental
def build_image(model_uri, workspace_name, subscription_id, image_name, model_name, mlflow_home,
                description, tags):
    """
