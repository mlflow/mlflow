...
class EvaluationExample:
    ...
    :param eval_args: The eval_args provided to the evaluator for evaluation
    ...
    eval_args: Dict[str, str] = None

    def __str__(self) -> str:
        eval_args = (
            ""
            if self.eval_args is None
            else "\n".join([f"Provided {key}: {value}" for key, value in self.eval_args.items()])
        )
