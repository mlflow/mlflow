...
def recall_at_k(k) -> EvaluationMetric:
    ...
    the retriever model at the given ``k`` value.


    If no relevant documents are retrieved, the score
    is 0, indicating that no relevant docs were retrieved. Then, the precision at k is calculated as follows:
    """
    return make_metric(
