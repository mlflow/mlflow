...
def _get_provider_instance(
    ...
    elif provider == Provider.ATLASCLOUD:
        from mlflow.gateway.config import _OpenAICompatibleConfig
        from mlflow.gateway.providers.atlascloud import AtlasCloudProvider

        config = _OpenAICompatibleConfig(api_key=os.environ.get("ATLASCLOUD_API_KEY"))
        return AtlasCloudProvider(_get_route_config(config))
