...
from mlflow.utils.provider_filter import _normalize_provider_name
...
def _call_llm_provider_api(
    ...
    *,
    ...
    if _normalize_provider_name(provider_name) == Provider.BEDROCK:
...
def _get_provider_instance(provider: str, model: str) -> "BaseProvider":
    ...
    elif _normalize_provider_name(provider) == Provider.BEDROCK:
