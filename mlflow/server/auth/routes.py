...
CHECK_USER_PERMISSION = _get_rest_path("/mlflow/users/permissions/check", version=3)
AJAX_CHECK_USER_PERMISSION = _get_ajax_path("/mlflow/users/permissions/check", version=3)
