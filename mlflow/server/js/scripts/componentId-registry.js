...
module.exports = {
  ...
  "admin.create_role_modal.discard_unsaved_draft": "",
  ...
  "admin.create_user_modal.discard_unsaved_draft": "",
  "admin.create_user_modal.error": "",
  "admin.create_user_modal.grant_workspace": "",
  ...
  "admin.edit_access_modal.discard_unsaved_draft": "",
  "admin.edit_access_modal.error": "",
  "admin.edit_access_modal.grant_workspace": "",
  ...
  "admin.edit_role_modal.discard_unsaved_draft": "",
  ...
  "mlflow.assistant.chat_panel.remote_setup_close": "",
  ...
  "mlflow.assistant.setup.llm_connections_link": "",
  ...
  "mlflow.eval-datasets.key-value-tag-modal": "",
  "mlflow.eval-datasets.key-value-tag-modal-close": "",
  "mlflow.eval-datasets.key-value-tag-modal-delete": "",
  ...
  "mlflow.eval-datasets.tag-key-input": "",
  "mlflow.eval-datasets.tag-value-input": "",

  // -- mlflow.eval-datasets-v2 --
  "mlflow.eval-datasets-v2.breadcrumb.datasets": "",
  "mlflow.eval-datasets-v2.create-dataset.button": "",
  "mlflow.eval-datasets-v2.detail.actions": "",
  "mlflow.eval-datasets-v2.detail.actions.delete-dataset": "",
  "mlflow.eval-datasets-v2.detail.actions.view-in-unity-catalog": "",
  "mlflow.eval-datasets-v2.detail.actions.view-in-unity-catalog-link": "",
  "mlflow.eval-datasets-v2.detail.actions.view-metadata": "",
  "mlflow.eval-datasets-v2.detail.back-to-datasets": "",
  "mlflow.eval-datasets-v2.detail.delete-confirm-modal": "",
  "mlflow.eval-datasets-v2.detail.delete-error": "",
  "mlflow.eval-datasets-v2.detail.metadata-modal": "",
  "mlflow.eval-datasets-v2.drawer.discard": "",
  "mlflow.eval-datasets-v2.drawer.save": "",
  "mlflow.eval-datasets-v2.list.clear-search-link": "",
  "mlflow.eval-datasets-v2.list.dataset-link": "",
  "mlflow.eval-datasets-v2.list.delete-confirm-modal": "",
  "mlflow.eval-datasets-v2.list.delete-error": "",
  "mlflow.eval-datasets-v2.list.fetch-error": "",
  "mlflow.eval-datasets-v2.list.header.created-at": "",
  "mlflow.eval-datasets-v2.list.header.created-by": "",
  "mlflow.eval-datasets-v2.list.header.last-updated": "",
  "mlflow.eval-datasets-v2.list.header.name": "",
  "mlflow.eval-datasets-v2.list.learn-more-link": "",
  "mlflow.eval-datasets-v2.list.pagination": "",
  "mlflow.eval-datasets-v2.list.row.actions": "",
  "mlflow.eval-datasets-v2.list.row.delete": "",
  "mlflow.eval-datasets-v2.list.search": "",
  "mlflow.eval-datasets-v2.record-detail.collapsible-section": "",
  "mlflow.eval-datasets-v2.records.add-record": "",
  "mlflow.eval-datasets-v2.records.bulk-delete-confirm-modal": "",
  "mlflow.eval-datasets-v2.records.bulk-delete-error": "",
  "mlflow.eval-datasets-v2.records.cell.json-preview": "",
  "mlflow.eval-datasets-v2.records.cell.json-tooltip": "",
  "mlflow.eval-datasets-v2.records.cell.record-id": "",
  "mlflow.eval-datasets-v2.records.cell.record-id-link": "",
  "mlflow.eval-datasets-v2.records.cell.record-id-tooltip": "",
  "mlflow.eval-datasets-v2.records.cell.source.document": "",
  "mlflow.eval-datasets-v2.records.cell.source.human": "",
  "mlflow.eval-datasets-v2.records.cell.source.trace": "",
  "mlflow.eval-datasets-v2.records.cell.tag-preview": "",
  "mlflow.eval-datasets-v2.records.cell.tag-preview-pill": "",
  "mlflow.eval-datasets-v2.records.cell.tag-preview-tooltip": "",
  "mlflow.eval-datasets-v2.records.column-selector.item.create_time": "",
  "mlflow.eval-datasets-v2.records.column-selector.item.created_by": "",
  "mlflow.eval-datasets-v2.records.column-selector.item.dataset_record_id": "",
  "mlflow.eval-datasets-v2.records.column-selector.item.expectations": "",
  "mlflow.eval-datasets-v2.records.column-selector.item.inputs": "",
  "mlflow.eval-datasets-v2.records.column-selector.item.last_updated": "",
  "mlflow.eval-datasets-v2.records.column-selector.item.last_updated_by": "",
  "mlflow.eval-datasets-v2.records.column-selector.item.source": "",
  "mlflow.eval-datasets-v2.records.column-selector.item.tags": "",
  "mlflow.eval-datasets-v2.records.column-selector.reset": "",
  "mlflow.eval-datasets-v2.records.column-selector.trigger": "",
  "mlflow.eval-datasets-v2.records.empty.add-record": "",
  "mlflow.eval-datasets-v2.records.empty.clear-search-link": "",
  "mlflow.eval-datasets-v2.records.empty.sdk-docs-link": "",
  "mlflow.eval-datasets-v2.records.fetch-error": "",
  "mlflow.eval-datasets-v2.records.header.create-time": "",
  "mlflow.eval-datasets-v2.records.header.created-by": "",
  "mlflow.eval-datasets-v2.records.header.expectations": "",
  "mlflow.eval-datasets-v2.records.header.inputs": "",
  "mlflow.eval-datasets-v2.records.header.last-updated": "",
  "mlflow.eval-datasets-v2.records.header.last-updated-by": "",
  "mlflow.eval-datasets-v2.records.header.record-id": "",
  "mlflow.eval-datasets-v2.records.header.source": "",
  "mlflow.eval-datasets-v2.records.header.tags": "",
  "mlflow.eval-datasets-v2.records.pagination": "",
  "mlflow.eval-datasets-v2.records.row-select": "",
  "mlflow.eval-datasets-v2.records.row-select-all": "",
  "mlflow.eval-datasets-v2.records.row-select.phantom": "",
  "mlflow.eval-datasets-v2.records.search": "",
  "mlflow.eval-datasets-v2.records.selection-toolbar.clear": "",
  "mlflow.eval-datasets-v2.records.selection-toolbar.delete": "",
  "mlflow.eval-datasets-v2.records.tag.add": "",
  "mlflow.eval-datasets-v2.records.tag.draft.add": "",
  "mlflow.eval-datasets-v2.records.tag.draft.pill": "",
  "mlflow.eval-datasets-v2.records.tag.draft.pill-tooltip": "",
  "mlflow.eval-datasets-v2.records.tag.phantom-pill": "",
  "mlflow.eval-datasets-v2.records.tag.pill": "",
  "mlflow.eval-datasets-v2.records.tag.pill-tooltip": "",
  "mlflow.eval-datasets-v2.side-panel.close": "",
  "mlflow.eval-datasets-v2.side-panel.discard-prompt": "",
  "mlflow.eval-datasets-v2.side-panel.source-trace-link": "",
  "mlflow.eval-datasets-v2.trace-modal": "",
  ...
  "mlflow.evaluations_review.modal.add_to_dataset.tooltip": "",
  ...
  "mlflow.evaluations_review.modal.flag_for_review.guidance": "",
  "mlflow.evaluations_review.modal.flag_for_review.tooltip": "",
  "mlflow.evaluations_review.modal.fullscreen": "",
  "mlflow.evaluations_review.modal.fullscreen-tooltip": "",
  "mlflow.evaluations_review.modal.next-tooltip": "",
  "mlflow.evaluations_review.modal.next_eval": "",
  "mlflow.evaluations_review.modal.previous-tooltip": "",
  ...
  "mlflow.evaluations_review.modal.trace-id": "",
  "mlflow.evaluations_review.modal.trace-id-tooltip": "",
  ...
  "mlflow.experiment-side-nav.genai.playground": "",
  ...
  "mlflow.gateway.budgets-list.deleted-endpoint-tooltip": "",
  ...
  "mlflow.gateway.budgets-list.scope-header": "",
  "mlflow.gateway.budgets-list.updated-header": "",
  "mlflow.gateway.budgets-list.user-scope-tag": "",
  ...
  "mlflow.gateway.create-budget-policy-modal.endpoint": "",
  ...
  "mlflow.gateway.create-budget-policy-modal.scope": "",
  "mlflow.gateway.create-budget-policy-modal.username": "",
  ...
  "mlflow.gateway.edit-budget-policy-modal.endpoint": "",
  ...
  "mlflow.gateway.edit-budget-policy-modal.scope": "",
  "mlflow.gateway.edit-budget-policy-modal.username": "",
  ...
  "mlflow.mcp_registry.detail.version.edit_status": "",
  "mlflow.mcp_registry.detail.version.status_select": "",
  "mlflow.mcp_registry.detail.version.status_update_error": "",
  ...
  "mlflow.playground.params.drawer.trigger": "",
  "mlflow.playground.params.frequency_penalty": "",
  "mlflow.playground.params.max_tokens": "",
  "mlflow.playground.params.presence_penalty": "",
  "mlflow.playground.params.section.parameters_help": "",
  "mlflow.playground.params.section.response_format_help": "",
  "mlflow.playground.params.section.tools_help": "",
  "mlflow.playground.params.stop": "",
  "mlflow.playground.params.temperature": "",
  "mlflow.playground.params.top_k": "",
  ...
  "mlflow.playground.response_format.format": "",
  "mlflow.playground.response_format.type": "",
  "mlflow.playground.save_prompt_version": "",
  "mlflow.playground.save_prompt_version.commit_message": "",
  "mlflow.playground.save_prompt_version.error": "",
  "mlflow.playground.save_prompt_version.include_settings": "",
  "mlflow.playground.save_prompt_version.name": "",
  "mlflow.playground.save_prompt_version.no_messages": "",
  "mlflow.playground.save_prompt_version.saved": "",
  "mlflow.playground.save_prompt_version.saved.close": "",
  ...
  "mlflow.playground.tools.add_tool": "",
  "mlflow.playground.tools.description": "",
  "mlflow.playground.tools.format": "",
  "mlflow.playground.tools.name": "",
  ...
  "mlflow.traces.issue-detection.low-results-callout": "",
  "mlflow.traces.issue-detection.low-results-callout.feedback-docs-link": "",
  ...
  "mlflow.traces-v4.column-selector.item.source": "",
  "mlflow.traces-v4.column-selector.item.start_time": "",
  "mlflow.traces-v4.column-selector.item.state": "",
  "mlflow.traces-v4.column-selector.item.tags": "",
  "mlflow.traces-v4.column-selector.item.tokens": "",
  "mlflow.traces-v4.column-selector.item.trace_id": "",
  "mlflow.traces-v4.column-selector.item.trace_name": "",
  "mlflow.traces-v4.column-selector.item.user": "",
  "mlflow.traces-v4.date-selector": "",
  "mlflow.traces-v4.date-selector.custom-presets.trigger": "",
  "mlflow.traces-v4.date-selector.end-date-picker": "",
  ...
  "mlflow.traces-v4.save_view.link": "",
  "mlflow.traces-v4.save_view.modal": "",
  "mlflow.traces-v4.save_view.name_input": "",
  "mlflow.traces-v4.save_view.save_button": "",
  ...
  "shared.model-trace-explorer.assessments-pane-toggle-count": "",
  ...
  "shared.model-trace-explorer.attributes.render-mode": "",
  "shared.model-trace-explorer.attributes.render-mode-radio": "",
  ...
  "shared.model-trace-explorer.copy-scalar": "",
  ...
  "shared.model-trace-explorer.copy-tool-call-id": "",
  ...
  "shared.model-trace-explorer.custom-view.build-new-custom-view-button": "",
  "shared.model-trace-explorer.custom-view.cancel-new-custom-view-button": "",
  "shared.model-trace-explorer.custom-view.create-new-view-prompt-input": "",
  ...
  "shared.model-trace-explorer.custom-view.edit-existing-view-button": "",
  "shared.model-trace-explorer.custom-view.feedback-button-down": "",
  "shared.model-trace-explorer.custom-view.feedback-button-up": "",
  "shared.model-trace-explorer.custom-view.feedback-down": "",
  "shared.model-trace-explorer.custom-view.feedback-input-text": "",
  "shared.model-trace-explorer.custom-view.feedback-radio-group": "",
  "shared.model-trace-explorer.custom-view.feedback-submit-button": "",
  "shared.model-trace-explorer.custom-view.feedback-up": "",
  "shared.model-trace-explorer.custom-view.markdown.link": "",
  "shared.model-trace-explorer.custom-view.more": "",
  "shared.model-trace-explorer.custom-view.name-input": "",
  "shared.model-trace-explorer.custom-view.name-modal": "",
  "shared.model-trace-explorer.custom-view.prompt": "",
  "shared.model-trace-explorer.custom-view.rename": "",
  "shared.model-trace-explorer.custom-view.rename-disabled-reason": "",
  "shared.model-trace-explorer.custom-view.rename-input": "",
  "shared.model-trace-explorer.custom-view.rename-modal": "",
  "shared.model-trace-explorer.custom-view.rename-view-modal": "",
  "shared.model-trace-explorer.custom-view.rename-view-modal-open-button": "",
  "shared.model-trace-explorer.custom-view.save": "",
  "shared.model-trace-explorer.custom-view.save-error": "",
  "shared.model-trace-explorer.custom-view.save-new-custom-view-with-name-modal": "",
  "shared.model-trace-explorer.custom-view.switch-view-item": "",
  "shared.model-trace-explorer.custom-view.view-switcher": "",
  "shared.model-trace-explorer.default-span-view.render-mode": "",
  "shared.model-trace-explorer.default-span-view.render-mode-radio": "",
  ...
  "shared.model-trace-explorer.header-details.edit-tags": "",
  ...
  "shared.model-trace-explorer.linked-prompts-metadata": "",
  "shared.model-trace-explorer.linked-prompts-popover": "",
  "shared.model-trace-explorer.linked-prompts-popover.prompt-link": "",
  ...
  "shared.model-trace-explorer.refresh-trace": "",
  "shared.model-trace-explorer.refresh-trace-error": "",
  "shared.model-trace-explorer.relevance-assessment-tooltip": "",
  "shared.model-trace-explorer.retriever-document-collapse": "",
  "shared.model-trace-explorer.right-pane-header-breakdown-tag": "",
  "shared.model-trace-explorer.right-pane-header-copy-session-id-tooltip": "",
  "shared.model-trace-explorer.right-pane-header-metadata-tooltip": "",
  "shared.model-trace-explorer.right-pane-header.copy-session-id": "",
  "shared.model-trace-explorer.right-pane-header.session-link": "",
  "shared.model-trace-explorer.right-pane-tabs": "",
  "shared.model-trace-explorer.search-input": "",
  "shared.model-trace-explorer.settings-button": "",
  "shared.model-trace-explorer.settings-tooltip": "",
  "shared.model-trace-explorer.show-exception-spans": "",
  "shared.model-trace-explorer.show-exception-spans-tooltip": "",
  "shared.model-trace-explorer.show-exceptions-tooltip": "",
  "shared.model-trace-explorer.show-parent-spans": "",
  "shared.model-trace-explorer.show-parent-spans-tooltip": "",
  ...
  "shared.model-trace-explorer.toggle-metric": "",
