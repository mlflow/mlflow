...
export const VirtualizedSpanCellRenderer = ({ data, onToggleExpand }: VirtualizedSpanCellRendererProps) => {
  const { theme } = useDesignSystemTheme();
  const { setAssessmentsPaneExpanded } = useModelTraceExplorerViewState();

  const { node, depth, isExpanded, hasChildren, isSelected, isInActiveChain, linesToRender } = data;
