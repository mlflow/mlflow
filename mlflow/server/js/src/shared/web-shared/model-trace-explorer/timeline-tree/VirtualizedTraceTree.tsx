...
const SpanCellRenderer = ({ data }: ICellRendererParams) => {
  if (!data) return null;
  return <VirtualizedSpanCellRenderer data={data as VirtualizedSpanRow} />;
};
...
export const VirtualizedTraceTree = ({
  ...
  const rowData = useMemo(
    () => flattenTreeToRows(rootNodes, expandedKeys, handleToggleExpand, selectedNode?.key),
    [rootNodes, expandedKeys, handleToggleExpand, selectedNode?.key],
  );
