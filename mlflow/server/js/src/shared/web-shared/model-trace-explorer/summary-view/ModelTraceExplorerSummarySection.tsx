...
import { buildAggregatedJsonFromKeyValueList } from '../ModelTraceExplorer.utils';
...
export const ModelTraceExplorerSummarySection = ({
  ...
  const aggregatedTableData = useMemo(() => buildAggregatedJsonFromKeyValueList(data), [data]);
