  ...
  const breakdownItems = useMemo(() => {
    ...
    if ((cost.input_cost ?? 0) > 0) {
      items.push({
        key: 'input',
        label: 'Input cost',
        value: formatCostUSD(cost.input_cost ?? 0),
      });
    }
    ...
    if ((cost.output_cost ?? 0) > 0) {
      items.push({
        key: 'output',
        label: 'Output cost',
        value: formatCostUSD(cost.output_cost ?? 0),
      });
    }
    ...
    if ((cost.tool_cost ?? 0) > 0) {
      items.push({
        key: 'tool',
        label: 'Tool cost',
        value: formatCostUSD(cost.tool_cost ?? 0),
      });
    }
    ...
    if ((cost.embedding_cost ?? 0) > 0) {
      items.push({
        ...
        value: formatCostUSD(cost.embedding_cost ?? 0),
      });
    }
    ...
    if ((cost.retrieval_cost ?? 0) > 0) {
      items.push({
        ...
        value: formatCostUSD(cost.retrieval_cost ?? 0),
      });
    }
    ...
    if ((cost.other_cost ?? 0) > 0) {
      items.push({
        key: 'misc',
        label: 'Other cost',
        value: formatCostUSD(cost.other_cost ?? 0),
      });
    }
