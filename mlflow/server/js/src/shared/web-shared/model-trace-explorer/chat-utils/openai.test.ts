...
const MOCK_OPENAI_RESPONSES_INPUT_WITH_FUNCTION_CALL = {
  model: 'gpt-5',
  ...
  input: [
    ...
    {
      id: 'rs_085bcde0f08b9b5500697219393bc8819796d3867b86f95c47',
      summary: [],
      type: 'reasoning',
      content: null,
      encrypted_content: null,
    ...
    },
    {
      ...
      call_id: 'call_SfBoaQhlkGzpziAczZG8SmgT',
      name: 'get_horoscope',
      type: 'function_call',
      id: 'fc_085bcde0f08b9b55006972193b2d048197b27638b97d54a104',
      status: 'completed',
    },
    {
...
describe('normalizeConversation', () => {
  ...
  it('handles a Responses input with a function call', () => {
    expect(normalizeConversation(MOCK_OPENAI_RESPONSES_INPUT_WITH_FUNCTION_CALL, 'openai')).toEqual([
      expect.objectContaining({
        role: 'user',
        content: 'What is my horoscope? I am an Aquarius.',
      }),
      expect.objectContaining({
        ...
        tool_calls: [
          expect.objectContaining({
            id: 'call_SfBoaQhlkGzpziAczZG8SmgT',
          }),
        ],
      }),
      expect.objectContaining({
        role: 'tool',
        content: '{"horoscope": "{\'sign\': \'Aquarius\'}: Next Tuesday you will befriend a baby otter."}',
