...
import { FeedbackGroup } from '../../assessments-pane/FeedbackGroup';
      ...
      <>
        <DropdownMenu.Root>
          ...
          <DropdownMenu.Content>
            ...
            >
              <FormattedMessage
                defaultMessage="LLM scorer feedback"
                description="Label for the button to add LLM scorer feedback to the trace"
              />
            </DropdownMenu.Item>
          </DropdownMenu.Content>
        </DropdownMenu.Root>
      ...
      {newTracePendingEvaluations.map((evaluation) => (
        ...
        >
          ...
          {reset && (
            ...
            >
              <FormattedMessage
                defaultMessage="Cancel scorer"
                description="Button text for canceling scorer evaluation"
              />
            </Button>
          )}
        </div>
