...
const HorizontalResizeHandle = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & {
    handleAxis?: string;
    theme: ReturnType<typeof useDesignSystemTheme>['theme'];
  }
>(function HorizontalResizeHandle({ handleAxis: _handleAxis, theme, ...domProps }, ref) {
  return (
    <div ref={ref} css={{ width: 0, position: 'relative' }} {...domProps}>
      <div
        css={{
          position: 'relative',
 ...
 * widths.
 */
const ModelTraceExplorerResizablePane: React.ForwardRefExoticComponent<
  ModelTraceExplorerResizablePaneProps & React.RefAttributes<ModelTraceExplorerResizablePaneRef>
> = forwardRef<
  ...
  return (
    ...
    >
      ...
      <ResizableBox
        axis="x"
        width={paneWidth}
        css={{ display: 'flex', flex: `0 0 ${paneWidth}px`, minHeight: 0 }}
        handle={<HorizontalResizeHandle theme={theme} />}
        onResize={(e, { size }) => {
