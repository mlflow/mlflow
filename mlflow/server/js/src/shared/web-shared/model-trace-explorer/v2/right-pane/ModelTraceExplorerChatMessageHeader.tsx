...
const getRoleIcon = (role: string) => {
  switch (role) {
    ...
    case 'function':
      return <ModelTraceExplorerIcon type={ModelIconType.FUNCTION} />;
    default:
          ...
          {message.tool_calls && message.tool_calls.length > 0 && (
            <Typography.Text color="secondary" size="sm">
              <FormattedMessage
                ...
                description="Label for tool calls attached to an assistant chat message"
              />
            </Typography.Text>
          )}
        </div>
