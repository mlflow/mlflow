...
- Static layout text (titles, labels, icons, tones) stays a plain literal — it is the SAME for every trace.`;
  ...
  "messages": [
    {
      ...
      "updateComponents": {
        ...
        "components": [
          ...
          { "id": "stat-status", "component": "StatCard", "value": { "$source": "metrics.status" }, "label": "Status", "icon": "checkCircle", "tone": "success" }
        ]
      }
    }
  ]
