...
export const QUICKSTART_TAB_MESSAGES: Record<QUICKSTART_FLAVOR, React.ReactNode> = {
  openai: (
    <FormattedMessage
  ...
  dspy: (
    <FormattedMessage defaultMessage="DSPy" description="Header for DSPy tab in the MLflow Tracing quickstart guide" />
  ),
  crewai: (
    <FormattedMessage
