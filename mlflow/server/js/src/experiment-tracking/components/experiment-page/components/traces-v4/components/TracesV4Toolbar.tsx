...
export interface TracesV4ToolbarParams {
  ...
  onDetectIssues?: () => void;
  /** The "Views" saved-views dropdown, rendered as the first item on the left (before the date selector). Omit to hide it. */
...
export interface TracesV4ToolbarSlots {
  /** Rendered before the shared search box: the Views saved-views dropdown, then the date-range selector. */
