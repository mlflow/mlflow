...
import { EvaluationDatasetRecord, EvaluationDatasetRecordsTableMetadata } from '../types';
...
export const JsonCell = ({
  ...
  const rowSize = (options?.meta as EvaluationDatasetRecordsTableMetadata)?.rowSize;
