import { Button, CodeIcon, Modal, Spinner, Typography, useDesignSystemTheme } from '@databricks/design-system';
...
export const EvaluationCodeSnippetButton = ({ experimentId }: { experimentId: string }) => {
  ...
  return (
    <>
      <Button componentId="mlflow.eval-runs.code-snippet-button" icon={<CodeIcon />} onClick={() => setIsOpen(true)}>
        <FormattedMessage
          defaultMessage="View code snippet"
          description="Label for a button that opens a modal containing a runnable evaluation code snippet"
        />
      </Button>
      <Modal
        componentId="mlflow.eval-runs.code-snippet-modal"
        title={
          <FormattedMessage
            defaultMessage="Evaluation code snippet"
            description="Title for the evaluation code snippet modal dialog"
          />
        }
        visible={isOpen}
        ...
        {!isTraceMetricsLoaded ? (
          ...
          <div css={{ display: 'flex', flexDirection: 'column', gap: theme.spacing.sm }}>
            ...
            <div css={{ position: 'relative' }}>
              <SnippetCopyAction
                componentId="mlflow.eval-runs.code-snippet-modal.copy-snippet"
