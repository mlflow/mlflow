...
const LLMScorerFormRenderer: React.FC<LLMScorerFormRendererProps> = ({ mode, control, setValue, getValues }) => {
  ...
  // Prevent form field clicks from bubbling up to the parent Card's onClick handler
  // which would expand/collapse the card when users are trying to interact with form fields
