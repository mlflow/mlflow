...
import { JudgeEvaluationResult } from './useEvaluateTraces';
      ...
      >
        {!isInitialScreen && currentEvalResult ? (
          ...
          >
            ...
            <div css={{ height: '600px' }}>{renderCurrentItem()}</div>
          </div>
        ) : error ? (
          <div
            css={{
