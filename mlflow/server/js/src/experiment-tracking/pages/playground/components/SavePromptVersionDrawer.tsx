...
export const SavePromptVersionDrawer = ({
  visible,
  onCancel,
  messages,
  params,
  ...
  // Reset the form each time the drawer is opened so it reflects the prompt
  ...
  const nameError = useMemo(() => {
    ...
    if (!trimmedName) {
      return intl.formatMessage({
        ...
        description: 'Validation error when no prompt name is provided in the playground save-to-registry drawer',
      });
    }
    if (!NAME_PATTERN.test(trimmedName)) {
      return intl.formatMessage({
        defaultMessage: 'Only alphanumeric characters, underscores, hyphens, and dots are allowed',
        description: 'Validation error for an invalid prompt name in the playground save-to-registry drawer',
      });
    }
    return null;
        ...
        title={
          ...
          >
            ...
            <FormattedMessage
              ...
              description="Title of the save-prompt-version drawer on the playground page"
            />
          </span>
        }
      >
        <div css={{ display: 'flex', flexDirection: 'column', gap: theme.spacing.md }}>
          <Typography.Paragraph withoutMargins>
            <FormattedMessage
              ...
              description="Intro paragraph at the top of the playground save-prompt-version drawer"
            />
            ...
            <Alert
              ...
              message={
                <FormattedMessage
                  ...
                  description="Warning shown in the playground save-prompt-version drawer when there are no messages to save"
                />
              }
            />
          )}
          ...
          <div>
            <FormUI.Label>
              <FormattedMessage
                ...
                description="Label for the destination selector in the playground save-prompt-version drawer"
              />
            </FormUI.Label>
            {loadedPromptName ? (
              <SegmentedControlGroup
              ...
              >
                <SegmentedControlButton value="existing">
                  <FormattedMessage
                    ...
                    description="Option to save a new version of the loaded prompt in the playground save drawer"
                ...
                <SegmentedControlButton value="new">
                  <FormattedMessage
                    ...
                    description="Option to save the playground messages as a brand-new prompt in the save drawer"
                  />
                </SegmentedControlButton>
              </SegmentedControlGroup>
            ) : (
              <Typography.Text color="secondary">
                <FormattedMessage
                  ...
                  description="Note shown in the playground save drawer when no prompt is loaded, so a new prompt is created"
                />
              </Typography.Text>
            )}
          </div>
            ...
            <div>
              <FormUI.Label htmlFor="mlflow.playground.save_prompt_version.name">
                <FormattedMessage
                  ...
                  description="Label for the new-prompt name input in the playground save-prompt-version drawer"
                />
              </FormUI.Label>
              <Input
                ...
                placeholder={intl.formatMessage({
                  ...
                  description: 'Placeholder for the new-prompt name input in the playground save-prompt-version drawer',
                })}
          ...
          <div>
            <FormUI.Label htmlFor="mlflow.playground.save_prompt_version.commit_message">
              <FormattedMessage
                ...
                description="Label for the optional commit-message input in the playground save-prompt-version drawer"
              />
            </FormUI.Label>
            <Input
          ...
          <div css={{ display: 'flex', justifyContent: 'flex-end', gap: theme.spacing.sm }}>
            <Button componentId="mlflow.playground.save_prompt_version.cancel" onClick={onCancel}>
              <FormattedMessage
                defaultMessage="Cancel"
                description="Cancel-button label on the playground save-prompt-version drawer"
              />
            </Button>
            <Button
              componentId="mlflow.playground.save_prompt_version.save"
              type="primary"
              disabled={!canSave}
              loading={isLoading}
              onClick={handleSave}
            >
              <FormattedMessage
                ...
                description="Confirm-button label on the playground save-prompt-version drawer"
              />
            </Button>
          </div>
              ...
              >
                ...
                >
                  <FormattedMessage
                    ...
                    description="Header of the messages preview in the playground save-prompt-version drawer"
                  />
                </Typography.Text>
                <div
                  css={{
