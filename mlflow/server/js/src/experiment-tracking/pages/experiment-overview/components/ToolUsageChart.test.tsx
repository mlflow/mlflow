...
describe('ToolUsageChart', () => {
  ...
  describe('with data', () => {
    const mockDataPoints = [
      createToolUsageDataPoint('2025-12-22T10:00:00Z', 'delivery_estimate', 150),
      createToolUsageDataPoint('2025-12-22T11:00:00Z', 'delivery_estimate', 180),
      createToolUsageDataPoint('2025-12-22T12:00:00Z', 'delivery_estimate', 200),
      createToolUsageDataPoint('2025-12-22T10:00:00Z', 'get_order_status', 120),
      createToolUsageDataPoint('2025-12-22T11:00:00Z', 'get_order_status', 140),
      createToolUsageDataPoint('2025-12-22T10:00:00Z', 'calculate_shipping', 90),
    ];
