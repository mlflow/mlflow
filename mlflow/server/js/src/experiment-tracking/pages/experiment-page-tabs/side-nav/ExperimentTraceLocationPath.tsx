...
import { isTablePrefixDestinationPath } from '@databricks/web-shared/genai-traces-table';
 ...
 * uses a UC table prefix location (3-part path: catalog.schema.prefix).
 * Hidden for UC schema (2-part) and V3 experiments.
 */
export const ExperimentTraceLocationPath = () => {
  ...
  if (!destinationPath || !isTablePrefixDestinationPath(destinationPath)) {
    return null;
  }
