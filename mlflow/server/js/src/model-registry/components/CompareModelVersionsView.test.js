...
import ConnectedCompareModelVersionsView, { CompareModelVersionsView } from './CompareModelVersionsView';
...
describe('unconnected tests', () => {
  ...
  beforeEach(() => {
    ...
    commonProps = {
      ...minimumProps,
      runInfos: [RunInfo.fromJs({'run_uuid': '123', 'experiment_id': '0', 'user_id': 'test.user',
        'status': 'FINISHED', 'start_time': '0', 'end_time': '21',
        'artifact_uri': './mlruns', 'lifecycle_stage': 'active'})],
...
describe('connected tests', () => {
  ...
  beforeEach(() => {
    ...
    commonStore = mockStore({
      entities: {
        runInfosByUuid: {'123': RunInfo.fromJs({'run_uuid': '123', 'experiment_id': '0',
          'user_id': 'test.user', 'status': 'FINISHED', 'start_time': '0', 'end_time': '21',
          'artifact_uri': './mlruns', 'lifecycle_stage': 'active'})},
        latestMetricsByRunUuid: {'123': {'key': 'test_metric', 'value': 0.0,
          'timestamp': '321', 'step': '42'}},
