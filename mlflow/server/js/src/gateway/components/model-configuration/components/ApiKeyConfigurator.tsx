/**
 * Pure presentation component for API key configuration.
 *
 * Renders:
 * - Toggle between "Create new" and "Use existing" API key
 * - New secret form fields (name, auth mode, credentials)
 * - Existing secret selector
 *
...
export interface ApiKeyConfiguratorProps {
...
export function ApiKeyConfigurator({
  ...
  const handleAuthModeChange = useCallback(
    (authMode: string) => {
      // Clear secret and config fields when switching auth modes
...
/**
 * Sub-component for new secret form fields
 */
