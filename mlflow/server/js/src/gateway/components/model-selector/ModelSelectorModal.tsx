...
function CostIndicator({ tier, inputCost, outputCost }: { tier: number; inputCost?: number; outputCost?: number }) {
              ...
              {filteredModels.length === 0 ? (
                ...
                >
                  {filteredModels.map((model) => {
                    const isSelected = selectedModelId === model.model;
                    ...
                    return (
                      ...
                      >
                        ...
                        <div css={{ minWidth: 0 }}>
                          ...
                          <Typography.Text
                            color="secondary"
                            css={{ fontSize: theme.typography.fontSizeSm, display: 'block' }}
                          >
                            {[
