...
import { Alert, Button, Input, Modal, Spinner, Typography, useDesignSystemTheme } from '@databricks/design-system';
...
export const TestGuardrailModal = ({ open, onClose, guardrail, experimentId }: TestGuardrailModalProps) => {
   ...
   */
  const pollForJobResult = useCallback(async (jobIds: string[], traceId: string) => {
      ...
      <div css={{ display: 'flex', flexDirection: 'column', gap: theme.spacing.md }}>
        ...
        <Alert
          ...
          message={intl.formatMessage(
            {
              defaultMessage: 'This is a {hook}-invocation {operation} guardrail. It will test against {dataSource}.',
        ...
        {inputMode === 'trace' && experimentId && (
          <div css={{ display: 'flex', flexDirection: 'column', gap: theme.spacing.sm }}>
            <Typography.Text bold>
              <FormattedMessage defaultMessage="Select a trace" description="Label for trace selection in test modal" />
            </Typography.Text>
            ...
            {!tracesLoading && traces.length > 0 && (
              ...
              >
                {traces.map((trace) => {
                  ...
                  const preview = guardrail.hook === 'PRE' ? trace.request_preview : trace.response_preview;
        ...
        {/* Test result */}
        {testError && (
          <Alert componentId="mlflow.gateway.guardrails.test-error" type="error" closable={false} message={testError} />
        )}
            ...
            <div css={{ padding: theme.spacing.md }}>
              ...
              {testResult?.result?.modified_text && (
                <>
                  ...
                  >
                    <FormattedMessage
                      defaultMessage="Modified output"
                      description="Modified text label in test result"
                    />
                  </Typography.Text>
                  <div
                    css={{
