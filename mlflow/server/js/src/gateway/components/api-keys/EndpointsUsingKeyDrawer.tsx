...
export const EndpointsUsingKeyDrawer = ({ open, endpoints, onClose }: EndpointsUsingKeyDrawerProps) => {
        ...
        title={
          <Typography.Title level={3} css={{ margin: 0 }}>
            <FormattedMessage
              ...
              description="Title for endpoints using key drawer"
          ...
          <Empty
            description={
              <FormattedMessage
                ...
                description="Empty state when no endpoints use the key"
              />
            }
          />
        ) : (
