 ...
 * - EndpointFormRenderer: Unified presentational component for both create and edit
 *
 * This component handles page-level concerns (breadcrumbs, page wrapper, FormProvider)
 * while the renderer handles just the form UI. This separation allows easy swapping
 * of renderers (full page, modal, etc.) while reusing all the business logic.
 */
