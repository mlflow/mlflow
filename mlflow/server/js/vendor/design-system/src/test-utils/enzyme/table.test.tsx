...
function mountTable() {
  ...
  return mount(
    <DesignSystemProvider>
      <Table>
        <TableRow isHeader>
          <TableHeader componentId="codegen_design-system_src_test-utils_enzyme_table.test.tsx_23">Name</TableHeader>
          <TableHeader componentId="codegen_design-system_src_test-utils_enzyme_table.test.tsx_24">Age</TableHeader>
        </TableRow>
        {data.map((row) => (
          <TableRow key={row.id}>
