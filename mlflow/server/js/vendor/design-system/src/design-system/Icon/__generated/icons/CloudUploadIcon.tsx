...
function SvgCloudUploadIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const CloudUploadIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgCloudUploadIcon} />;
});
