...
function SvgCommandPaletteIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const CommandPaletteIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgCommandPaletteIcon} />;
});
