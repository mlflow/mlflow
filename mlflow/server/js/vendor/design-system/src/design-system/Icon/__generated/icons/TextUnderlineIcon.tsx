...
function SvgTextUnderlineIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const TextUnderlineIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgTextUnderlineIcon} />;
});
