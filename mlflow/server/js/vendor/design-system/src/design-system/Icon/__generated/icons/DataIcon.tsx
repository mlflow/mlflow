...
function SvgDataIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const DataIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgDataIcon} />;
});
