...
function SvgLettersNumbersIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const LettersNumbersIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgLettersNumbersIcon} />;
});
LettersNumbersIcon.displayName = 'LettersNumbersIcon';
export default LettersNumbersIcon;
