...
function SvgFloatIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const FloatIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgFloatIcon} />;
});
