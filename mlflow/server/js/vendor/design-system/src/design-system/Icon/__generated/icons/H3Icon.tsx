...
function SvgH3Icon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const H3Icon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgH3Icon} />;
});
