...
function SvgZoomMarqueeSelection(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const ZoomMarqueeSelection = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgZoomMarqueeSelection} />;
});
