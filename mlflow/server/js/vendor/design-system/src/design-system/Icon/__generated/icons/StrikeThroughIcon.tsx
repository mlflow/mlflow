...
function SvgStrikeThroughIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const StrikeThroughIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgStrikeThroughIcon} />;
});
