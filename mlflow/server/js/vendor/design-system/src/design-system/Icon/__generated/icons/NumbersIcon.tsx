...
function SvgNumbersIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const NumbersIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgNumbersIcon} />;
});
