...
function SvgUserSparkleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const UserSparkleIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgUserSparkleIcon} />;
});
