...
function SvgCaretUpSquareIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const CaretUpSquareIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgCaretUpSquareIcon} />;
});
