...
function SvgLettersIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const LettersIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgLettersIcon} />;
});
