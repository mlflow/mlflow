...
function SvgCloudDatabaseIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const CloudDatabaseIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgCloudDatabaseIcon} />;
});
