...
function SvgInfoBookIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const InfoBookIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgInfoBookIcon} />;
});
