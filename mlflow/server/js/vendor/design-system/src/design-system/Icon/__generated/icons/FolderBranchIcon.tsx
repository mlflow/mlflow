...
function SvgFolderBranchIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const FolderBranchIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgFolderBranchIcon} />;
});
