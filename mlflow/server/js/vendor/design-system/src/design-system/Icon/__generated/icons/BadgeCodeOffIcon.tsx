...
function SvgBadgeCodeOffIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const BadgeCodeOffIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgBadgeCodeOffIcon} />;
});
