...
function SvgFolderCloudIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const FolderCloudIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgFolderCloudIcon} />;
});
