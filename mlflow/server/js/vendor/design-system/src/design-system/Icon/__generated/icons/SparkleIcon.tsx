...
function SvgSparkleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const SparkleIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgSparkleIcon} />;
});
