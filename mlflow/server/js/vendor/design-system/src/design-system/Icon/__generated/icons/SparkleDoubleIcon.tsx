...
function SvgSparkleDoubleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const SparkleDoubleIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgSparkleDoubleIcon} />;
});
SparkleDoubleIcon.displayName = 'SparkleDoubleIcon';
export default SparkleDoubleIcon;
