...
function SvgGearFillIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const GearFillIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgGearFillIcon} />;
});
