...
function SvgCloudDownloadIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const CloudDownloadIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgCloudDownloadIcon} />;
});
