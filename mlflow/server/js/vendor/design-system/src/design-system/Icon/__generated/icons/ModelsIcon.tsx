...
function SvgModelsIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const ModelsIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgModelsIcon} />;
});
