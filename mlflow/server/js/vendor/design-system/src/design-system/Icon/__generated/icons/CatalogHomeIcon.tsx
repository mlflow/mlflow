...
function SvgCatalogHomeIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const CatalogHomeIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgCatalogHomeIcon} />;
});
