...
function SvgPencilSparkleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const PencilSparkleIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgPencilSparkleIcon} />;
});
PencilSparkleIcon.displayName = 'PencilSparkleIcon';
export default PencilSparkleIcon;
