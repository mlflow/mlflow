...
function SvgForkIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const ForkIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgForkIcon} />;
});
