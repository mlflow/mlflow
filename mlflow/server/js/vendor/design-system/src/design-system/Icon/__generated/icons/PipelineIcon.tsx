...
function SvgPipelineIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const PipelineIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgPipelineIcon} />;
});
