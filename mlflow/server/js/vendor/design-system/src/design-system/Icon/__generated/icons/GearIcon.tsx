...
function SvgGearIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const GearIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgGearIcon} />;
});
