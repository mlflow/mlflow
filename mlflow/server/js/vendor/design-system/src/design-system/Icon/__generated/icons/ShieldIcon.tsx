...
function SvgShieldIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const ShieldIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgShieldIcon} />;
});
