...
function SvgDagIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const DagIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgDagIcon} />;
});
