...
function SvgCommandIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const CommandIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgCommandIcon} />;
});
