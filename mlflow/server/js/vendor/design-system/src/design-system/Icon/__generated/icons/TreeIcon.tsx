...
function SvgTreeIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const TreeIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgTreeIcon} />;
});
