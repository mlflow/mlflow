...
function SvgWrenchSparkleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const WrenchSparkleIcon = forwardRef((props: IconProps, forwardedRef?: Ref<HTMLSpanElement>) => {
  return <Icon ref={forwardedRef} {...props} component={SvgWrenchSparkleIcon} />;
});
WrenchSparkleIcon.displayName = 'WrenchSparkleIcon';
export default WrenchSparkleIcon;
