 ...
 */
export function getLessVariables(isDarkMode: boolean): Record<string, any> {
  return {
 ...
 */
const transformLessVariableValue = (lessVariable: string | number) => {
 ...
 */
export function getLessVariablesObject(isDarkMode: boolean): Record<string, string | any> {
  const lessVariables = getLessVariables(isDarkMode);
  const lessVariablesObject: Record<string, string | any> = {};
 ...
 */
export function getLessVariablesText(isDarkMode: boolean): string {
  const lessVariables = getLessVariables(isDarkMode);
