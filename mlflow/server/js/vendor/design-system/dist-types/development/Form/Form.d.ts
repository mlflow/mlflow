...
interface FormContextValue {
    ...
    eventRef?: React.MutableRefObject<React.UIEvent | null>;
    formRef?: React.MutableRefObject<HTMLFormElement | null>;
}
export declare const useFormContext: () => FormContextValue;
export interface FormContextResetBoundaryProps {
    children: React.ReactNode;
}
export declare const FormContextResetBoundary: ({ children }: FormContextResetBoundaryProps) => import("@emotion/react/jsx-runtime").JSX.Element;
