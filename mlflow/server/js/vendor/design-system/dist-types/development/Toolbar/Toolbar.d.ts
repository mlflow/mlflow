...
export declare const ToggleGroup: import("react").ForwardRefExoticComponent<(RadixToolbar.ToolbarToggleGroupMultipleProps | RadixToolbar.ToolbarToggleGroupSingleProps) & import("react").RefAttributes<HTMLDivElement>>;
