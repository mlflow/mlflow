...
}) => Pick<CSSObject, "background" | "backgroundAttachment" | "backgroundRepeat" | "backgroundSize">;
/** Returns CSS containment styles when the `databricks.fe.eda.enablePanelContainment` safex flag is on. */
export declare function getPanelContainmentStyle(): CSSObject;
