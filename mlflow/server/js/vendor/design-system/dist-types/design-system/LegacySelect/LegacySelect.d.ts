...
export declare const LegacySelect: (<T extends AntdSelectValue>(props: LegacySelectProps<T> & {
    ...
    Option: React.ForwardRefExoticComponent<LegacySelectOptionProps & React.RefAttributes<HTMLElement>> & {
        isSelectOption: boolean;
    };
    OptGroup: React.ForwardRefExoticComponent<LegacySelectOptGroupProps & React.RefAttributes<HTMLElement>> & {
        isSelectOptGroup: boolean;
    };
