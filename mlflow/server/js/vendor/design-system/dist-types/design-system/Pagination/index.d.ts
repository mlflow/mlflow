...
export declare function getPaginationEmotionStyles(clsPrefix: string, theme: Theme, useNewBorderColors?: boolean): SerializedStyles;
...
export declare const CursorPagination: React.FC<React.PropsWithChildren<CursorPaginationProps>>;
export {};
