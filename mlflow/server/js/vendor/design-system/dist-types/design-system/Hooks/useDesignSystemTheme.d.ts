...
export declare function WithDesignSystemThemeHoc<P>(Component: React.ComponentType<React.PropsWithChildren<P & DesignSystemHocProps>>): (props: P) => ReactElement<any, string | React.JSXElementConstructor<any>>;
