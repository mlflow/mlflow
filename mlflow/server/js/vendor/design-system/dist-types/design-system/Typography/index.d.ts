...
export type { TypographyHintProps } from './Hint';
...
export type { TypographyTextMiddleElideProps } from './TextMiddleElide';
export type { TypographyTitleProps } from './Title';
export type { TypographTruncateProps } from './Truncate';
