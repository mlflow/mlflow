...
export declare const useDesignSystemEventComponentCallbacks: ({ componentType, componentId, componentSubType, analyticsEvents, valueHasNoPii, shouldStartInteraction, isInteractionSubject, }: {
    ...
    componentSubType?: DesignSystemEventProviderComponentSubTypes | undefined;
    analyticsEvents: readonly DesignSystemEventProviderAnalyticsEventTypes[];
    valueHasNoPii?: boolean | undefined;
    shouldStartInteraction?: boolean | undefined;
    isInteractionSubject?: boolean | undefined;
}) => {
    onClick: (event: React.UIEvent<Element, UIEvent> | undefined) => void;
