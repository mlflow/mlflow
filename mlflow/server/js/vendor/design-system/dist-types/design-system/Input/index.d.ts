...
declare const Input: import("react").ForwardRefExoticComponent<import("./common").InputProps & import("react").RefAttributes<import("antd").Input>> & {
    ...
    Password: import("react").FC<import("react").PropsWithChildren<import("./common").PasswordProps>>;
    Group: ({ dangerouslySetAntdProps, dangerouslyAppendEmotionCSS, compact, buttonSide, ...props }: import("./common").InputGroupProps) => import("@emotion/react/jsx-runtime").JSX.Element;
};
