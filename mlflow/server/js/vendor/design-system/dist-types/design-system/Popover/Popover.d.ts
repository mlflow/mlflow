...
export declare const Root: ({ children, onOpenChange, componentId, analyticsEvents, ...props }: PopoverRootProps) => ReactElement<any, string | import("react").JSXElementConstructor<any>>;
