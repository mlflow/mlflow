...
import type { ImplicitContextValue } from './implicitContext';
...
declare function wrapLegacyFormRules(rules: AntDFormItemProps['rules'], implicitContext: ImplicitContextValue): AntDFormItemProps['rules'];
/**
...
declare const FormItem: FC<React.PropsWithChildren<LegacyFormItemProps>>;
export declare const LegacyForm: FormInterface;
export declare const __INTERNAL_DO_NOT_USE__FormItem: FC<import("react").PropsWithChildren<LegacyFormItemProps>>;
export declare const __INTERNAL_DO_NOT_USE__wrapLegacyFormRules: typeof wrapLegacyFormRules;
export {};
