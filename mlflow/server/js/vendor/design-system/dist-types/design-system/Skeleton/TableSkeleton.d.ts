...
export declare const TableSkeletonRows: <TData, MetaType extends MinMetaType>({ table, actionColumnIds, numRows, loading, loadingDescription, label, }: TableSkeletonRowsProps<TData>) => React.ReactElement;
export {};
