...
export declare const Root: ({ children, onOpenChange, ...props }: RadixContextMenuProps) => ReactElement<any, string | React.JSXElementConstructor<any>>;
...
export declare const ContextMenu: {
    Root: ({ children, onOpenChange, ...props }: RadixContextMenuProps) => ReactElement<any, string | React.JSXElementConstructor<any>>;
