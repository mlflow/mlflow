...
function generateUuidV4() {
  ...
  const uuid = (_window$crypto = window.crypto) === null || _window$crypto === void 0 || (_window$crypto$random = _window$crypto.randomUUID) === null || _window$crypto$random === void 0 ? void 0 : _window$crypto$random.call(_window$crypto);
  if (uuid) {
    return uuid;
  }
...
const useDesignSystemEventComponentCallbacks = _ref => {
  ...
  }, [context, componentId, analyticsEvents, componentType, componentSubType, shouldStartInteractionComplete, isInteractionSubject, valueHasNoPii, componentViewId]);
  return callbacks;
};
...
//# sourceMappingURL=Popover-CwN5G-JZ.js.map
