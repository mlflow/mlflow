...
disableLegacyAntVirtualization = process.env.NODE_ENV === 'test' ? true : undefined })=>{
    ...
    // Use the patched provider if the flag is enabled
    const RadixTooltipProvider = usePatchedTooltip ? TooltipProvider : TooltipProvider$1;
    ...
    return /*#__PURE__*/ jsx(DesignSystemProviderPropsContext.Provider, {
        ...
        children: /*#__PURE__*/ jsx(ThemeProvider, {
            ...
            children: /*#__PURE__*/ jsx(AntDConfigProviderPropsContext.Provider, {
                ...
                children: /*#__PURE__*/ jsx(RadixTooltipProvider, {
...
const getComboboxContentWrapperStyles = (theme, { maxHeight = '100vh', maxWidth = '100vw', minHeight = 0, minWidth = 0, width, useNewShadows, useNewBorderColors })=>{
    return /*#__PURE__*/ css({
        maxHeight,
        maxWidth,
        minHeight,
...
const getButtonEmotionStyles = ({ theme, classNamePrefix, loading, withIcon, onlyIcon, isAnchor, enableAnimation, size, type, useFocusPseudoClass, forceIconStyles, danger, useNewShadows, useNewBorderRadii })=>{
...
const Root = ({ children, onOpenChange, componentId, analyticsEvents = [
    DesignSystemEventProviderAnalyticsEventTypes.OnView
], ...props })=>{
...
const Content = /*#__PURE__*/ forwardRef(function Content({ children, minWidth = 220, maxWidth, ...props }, ref) {
...
const Trigger = /*#__PURE__*/ forwardRef(function Trigger({ children, ...props }, ref) {
