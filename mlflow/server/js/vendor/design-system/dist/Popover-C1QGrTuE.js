...
const highlightOption = function(currentSelection, prevSelection) {
    ...
    var _currentSelection_scrollIntoView;
    if (prevSelection) {
    ...
    (_currentSelection_scrollIntoView = currentSelection.scrollIntoView) === null || _currentSelection_scrollIntoView === void 0 ? void 0 : _currentSelection_scrollIntoView.call(currentSelection, {
        block: 'center'
    });
};
const findHighlightedOption = (options)=>{
    var _options_find;
    return (_options_find = options.find((option)=>option.getAttribute('data-highlighted') === 'true')) !== null && _options_find !== void 0 ? _options_find : undefined;
};
const getContentOptions = (element)=>{
    var _element_closest;
    const options = (_element_closest = element.closest('[data-combobox-option-list="true"]')) === null || _element_closest === void 0 ? void 0 : _element_closest.querySelectorAll('[role="option"]');
            ...
            switch(e.key){
                ...
                case 'ArrowUp':
                    ...
                    if (previousSibling) {
                        ...
                        var _getContentOptions1;
                        const lastOption = (_getContentOptions1 = getContentOptions(e.currentTarget)) === null || _getContentOptions1 === void 0 ? void 0 : _getContentOptions1.slice(-1)[0];
                        if (lastOption) {
...
const dialogComboboxLookAheadKeyDown = (e, setLookAhead, lookAhead)=>{
    ...
    e.preventDefault();
    var _e_currentTarget_parentElement_children;
    const siblings = Array.from((_e_currentTarget_parentElement_children = (_e_currentTarget_parentElement = e.currentTarget.parentElement) === null || _e_currentTarget_parentElement === void 0 ? void 0 : _e_currentTarget_parentElement.children) !== null && _e_currentTarget_parentElement_children !== void 0 ? _e_currentTarget_parentElement_children : []);
    ...
    const nextSiblingIndex = siblings.findIndex((sibling)=>{
        var _sibling_textContent;
        var _sibling_textContent_toLowerCase;
        const siblingLabel = (_sibling_textContent_toLowerCase = (_sibling_textContent = sibling.textContent) === null || _sibling_textContent === void 0 ? void 0 : _sibling_textContent.toLowerCase()) !== null && _sibling_textContent_toLowerCase !== void 0 ? _sibling_textContent_toLowerCase : '';
...
const COMBOBOX_MENU_ITEM_PADDING = [
    6,
    32,
    6,
    12
...
const getComboboxOptionLabelStyles = (param)=>{
    let { theme, dangerouslyHideCheck, textOverflowMode, contentWidth, hasHintColumn } = param;
    return /*#__PURE__*/ css({
...
function observeElement(element, callback) {
    ...
    sharedObserver === null || sharedObserver === void 0 ? void 0 : sharedObserver.observe(element);
    return ()=>{
        if (element) {
            sharedObserver === null || sharedObserver === void 0 ? void 0 : sharedObserver.unobserve(element);
...
function generateUuidV4() {
    var _window_crypto_randomUUID, _window_crypto;
    const uuid = (_window_crypto = window.crypto) === null || _window_crypto === void 0 ? void 0 : (_window_crypto_randomUUID = _window_crypto.randomUUID) === null || _window_crypto_randomUUID === void 0 ? void 0 : _window_crypto_randomUUID.call(_window_crypto);
    if (uuid) {
        return uuid;
    }
...
function extractReferrerComponent() {
    ...
    var _activeElement_dataset;
    const { componentType, componentId } = (_activeElement_dataset = activeElement === null || activeElement === void 0 ? void 0 : activeElement.dataset) !== null && _activeElement_dataset !== void 0 ? _activeElement_dataset : {};
...
const Button = /* #__PURE__ */ (()=>{
    ...
    param, ref) {
        ...
        const handleClick = useCallback((event)=>{
            ...
            if (props.htmlType === 'submit' && ((_formContext_formRef = formContext.formRef) === null || _formContext_formRef === void 0 ? void 0 : _formContext_formRef.current)) {
...
function TextMiddleElide(param) {
    ...
    const disableElide = ((_process = process) === null || _process === void 0 ? void 0 : (_process_env = _process.env) === null || _process_env === void 0 ? void 0 : _process_env.NODE_ENV) === 'test'; // so unit tests play nice
    ...
    useEffect(()=>{
        ...
        const clipboardCopyHandler = (e)=>{
            ...
            e === null || e === void 0 ? void 0 : (_e_clipboardData = e.clipboardData) === null || _e_clipboardData === void 0 ? void 0 : _e_clipboardData.setData('text/plain', text);
        };
        const selector = `.${id}`;
        (_document_querySelector = document.querySelector(selector)) === null || _document_querySelector === void 0 ? void 0 : _document_querySelector.addEventListener('copy', clipboardCopyHandler);
        return ()=>{
            var _document_querySelector;
            (_document_querySelector = document.querySelector(selector)) === null || _document_querySelector === void 0 ? void 0 : _document_querySelector.removeEventListener('copy', clipboardCopyHandler);
        };
    }, [
        id,
        text
    ]);
    var _textProps_title;
    return /*#__PURE__*/ jsx(Text, {
        ...
        ...textProps,
        "aria-label": text,
        title: (_textProps_title = textProps.title) !== null && _textProps_title !== void 0 ? _textProps_title : text,
        className: id,
