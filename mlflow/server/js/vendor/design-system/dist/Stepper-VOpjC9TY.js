...
const Button = /* #__PURE__ */(() => {
  ...
  _ref2, ref) {
    ...
    const emitOnView = safex('databricks.fe.observability.defaultButtonComponentView', false);
    const formContext = useFormContext();
    const {
      theme,
      classNamePrefix
