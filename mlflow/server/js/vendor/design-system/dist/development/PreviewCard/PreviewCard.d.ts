...
export declare const PreviewCard: ({ icon, title, subtitle, children, startActions, endActions, image, onClick, dangerouslyAppendEmotionCSS, ...props }: PreviewCardProps) => import("@emotion/react/jsx-runtime").JSX.Element;
