...
export declare const TitleSkeleton: ({ label, seed, frameRate, style, loading, loadingDescription, ...restProps }: TitleSkeletonProps) => import("@emotion/react/jsx-runtime").JSX.Element;
export {};
