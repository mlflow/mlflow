...
export interface ModalProps extends HTMLDataAttributes, AnalyticsEventPropsWithStartInteraction<DesignSystemEventProviderAnalyticsEventTypes.OnView> {
    dangerouslySetAntdProps?: Partial<Pick<AntDModalProps, 'bodyStyle' | 'width' | 'wrapProps' | 'closable' | 'maskClosable' | 'keyboard' | 'centered' | 'closeIcon' | 'style' | 'mask' | 'modalRender' | 'okType'>>;
