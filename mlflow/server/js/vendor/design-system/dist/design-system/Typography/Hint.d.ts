...
export interface HintProps extends AntDTypographyProps, Pick<AntDTextProps, 'ellipsis' | 'id' | 'title' | 'aria-label'>, HTMLDataAttributes, DangerouslySetAntdProps<Omit<AntDTextProps, 'hint'>> {
    bold?: boolean;
    size?: 'sm' | 'md' | 'lg' | 'xl' | 'xxl';
    withoutMargins?: boolean;
    color?: TypographyColor;
}
export declare function Hint(userProps: HintProps): JSX.Element;
export {};
