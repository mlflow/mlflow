...
export interface ParagraphProps extends AntDTypographyProps, Pick<AntDParagraphProps, 'ellipsis' | 'disabled' | 'id' | 'title' | 'aria-label'>, HTMLDataAttributes, DangerouslySetAntdProps<AntDParagraphProps> {
