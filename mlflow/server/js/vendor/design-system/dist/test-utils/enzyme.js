 ...
 */ function findAllByText(wrapper, text) {
    let { trim = false } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
 ...
 * });
 */ function _waitFor(f) {
    let { interval = 50, stackTraceError, timeout = 1500 } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
 ...
 */ function getTableRowByCellText(tableWrapper, cellText) {
    ...
    const matchingRows = findAllByRole(tableWrapper, 'row')// Skip first row (table header)
    .slice(1).filter((row)=>{
