...
const getTheme = _memoize(getThemeImpl, function (isDarkMode) {
...
const COMBOBOX_MENU_ITEM_PADDING = [6, 32, 6, 12];
...
function getDarkModePortalStyles(theme, useNewShadows) {
...
let DesignSystemEventProviderComponentSubTypes = /*#__PURE__*/function (DesignSystemEventProviderComponentSubTypes) {
...
const useDesignSystemEventComponentCallbacks = _ref => {
  ...
  const shouldStartInteractionComplete = useMemo(() => shouldStartInteraction || shouldStartInteraction === undefined && !suppressInteractionContext.suppressAnalyticsStartInteraction, [suppressInteractionContext, shouldStartInteraction]);
  const callbacks = useMemo(() => {
    ...
    return {
      ...
      onSubmit: payload => {
        const mode = shouldTriggerCallback(DesignSystemEventProviderAnalyticsEventTypes.OnSubmit, analyticsEvents) ? 'default' : 'associate_event_only';
        context.callback({
  ...
  }, [context, componentId, analyticsEvents, componentType, componentSubType, shouldStartInteractionComplete, isInteractionSubject, valueHasNoPii]);
  return callbacks;
};
...
function TextMiddleElide(_ref) {
  var _process, _textProps$title;
  let {
    text,
    suffixLength = MiddleElideSuffixLength,
    ...textProps
  } = _ref;
  const id = useMemo(() => _uniqueId('text-middle-elided-'), []);
  const {
    start,
    suffix
  } = getStartAndSuffix(text, suffixLength);
  const disableElide = ((_process = process) === null || _process === void 0 || (_process = _process.env) === null || _process === void 0 ? void 0 : _process.NODE_ENV) === 'test'; // so unit tests play nice
  ...
  useEffect(() => {
    ...
    const clipboardCopyHandler = e => {
      ...
      e === null || e === void 0 || (_e$clipboardData = e.clipboardData) === null || _e$clipboardData === void 0 || _e$clipboardData.setData('text/plain', text);
    };
    const selector = `.${id}`;
    (_document$querySelect = document.querySelector(selector)) === null || _document$querySelect === void 0 || _document$querySelect.addEventListener('copy', clipboardCopyHandler);
    return () => {
      var _document$querySelect2;
      (_document$querySelect2 = document.querySelector(selector)) === null || _document$querySelect2 === void 0 || _document$querySelect2.removeEventListener('copy', clipboardCopyHandler);
    };
  }, [id, text]);
  return jsx(Text, {
    ...
    ...textProps,
    "aria-label": text,
    title: (_textProps$title = textProps.title) !== null && _textProps$title !== void 0 ? _textProps$title : text,
    className: id,
...
const Root = _ref => {
  ...
  const eventContext = useDesignSystemEventComponentCallbacks({
    ...
    componentId: componentId !== null && componentId !== void 0 ? componentId : 'design_system.popover',
    analyticsEvents: memoizedAnalyticsEvents
  });
  useEffect(() => {
...
const Content = /*#__PURE__*/forwardRef(function Content(_ref2, ref) {
  let {
    children,
    minWidth = 220,
    maxWidth,
...
const Close = /*#__PURE__*/forwardRef(function Close(_ref4, ref) {
  let {
    children,
    ...props
  } = _ref4;
...
const Arrow = /*#__PURE__*/forwardRef(function Arrow(_ref5, ref) {
  let {
    children,
    ...props
  } = _ref5;
...
const popoverContentStyles = (theme, useNewShadows) => ({
...
export { getContentOptions as $, getDarkModePortalStyles as A, Button as B, CloseIcon as C, DesignSystemAntDConfigProvider as D, getShadowScrollStyles as E, Form as F, useDesignSystemContext as G, Spinner as H, Icon as I, useUniqueId as J, Arrow as K, LoadingState as L, visuallyHidden as M, CheckIcon as N, ComponentFinderContext as O, getComboboxContentWrapperStyles as P, getFooterStyles as Q, Root as R, Stepper as S, Typography as T, highlightFirstNonDisabledOption as U, getInfoIconStyles as V, WarningIcon as W, getKeyboardNavigationFunctions as X, dialogComboboxLookAheadKeyDown as Y, getCheckboxStyles as Z, getDialogComboboxOptionLabelWidth as _, useDesignSystemSafexFlags as a, findHighlightedOption as a0, highlightOption as a1, findClosestOptionSibling as a2, getComboboxOptionLabelStyles as a3, getSelectItemWithHintColumnStyles as a4, getHintColumnStyles as a5, useComponentFinderContext as a6, ApplyDesignSystemContextOverrides as a7, LoadingIcon as a8, Title as a9, ColorVars as aA, AccessibleContainer as aa, DU_BOIS_ENABLE_ANIMATION_CLASSNAME as ab, getDefaultStyles as ac, getPrimaryStyles as ad, getDisabledSplitButtonStyles as ae, getDisabledPrimarySplitButtonStyles as af, getMemoizedButtonEmotionStyles as ag, getButtonEmotionStyles as ah, DesignSystemEventProviderComponentSubTypes as ai, DesignSystemEventProvider as aj, useDesignSystemEventSuppressInteractionContext as ak, DesignSystemThemeContext as al, DesignSystemContext as am, DesignSystemThemeProvider as an, DesignSystemProvider as ao, ApplyDesignSystemFlags as ap, useAntDConfigProviderContext as aq, isOptionDisabled as ar, resetTabIndexToFocusedElement as as, WithDesignSystemThemeHoc as at, NewWindowIcon as au, LoadingStateContext as av, Popover as aw, getTypographyColor as ax, getBottomOnlyShadowScrollStyles as ay, getVirtualizedComboboxMenuItemStyles as az, addDebugOutlineIfEnabled as b, getAnimationCss as c, DesignSystemEventProviderAnalyticsEventTypes as d, useFormContext as e, useDesignSystemEventComponentCallbacks as f, getValidationStateColor as g, DesignSystemEventProviderComponentTypes as h, importantify as i, DangerIcon as j, DesignSystemEventProviderComponentSubTypeMap as k, useNotifyOnFirstView as l, Trigger as m, Content as n, ChevronLeftIcon as o, primitiveColors as p, ChevronRightIcon as q, getComboboxOptionItemWrapperStyles as r, RhfForm as s, DesignSystemEventSuppressInteractionProviderContext as t, useDesignSystemTheme as u, DesignSystemEventSuppressInteractionTrueContextValue as v, safex as w, augmentWithDataComponentProps as x, RestoreAntDDefaultClsPrefix as y, addDebugOutlineStylesIfEnabled as z };
//# sourceMappingURL=Stepper-BevE-qWg.js.map
