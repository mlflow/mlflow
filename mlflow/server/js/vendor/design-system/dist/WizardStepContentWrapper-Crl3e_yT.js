...
import { I as Icon, v as DesignSystemEventSuppressInteractionProviderContext, w as DesignSystemEventSuppressInteractionTrueContextValue, u as useDesignSystemTheme, s as safex, e as useDesignSystemEventComponentCallbacks, f as DesignSystemEventProviderComponentTypes, j as useNotifyOnFirstView, d as DesignSystemEventProviderAnalyticsEventTypes, x as augmentWithDataComponentProps, T as Typography, B as Button, C as CloseIcon, y as addDebugOutlineStylesIfEnabled, b as getAnimationCss, z as getDarkModePortalStyles, A as getShadowScrollStyles, E as useDesignSystemContext, D as DesignSystemAntDConfigProvider, a as addDebugOutlineIfEnabled, G as RestoreAntDDefaultClsPrefix, k as DangerIcon, i as importantify, o as ChevronRightIcon, n as ChevronLeftIcon, W as WarningIcon, L as LoadingIcon, H as DEFAULT_SPACING_UNIT, R as Root$1, l as Trigger$1, m as Content$2 } from './Popover-C9XzCfd9.js';
...
const modalContentStyles = (theme, maxedOutHeight, useNewBorderRadii, useNewBorderColors)=>{
    ...
    return /*#__PURE__*/ jsxs(Fragment, {
        children: [
            cancelText && /*#__PURE__*/ jsx(Button, {
                // eslint-disable-next-line @databricks/no-dynamic-property-value -- http://go/static-frontend-log-property-strings exempt:ac31febe-9bad-476d-99ff-278cc11d71ea
    ...
    const dialogContent = /*#__PURE__*/ jsx(DialogPrimitive.Content, {
        ...
        children: /*#__PURE__*/ jsxs("div", {
            ...
            css: [
                ...
                modalContentStyles(theme, verticalSizing === 'maxed_out', useNewBorderRadii, useNewBorderColors)
            ],
            style: {
...
const getModalEmotionStyles = (args)=>{
    const { theme, clsPrefix, hasFooter = true, maxedOutHeight, useNewBorderRadii, useNewBorderColors } = args;
 ...
 */ function DefaultFooter({ componentId, onOk, onCancel, confirmLoading, okText, cancelText, okButtonProps, cancelButtonProps, autoFocusButton, shouldStartInteraction }) {
    ...
    return /*#__PURE__*/ jsxs(Fragment, {
        children: [
            cancelText && /*#__PURE__*/ jsx(Button, {
                // eslint-disable-next-line @databricks/no-dynamic-property-value -- http://go/static-frontend-log-property-strings exempt:eb49a50a-f8af-4343-8ea2-b533a6b85525
    ...
    return compact([
        !cancelStepButtonHidden && (moveCancelToOtherSide ? /*#__PURE__*/ jsx("div", {
            ...
            children: /*#__PURE__*/ jsx(CancelButton, {
                ...
                // eslint-disable-next-line @databricks/no-dynamic-property-value -- http://go/static-frontend-log-property-strings exempt:4b31acca-dae8-44a7-a7f5-fa3e1bc167c5
                componentId: componentId ? `${componentId}.cancel` : undefined
            })
        }, "cancel") : /*#__PURE__*/ jsx(CancelButton, {
            onCancel: onCancel,
            cancelButtonContent: cancelButtonContent,
            // eslint-disable-next-line @databricks/no-dynamic-property-value -- http://go/static-frontend-log-property-strings exempt:acae06b0-d74d-44ee-86db-15b3014e2bcf
            componentId: componentId ? `${componentId}.cancel` : undefined
        }, "cancel")),
...
function Content({ title, modalTitleWhenCompact, width, children, closeLabel, displayModalWhenCompact }) {
    ...
    if (displayModalWhenCompact) {
        return /*#__PURE__*/ jsx(Modal, {
            // eslint-disable-next-line @databricks/no-dynamic-property-value -- http://go/static-frontend-log-property-strings exempt:a0e9c351-a016-4724-bce3-ad7a42263766
    ...
    return /*#__PURE__*/ jsx(Sidebar, {
        ...
        children: /*#__PURE__*/ jsx(Sidebar.Content, {
            // eslint-disable-next-line @databricks/no-dynamic-property-value -- http://go/static-frontend-log-property-strings exempt:c458e101-d5d2-4eb6-8f08-17c78d0e2802
                        ...
                        /*#__PURE__*/ jsxs("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ jsx(Button, {
                                    ...
                                    icon: /*#__PURE__*/ jsx(CloseIcon, {}),
                                    // eslint-disable-next-line @databricks/no-dynamic-property-value -- http://go/static-frontend-log-property-strings exempt:921f66a9-540d-4e93-86c1-e6fa7b0dfc5e
...
//# sourceMappingURL=WizardStepContentWrapper-Crl3e_yT.js.map
