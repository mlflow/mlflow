...
function getGradients(isDarkMode) {
  ...
  return {
    aiBorderGradient: `linear-gradient(135deg, ${colors.branded.ai.gradientStart} 21.06%, ${colors.branded.ai.gradientMid} 53.65%, ${colors.branded.ai.gradientEnd} 80.06%)`
  };
}
...
const useDesignSystemEventComponentCallbacks = _ref => {
  ...
  // If shouldStartInteraction is explicitly true or has no suppression when shouldStartInteraction is not defined, then it will start the interaction
