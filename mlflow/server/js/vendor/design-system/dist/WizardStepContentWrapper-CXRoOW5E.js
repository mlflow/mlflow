...
function Content$1(param) {
    let { disableResize, openPanelId, closable = true, onClose, onResizeStart, onResizeStop, width, minWidth, maxWidth, destroyInactivePanels = false, children, dangerouslyAppendEmotionCSS, enableCompact, resizeBoxStyle, noSideBorder, componentId } = param;
    const { theme } = useDesignSystemTheme();
        ...
        children: disableResize || isCompact ? /*#__PURE__*/ jsxs(Fragment, {
            ...
            children: [
                ...
                /*#__PURE__*/ jsx(ResizableBox, {
                    ...
                    handle: /*#__PURE__*/ jsx(ResizablePanelHandle, {
                        css: /*#__PURE__*/ css({
                            width: 10,
                            height: '100%',
                            position: 'absolute',
...
//# sourceMappingURL=WizardStepContentWrapper-CXRoOW5E.js.map
