...
import { u as useDesignSystemTheme, B as Button, i as importantify, T as Typography, C as CloseIcon, o as ChevronRightIcon, q as ChevronLeftIcon, a as addDebugOutlineIfEnabled, W as WarningIcon, k as DangerIcon, w as LoadingIcon, x as CheckIcon, y as DEFAULT_SPACING_UNIT, z as getShadowScrollStyles, A as Tooltip, E as Modal, I as InfoSmallIcon, R as Root$1, l as Trigger$1, G as ListIcon, m as Content$2 } from './Tabs-Boh-9zWA.js';
...
function VerticalWizardContent({ width, height, steps: wizardSteps, currentStepIndex, localizeStepNumber, onStepsChange, title, padding, verticalCompactButtonContent, enableClickingToSteps, verticalDocumentationSidebarConfig, hideDescriptionForFutureSteps = false, contentMaxWidth, compactStepperBreakpoint, compactBreakpointBehavior = 'viewport', ...footerProps }) {
    const { theme } = useDesignSystemTheme();
    ...
    return /*#__PURE__*/ jsx(Wrapper, {
        ...
        children: /*#__PURE__*/ jsxs("div", {
            ...
            children: [
                ...
                isCompactStepper && /*#__PURE__*/ jsxs(Root$1, {
                ...
                /*#__PURE__*/ jsxs("div", {
                    css: {
                        ...
                        height: isCompactStepper ? `calc(100% - ${EXTRA_COMPACT_BUTTON_HEIGHT}px)` : '100%',
