...
function ModalInternal(param) {
    ...
    const emitViewEventThroughVisibleEffect = (dangerouslySetAntdProps === null || dangerouslySetAntdProps === void 0 ? void 0 : dangerouslySetAntdProps.closable) === false;
    ...
    const onCancelWrapper = (e)=>{
        ...
        (_props_onCancel = props.onCancel) === null || _props_onCancel === void 0 ? void 0 : _props_onCancel.call(props, e);
    };
 ...
 */ function useMediaQuery(param) {
    ...
    var _options_defaultValue;
    // TODO: Refactor this code after the deprecated signature has been removed.
    const defaultValue = typeof options === 'boolean' ? options : (_options_defaultValue = options === null || options === void 0 ? void 0 : options.defaultValue) !== null && _options_defaultValue !== void 0 ? _options_defaultValue : false;
    var _options_initializeWithValue;
    const initializeWithValue = typeof options === 'boolean' ? undefined : (_options_initializeWithValue = options === null || options === void 0 ? void 0 : options.initializeWithValue) !== null && _options_initializeWithValue !== void 0 ? _options_initializeWithValue : undefined;
        ...
        children: disableResize || isCompact ? /*#__PURE__*/ jsxs(Fragment, {
            ...
            children: [
                ...
                /*#__PURE__*/ jsx(ResizableBox, {
                    ...
                    minConstraints: [
                        minWidth !== null && minWidth !== void 0 ? minWidth : DEFAULT_WIDTH,
                        150
                    ],
                    maxConstraints: [
                        maxWidth !== null && maxWidth !== void 0 ? maxWidth : 800,
                        150
                    ],
                    onResizeStart: (_, param)=>{
                        let { size } = param;
                        onResizeStart === null || onResizeStart === void 0 ? void 0 : onResizeStart(size.width);
                        setDragging(true);
                    },
...
function HorizontalWizardStepsContent(param) {
    ...
    var _wizardSteps_currentStepIndex_expandContentToFullHeight;
    const expandContentToFullHeight = (_wizardSteps_currentStepIndex_expandContentToFullHeight = wizardSteps[currentStepIndex].expandContentToFullHeight) !== null && _wizardSteps_currentStepIndex_expandContentToFullHeight !== void 0 ? _wizardSteps_currentStepIndex_expandContentToFullHeight : true;
    var _wizardSteps_currentStepIndex_disableDefaultScrollBehavior;
    const disableDefaultScrollBehavior = (_wizardSteps_currentStepIndex_disableDefaultScrollBehavior = wizardSteps[currentStepIndex].disableDefaultScrollBehavior) !== null && _wizardSteps_currentStepIndex_disableDefaultScrollBehavior !== void 0 ? _wizardSteps_currentStepIndex_disableDefaultScrollBehavior : false;
    return /*#__PURE__*/ jsxs(Fragment, {
        children: [
...
function getWizardFooterButtons(param) {
    ...
    var _extraFooterButtonsRight_length;
    return compact([
        ...
        /*#__PURE__*/ jsx(ButtonWithTooltip, {
            ...
            type: ((_extraFooterButtonsRight_length = extraFooterButtonsRight === null || extraFooterButtonsRight === void 0 ? void 0 : extraFooterButtonsRight.length) !== null && _extraFooterButtonsRight_length !== void 0 ? _extraFooterButtonsRight_length : 0) > 0 ? undefined : 'primary',
...
//# sourceMappingURL=WizardStepContentWrapper-3bBt6fXR.js.map
