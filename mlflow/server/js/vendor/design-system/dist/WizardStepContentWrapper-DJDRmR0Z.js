...
import React__default, { forwardRef, useMemo, useRef, useEffect, useState, useContext, createContext, useLayoutEffect, useCallback } from 'react';
import { I as Icon, t as DesignSystemEventSuppressInteractionProviderContext, v as DesignSystemEventSuppressInteractionTrueContextValue, d as DesignSystemEventProviderAnalyticsEventTypes, u as useDesignSystemTheme, s as safex, e as useDesignSystemEventComponentCallbacks, f as DesignSystemEventProviderComponentTypes, j as useNotifyOnFirstView, w as augmentWithDataComponentProps, B as Button, C as CloseIcon, x as addDebugOutlineStylesIfEnabled, b as getAnimationCss, y as getDarkModePortalStyles, z as getShadowScrollStyles, A as useDesignSystemContext, D as DesignSystemAntDConfigProvider, a as addDebugOutlineIfEnabled, E as RestoreAntDDefaultClsPrefix, k as DangerIcon, i as importantify, T as Typography, o as ChevronRightIcon, n as ChevronLeftIcon, W as WarningIcon, L as LoadingIcon, G as DEFAULT_SPACING_UNIT, R as Root$1, l as Trigger$1, m as Content$2 } from './Popover-BhijY5a8.js';
...
const overlayStyles = (theme, zIndex)=>/*#__PURE__*/ css({
        position: 'fixed',
        inset: 0,
...
const modalFooterStyles = (theme, hasCustomFooter)=>{
    const MODAL_PADDING = theme.spacing.lg;
    const CONTENT_BUFFER = 8;
...
function ModalInternal$1(param) {
    ...
    const dialogContent = /*#__PURE__*/ jsxs("div", {
        role: "document",
        "aria-hidden": !open,
        className: classnames(`${classNamePrefix}-modal`, wrapClassName),
        children: [
            open && dangerouslySetAntdProps?.mask !== false ? /*#__PURE__*/ jsx(DialogPrimitive.Overlay, {
                css: [
                    overlayStyles(theme, zIndex ? zIndex : theme.options.zIndexBase)
                ]
            }) : null,
                ...
                children: /*#__PURE__*/ jsxs("div", {
                    ...
                    children: [
                        ...
                        footer !== null && /*#__PURE__*/ jsx("div", {
                            css: modalFooterStyles(theme, footer !== null),
    ...
    return /*#__PURE__*/ jsx(DialogPrimitive.Root, {
        ...
        children: /*#__PURE__*/ jsx(DialogPrimitive.Portal, {
            ...
            forceMount: destroyOnClose ? undefined : true,
            children: visible ? modalRender ? modalRender(dialogContent) : dangerouslySetAntdProps?.modalRender ? dangerouslySetAntdProps.modalRender(dialogContent) : dialogContent : null
        })
    });
}
...
//# sourceMappingURL=WizardStepContentWrapper-DJDRmR0Z.js.map
