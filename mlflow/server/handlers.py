...
from mlflow.utils.uri import is_file_uri, is_local_uri, validate_path_is_safe, validate_url_parts
...
def _create_experiment():
    ...
    # Validate query string, fragment and params in artifact location to prevent attacks
    parsed_artifact_location = urllib.parse.urlparse(request_message.artifact_location)
    validate_url_parts(parsed_artifact_location)
