...
def save_model(keras_model, path, conda_env=None, mlflow_model=Model(), custom_objects=None,
    ...
    mappings for custom layers in your Keras model.
    :param keras_module: Keras module to be used to save / load the model. If not
    provided, MLflow will attempt to infer the Keras module based on the given model.
