...
if Version(google.protobuf.__version__).major >= 5:
  ...
  if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_UNITYCATALOGPROMPTSERVICE'].methods_by_name['LinkPromptVersionToTraces']._loaded_options = None
    _globals['_UNITYCATALOGPROMPTSERVICE'].methods_by_name['LinkPromptVersionToTraces']._serialized_options = b'\362\206\031\210\001\nU\n\004POST\022G/mlflow/unity-catalog/prompts/{name}/versions/{version}/links-to-traces\032\004\010\002\020\000\020\003*-(Unity Catalog) Link Prompt Version to Traces'
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _UNITYCATALOGPROMPTSERVICE.methods_by_name['LinkPromptVersionToTraces']._options = None
    _UNITYCATALOGPROMPTSERVICE.methods_by_name['LinkPromptVersionToTraces']._serialized_options = b'\362\206\031\210\001\nU\n\004POST\022G/mlflow/unity-catalog/prompts/{name}/versions/{version}/links-to-traces\032\004\010\002\020\000\020\003*-(Unity Catalog) Link Prompt Version to Traces'
