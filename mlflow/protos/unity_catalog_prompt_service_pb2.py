...
if Version(google.protobuf.__version__).major >= 5:
  ...
  DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\"unity_catalog_prompt_service.proto\x12\x13mlflow.unitycatalog\x1a\x10\x64\x61tabricks.proto\x1a\x15scalapb/scalapb.proto\x1a#unity_catalog_prompt_messages.proto2\xdf\x1d\n\x19UnityCatalogPromptService\x12\xb7\x01\n\x0c\x43reatePrompt\x12(.mlflow.unitycatalog.CreatePromptRequest\x1a).mlflow.unitycatalog.CreatePromptResponse\"R\xf2\x86\x19N\n+\n\x04POST\x12\x1d/mlflow/unity-catalog/prompts\x1a\x04\x08\x02\x10\x00\x10\x03*\x1d(Unity Catalog) Create Prompt\x12\xbf\x01\n\x0cUpdatePrompt\x12(.mlflow.unitycatalog.UpdatePromptRequest\x1a).mlflow.unitycatalog.UpdatePromptResponse\"Z\xf2\x86\x19V\n3\n\x05PATCH\x12$/mlflow/unity-catalog/prompts/{name}\x1a\x04\x08\x02\x10\x00\x10\x03*\x1d(Unity Catalog) Update Prompt\x12\xc0\x01\n\x0c\x44\x65letePrompt\x12(.mlflow.unitycatalog.DeletePromptRequest\x1a).mlflow.unitycatalog.DeletePromptResponse\"[\xf2\x86\x19W\n4\n\x06\x44\x45LETE\x12$/mlflow/unity-catalog/prompts/{name}\x1a\x04\x08\x02\x10\x00\x10\x03*\x1d(Unity Catalog) Delete Prompt\x12\xb1\x01\n\tGetPrompt\x12%.mlflow.unitycatalog.GetPromptRequest\x1a&.mlflow.unitycatalog.GetPromptResponse\"U\xf2\x86\x19Q\n1\n\x03GET\x12$/mlflow/unity-catalog/prompts/{name}\x1a\x04\x08\x02\x10\x00\x10\x03*\x1a(Unity Catalog) Get Prompt\x12\xc2\x01\n\rSearchPrompts\x12).mlflow.unitycatalog.SearchPromptsRequest\x1a*.mlflow.unitycatalog.SearchPromptsResponse\"Z\xf2\x86\x19V\n2\n\x04POST\x12$/mlflow/unity-catalog/prompts/search\x1a\x04\x08\x02\x10\x00\x10\x03*\x1e(Unity Catalog) Search Prompts\x12\xe4\x01\n\x13\x43reatePromptVersion\x12/.mlflow.unitycatalog.CreatePromptVersionRequest\x1a\x30.mlflow.unitycatalog.CreatePromptVersionResponse\"j\xf2\x86\x19\x66\n;\n\x04POST\x12-/mlflow/unity-catalog/prompts/{name}/versions\x1a\x04\x08\x02\x10\x00\x10\x03*%(Unity Catalog) Create Prompt Version\x12\xef\x01\n\x13UpdatePromptVersion\x12/.mlflow.unitycatalog.UpdatePromptVersionRequest\x1a\x30.mlflow.unitycatalog.UpdatePromptVersionResponse\"u\xf2\x86\x19q\nF\n\x05PATCH\x12\x37/mlflow/unity-catalog/prompts/{name}/versions/{version}\x1a\x04\x08\x02\x10\x00\x10\x03*%(Unity Catalog) Update Prompt Version\x12\xf0\x01\n\x13\x44\x65letePromptVersion\x12/.mlflow.unitycatalog.DeletePromptVersionRequest\x1a\x30.mlflow.unitycatalog.DeletePromptVersionResponse\"v\xf2\x86\x19r\nG\n\x06\x44\x45LETE\x12\x37/mlflow/unity-catalog/prompts/{name}/versions/{version}\x1a\x04\x08\x02\x10\x00\x10\x03*%(Unity Catalog) Delete Prompt Version\x12\xe1\x01\n\x10GetPromptVersion\x12,.mlflow.unitycatalog.GetPromptVersionRequest\x1a-.mlflow.unitycatalog.GetPromptVersionResponse\"p\xf2\x86\x19l\nD\n\x03GET\x12\x37/mlflow/unity-catalog/prompts/{name}/versions/{version}\x1a\x04\x08\x02\x10\x00\x10\x03*\"(Unity Catalog) Get Prompt Version\x12\xe7\x01\n\x14SearchPromptVersions\x12\x30.mlflow.unitycatalog.SearchPromptVersionsRequest\x1a\x31.mlflow.unitycatalog.SearchPromptVersionsResponse\"j\xf2\x86\x19\x66\n:\n\x03GET\x12-/mlflow/unity-catalog/prompts/{name}/versions\x1a\x04\x08\x02\x10\x00\x10\x03*&(Unity Catalog) Search Prompt Versions\x12\xd7\x01\n\x0eSetPromptAlias\x12*.mlflow.unitycatalog.SetPromptAliasRequest\x1a+.mlflow.unitycatalog.SetPromptAliasResponse\"l\xf2\x86\x19h\nB\n\x04POST\x12\x34/mlflow/unity-catalog/prompts/{name}/aliases/{alias}\x1a\x04\x08\x02\x10\x00\x10\x03* (Unity Catalog) Set Prompt Alias\x12\xe5\x01\n\x11\x44\x65letePromptAlias\x12-.mlflow.unitycatalog.DeletePromptAliasRequest\x1a..mlflow.unitycatalog.DeletePromptAliasResponse\"q\xf2\x86\x19m\nD\n\x06\x44\x45LETE\x12\x34/mlflow/unity-catalog/prompts/{name}/aliases/{alias}\x1a\x04\x08\x02\x10\x00\x10\x03*#(Unity Catalog) Delete Prompt Alias\x12\x87\x02\n\x17GetPromptVersionByAlias\x12\x33.mlflow.unitycatalog.GetPromptVersionByAliasRequest\x1a\x34.mlflow.unitycatalog.GetPromptVersionByAliasResponse\"\x80\x01\xf2\x86\x19|\nK\n\x03GET\x12>/mlflow/unity-catalog/prompts/{name}/versions/by-alias/{alias}\x1a\x04\x08\x02\x10\x00\x10\x03*+(Unity Catalog) Get Prompt Version By Alias\x12\xc4\x01\n\x0cSetPromptTag\x12(.mlflow.unitycatalog.SetPromptTagRequest\x1a).mlflow.unitycatalog.SetPromptTagResponse\"_\xf2\x86\x19[\n7\n\x04POST\x12)/mlflow/unity-catalog/prompts/{name}/tags\x1a\x04\x08\x02\x10\x00\x10\x03*\x1e(Unity Catalog) Set Prompt Tag\x12\xd8\x01\n\x0f\x44\x65letePromptTag\x12+.mlflow.unitycatalog.DeletePromptTagRequest\x1a,.mlflow.unitycatalog.DeletePromptTagResponse\"j\xf2\x86\x19\x66\n?\n\x06\x44\x45LETE\x12//mlflow/unity-catalog/prompts/{name}/tags/{key}\x1a\x04\x08\x02\x10\x00\x10\x03*!(Unity Catalog) Delete Prompt Tag\x12\xf4\x01\n\x13SetPromptVersionTag\x12/.mlflow.unitycatalog.SetPromptVersionTagRequest\x1a\x30.mlflow.unitycatalog.SetPromptVersionTagResponse\"z\xf2\x86\x19v\nJ\n\x04POST\x12</mlflow/unity-catalog/prompts/{name}/versions/{version}/tags\x1a\x04\x08\x02\x10\x00\x10\x03*&(Unity Catalog) Set Prompt Version Tag\x12\x8a\x02\n\x16\x44\x65letePromptVersionTag\x12\x32.mlflow.unitycatalog.DeletePromptVersionTagRequest\x1a\x33.mlflow.unitycatalog.DeletePromptVersionTagResponse\"\x86\x01\xf2\x86\x19\x81\x01\nR\n\x06\x44\x45LETE\x12\x42/mlflow/unity-catalog/prompts/{name}/versions/{version}/tags/{key}\x1a\x04\x08\x02\x10\x00\x10\x03*)(Unity Catalog) Delete Prompt Version TagB4\n\'com.databricks.api.proto.managedcatalog\x90\x01\x01\xa0\x01\x01\xe2?\x02\x10\x01')
  ...
  if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_UNITYCATALOGPROMPTSERVICE'].methods_by_name['SearchPromptVersions']._serialized_options = b'\362\206\031f\n:\n\003GET\022-/mlflow/unity-catalog/prompts/{name}/versions\032\004\010\002\020\000\020\003*&(Unity Catalog) Search Prompt Versions'
    ...
    _globals['_UNITYCATALOGPROMPTSERVICE']._serialized_start=138
    _globals['_UNITYCATALOGPROMPTSERVICE']._serialized_end=3945
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _UNITYCATALOGPROMPTSERVICE.methods_by_name['SearchPromptVersions']._serialized_options = b'\362\206\031f\n:\n\003GET\022-/mlflow/unity-catalog/prompts/{name}/versions\032\004\010\002\020\000\020\003*&(Unity Catalog) Search Prompt Versions'
    ...
    _UNITYCATALOGPROMPTSERVICE._serialized_start=138
    _UNITYCATALOGPROMPTSERVICE._serialized_end=3945
