...
if Version(google.protobuf.__version__).major >= 5:
  ...
  # source: mlflow/protos/unity_catalog_prompt_service.proto
  ...
  if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_UNITYCATALOGPROMPTSERVICE']._serialized_start=223
    _globals['_UNITYCATALOGPROMPTSERVICE']._serialized_end=4445
  _builder.BuildServices(DESCRIPTOR, 'mlflow.protos.unity_catalog_prompt_service_pb2', _globals)
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _UNITYCATALOGPROMPTSERVICE._serialized_start=223
    _UNITYCATALOGPROMPTSERVICE._serialized_end=4445
  UnityCatalogPromptService = service_reflection.GeneratedServiceType('UnityCatalogPromptService', (_service.Service,), dict(
    ...
    __module__ = 'mlflow.protos.unity_catalog_prompt_service_pb2'
    ))
