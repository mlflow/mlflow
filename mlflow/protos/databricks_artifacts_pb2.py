...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GETCREDENTIALSFORTRACEDATADOWNLOAD.fields_by_name['trace_id']._options = None
  _GETCREDENTIALSFORTRACEDATADOWNLOAD.fields_by_name['trace_id']._serialized_options = b'\370\206\031\001'
  _GETCREDENTIALSFORTRACEDATADOWNLOAD.fields_by_name['run_id']._options = None
  _GETCREDENTIALSFORTRACEDATADOWNLOAD.fields_by_name['run_id']._serialized_options = b'\370\206\031\001'
  _GETCREDENTIALSFORTRACEDATADOWNLOAD._options = None
  _GETCREDENTIALSFORTRACEDATADOWNLOAD._serialized_options = b'\342?(\n&com.databricks.rpc.RPC[$this.Response]\342?1\n/com.databricks.mlflow.api.MlflowTrackingMessage'
  _GETCREDENTIALSFORTRACEDATAUPLOAD.fields_by_name['trace_id']._options = None
  _GETCREDENTIALSFORTRACEDATAUPLOAD.fields_by_name['trace_id']._serialized_options = b'\370\206\031\001'
  _GETCREDENTIALSFORTRACEDATAUPLOAD.fields_by_name['run_id']._options = None
  _GETCREDENTIALSFORTRACEDATAUPLOAD.fields_by_name['run_id']._serialized_options = b'\370\206\031\001'
  ...
  _DATABRICKSMLFLOWARTIFACTSSERVICE.methods_by_name['getCredentialsForTraceDataDownload']._serialized_options = b'\362\206\031H\nD\n\003GET\0227/mlflow/traces/{trace_id}/credentials-for-data-download\032\004\010\002\020\000\020\003'
  _DATABRICKSMLFLOWARTIFACTSSERVICE.methods_by_name['getCredentialsForTraceDataUpload']._options = None
  _DATABRICKSMLFLOWARTIFACTSSERVICE.methods_by_name['getCredentialsForTraceDataUpload']._serialized_options = b'\362\206\031F\nB\n\003GET\0225/mlflow/traces/{trace_id}/credentials-for-data-upload\032\004\010\002\020\000\020\003'
  _ARTIFACTCREDENTIALTYPE._serialized_start=2284
  _ARTIFACTCREDENTIALTYPE._serialized_end=2399
  ...
  _GETCREDENTIALSFORTRACEDATADOWNLOAD._serialized_end=2033
  _GETCREDENTIALSFORTRACEDATADOWNLOAD_RESPONSE._serialized_start=1869
  _GETCREDENTIALSFORTRACEDATADOWNLOAD_RESPONSE._serialized_end=1936
  _GETCREDENTIALSFORTRACEDATAUPLOAD._serialized_start=2036
  _GETCREDENTIALSFORTRACEDATAUPLOAD._serialized_end=2282
  _GETCREDENTIALSFORTRACEDATAUPLOAD_RESPONSE._serialized_start=1869
  _GETCREDENTIALSFORTRACEDATAUPLOAD_RESPONSE._serialized_end=1936
  _DATABRICKSMLFLOWARTIFACTSSERVICE._serialized_start=2402
  _DATABRICKSMLFLOWARTIFACTSSERVICE._serialized_end=3689
