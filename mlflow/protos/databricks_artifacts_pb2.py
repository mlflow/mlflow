...
_ARTIFACTCREDENTIALTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='AZURE_SAS_URI', index=0, number=1, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='AWS_PRESIGNED_URL', index=1, number=2, serialized_options=None, type=None),
    ],
...
_ARTIFACTCREDENTIALINFO_HTTPHEADER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='mlflow.ArtifactCredentialInfo.HttpHeader.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='mlflow.ArtifactCredentialInfo.HttpHeader.value',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_ARTIFACTCREDENTIALINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='run_id',
            full_name='mlflow.ArtifactCredentialInfo.run_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='path',
            full_name='mlflow.ArtifactCredentialInfo.path',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='signed_uri',
            full_name='mlflow.ArtifactCredentialInfo.signed_uri',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='headers',
            full_name='mlflow.ArtifactCredentialInfo.headers',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='type',
            full_name='mlflow.ArtifactCredentialInfo.type',
            index=4,
            number=5,
            type=14,
            cpp_type=8,
    ...
    extensions=[],
    nested_types=[
        _ARTIFACTCREDENTIALINFO_HTTPHEADER,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_GETCREDENTIALSFORREAD_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='credentials',
            full_name='mlflow.GetCredentialsForRead.Response.credentials',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_GETCREDENTIALSFORREAD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='run_id',
            full_name='mlflow.GetCredentialsForRead.run_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='path',
            full_name='mlflow.GetCredentialsForRead.path',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
    ...
    extensions=[],
    nested_types=[
        _GETCREDENTIALSFORREAD_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b(
...
_GETCREDENTIALSFORWRITE_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='credentials',
            full_name='mlflow.GetCredentialsForWrite.Response.credentials',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_GETCREDENTIALSFORWRITE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='run_id',
            full_name='mlflow.GetCredentialsForWrite.run_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='path',
            full_name='mlflow.GetCredentialsForWrite.path',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
    ...
    extensions=[],
    nested_types=[
        _GETCREDENTIALSFORWRITE_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b(
        '\342?(\n&com.databricks.rpc.RPC[$this.Response]\342?1\n/com.databricks.mlflow.api.MlflowTrackingMessage'
...
DatabricksMlflowArtifactsService = service_reflection.GeneratedServiceType(
    'DatabricksMlflowArtifactsService', (_service.Service, ),
    dict(DESCRIPTOR=_DATABRICKSMLFLOWARTIFACTSSERVICE, __module__='databricks_artifacts_pb2'))

DatabricksMlflowArtifactsService_Stub = service_reflection.GeneratedServiceStubType(
    'DatabricksMlflowArtifactsService_Stub', (DatabricksMlflowArtifactsService, ),
    dict(DESCRIPTOR=_DATABRICKSMLFLOWARTIFACTSSERVICE, __module__='databricks_artifacts_pb2'))
