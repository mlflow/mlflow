...
_GETMODELVERSIONDOWNLOADURI = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\370\206\031\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_signed_url', full_name='mlflow.GetModelVersionDownloadUri.use_signed_url', index=2,
...
_GETMODELVERSIONDOWNLOADURI.fields_by_name['use_signed_url']._options = None
