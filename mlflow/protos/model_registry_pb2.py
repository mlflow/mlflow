...
_CREATEREGISTEREDMODEL = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _CREATEREGISTEREDMODEL_RESPONSE,
    ],
    enum_types=[],
...
_RENAMEREGISTEREDMODEL = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _RENAMEREGISTEREDMODEL_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
    is_extendable=False,
...
_UPDATEREGISTEREDMODEL = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _UPDATEREGISTEREDMODEL_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
    is_extendable=False,
...
_DELETEREGISTEREDMODEL = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _DELETEREGISTEREDMODEL_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
    is_extendable=False,
...
_LISTREGISTEREDMODELS = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _LISTREGISTEREDMODELS_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
    is_extendable=False,
...
_SEARCHREGISTEREDMODELS = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _SEARCHREGISTEREDMODELS_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
    is_extendable=False,
...
_TRANSITIONMODELVERSIONSTAGE = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _TRANSITIONMODELVERSIONSTAGE_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
    is_extendable=False,
...
_GETMODELVERSIONDOWNLOADURI = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _GETMODELVERSIONDOWNLOADURI_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
    is_extendable=False,
...
_SETREGISTEREDMODELTAG = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _SETREGISTEREDMODELTAG_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
    is_extendable=False,
...
_DELETEREGISTEREDMODELTAG = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _DELETEREGISTEREDMODELTAG_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
    is_extendable=False,
...
_DELETEMODELVERSIONTAG = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _DELETEMODELVERSIONTAG_RESPONSE,
    ],
    enum_types=[],
    serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
    is_extendable=False,
...
ModelRegistryService = service_reflection.GeneratedServiceType(
    'ModelRegistryService', (_service.Service, ),
...
ModelRegistryService_Stub = service_reflection.GeneratedServiceStubType(
    'ModelRegistryService_Stub', (ModelRegistryService, ),
    dict(DESCRIPTOR=_MODELREGISTRYSERVICE, __module__='model_registry_pb2'))
