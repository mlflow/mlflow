...
_MODELSTAGE = _descriptor.Descriptor(
  name='ModelStage',
  full_name='mlflow.ModelStage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='mlflow.ModelStage.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='color', full_name='mlflow.ModelStage.color', index=1,
...
_RENAMEREGISTEREDMODEL_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='model_stages', full_name='mlflow.RenameRegisteredModel.Response.model_stages', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTMODELSTAGES_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflow.ListModelStages.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='model_stages', full_name='mlflow.ListModelStages.Response.model_stages', index=0,
...
_LISTMODELSTAGES = _descriptor.Descriptor(
  name='ListModelStages',
  full_name='mlflow.ListModelStages',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
  ...
  nested_types=[_LISTMODELSTAGES_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
  is_extendable=False,
...
_RENAMEREGISTEREDMODEL_RESPONSE.fields_by_name['model_stages'].message_type = _MODELSTAGE
...
_LISTMODELSTAGES_RESPONSE.fields_by_name['model_stages'].message_type = _MODELSTAGE
_LISTMODELSTAGES_RESPONSE.containing_type = _LISTMODELSTAGES
...
DESCRIPTOR.message_types_by_name['ListModelStages'] = _LISTMODELSTAGES
...
ModelStage = _reflection.GeneratedProtocolMessageType('ModelStage', (_message.Message,), dict(
  DESCRIPTOR = _MODELSTAGE,
  __module__ = 'model_registry_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.ModelStage)
  ))
...
ListModelStages = _reflection.GeneratedProtocolMessageType('ListModelStages', (_message.Message,), dict(

  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    DESCRIPTOR = _LISTMODELSTAGES_RESPONSE,
    __module__ = 'model_registry_pb2'
    # @@protoc_insertion_point(class_scope:mlflow.ListModelStages.Response)
    ))
  ,
  DESCRIPTOR = _LISTMODELSTAGES,
  __module__ = 'model_registry_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.ListModelStages)
  ))
_sym_db.RegisterMessage(ListModelStages)
_sym_db.RegisterMessage(ListModelStages.Response)
...
_LISTMODELSTAGES._options = None
...
_MODELREGISTRYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='listModelStages',
    full_name='mlflow.ModelRegistryService.listModelStages',
    index=6,
    containing_service=None,
    input_type=_LISTMODELSTAGES,
    output_type=_LISTMODELSTAGES_RESPONSE,
    serialized_options=_b('\362\206\031l\n.\n\003GET\022!/preview/mlflow/model-stages/list\032\004\010\002\020\000\n&\n\003GET\022\031/mlflow/model-stages/list\032\004\010\002\020\000\020\001*\020List ModelStages'),
  ),
  _descriptor.MethodDescriptor(
    name='listRegisteredModels',
