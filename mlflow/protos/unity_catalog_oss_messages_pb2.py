...
if Version(google.protobuf.__version__).major >= 5:
  ...
  # source: mlflow/protos/unity_catalog_oss_messages.proto
  ...
  if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MODELVERSIONSTATUS']._serialized_start=3107
    _globals['_MODELVERSIONSTATUS']._serialized_end=3223
    _globals['_MODELVERSIONOPERATION']._serialized_start=3225
    _globals['_MODELVERSIONOPERATION']._serialized_end=3339
    _globals['_REGISTEREDMODELINFO']._serialized_start=141
    _globals['_REGISTEREDMODELINFO']._serialized_end=394
    _globals['_CREATEREGISTEREDMODEL']._serialized_start=397
    _globals['_CREATEREGISTEREDMODEL']._serialized_end=605
    _globals['_CREATEREGISTEREDMODEL_RESPONSE']._serialized_start=522
    _globals['_CREATEREGISTEREDMODEL_RESPONSE']._serialized_end=605
    _globals['_DELETEREGISTEREDMODEL']._serialized_start=607
    _globals['_DELETEREGISTEREDMODEL']._serialized_end=676
    _globals['_DELETEREGISTEREDMODEL_RESPONSE']._serialized_start=522
    _globals['_DELETEREGISTEREDMODEL_RESPONSE']._serialized_end=532
    _globals['_GETREGISTEREDMODEL']._serialized_start=679
    _globals['_GETREGISTEREDMODEL']._serialized_end=809
    _globals['_GETREGISTEREDMODEL_RESPONSE']._serialized_start=522
    _globals['_GETREGISTEREDMODEL_RESPONSE']._serialized_end=605
    _globals['_UPDATEREGISTEREDMODEL']._serialized_start=812
    _globals['_UPDATEREGISTEREDMODEL']._serialized_end=974
    _globals['_UPDATEREGISTEREDMODEL_RESPONSE']._serialized_start=522
    _globals['_UPDATEREGISTEREDMODEL_RESPONSE']._serialized_end=605
    _globals['_LISTREGISTEREDMODELS']._serialized_start=977
    _globals['_LISTREGISTEREDMODELS']._serialized_end=1189
    _globals['_LISTREGISTEREDMODELS_RESPONSE']._serialized_start=1085
    _globals['_LISTREGISTEREDMODELS_RESPONSE']._serialized_end=1189
    _globals['_MODELVERSIONINFO']._serialized_start=1192
    _globals['_MODELVERSIONINFO']._serialized_end=1514
    _globals['_CREATEMODELVERSION']._serialized_start=1517
    _globals['_CREATEMODELVERSION']._serialized_end=1728
    _globals['_CREATEMODELVERSION_RESPONSE']._serialized_start=1651
    _globals['_CREATEMODELVERSION_RESPONSE']._serialized_end=1728
    _globals['_DELETEMODELVERSION']._serialized_start=1730
    _globals['_DELETEMODELVERSION']._serialized_end=1798
    _globals['_DELETEMODELVERSION_RESPONSE']._serialized_start=522
    _globals['_DELETEMODELVERSION_RESPONSE']._serialized_end=532
    _globals['_FINALIZEMODELVERSION']._serialized_start=1801
    _globals['_FINALIZEMODELVERSION']._serialized_end=1938
    _globals['_FINALIZEMODELVERSION_RESPONSE']._serialized_start=1651
    _globals['_FINALIZEMODELVERSION_RESPONSE']._serialized_end=1728
    _globals['_GETMODELVERSION']._serialized_start=1941
    _globals['_GETMODELVERSION']._serialized_end=2073
    _globals['_GETMODELVERSION_RESPONSE']._serialized_start=1651
    _globals['_GETMODELVERSION_RESPONSE']._serialized_end=1728
    _globals['_UPDATEMODELVERSION']._serialized_start=2076
    _globals['_UPDATEMODELVERSION']._serialized_end=2228
    _globals['_UPDATEMODELVERSION_RESPONSE']._serialized_start=1651
    _globals['_UPDATEMODELVERSION_RESPONSE']._serialized_end=1728
    _globals['_LISTMODELVERSIONS']._serialized_start=2231
    _globals['_LISTMODELVERSIONS']._serialized_end=2410
    _globals['_LISTMODELVERSIONS_RESPONSE']._serialized_start=2312
    _globals['_LISTMODELVERSIONS_RESPONSE']._serialized_end=2410
    _globals['_TEMPORARYCREDENTIALS']._serialized_start=2413
    _globals['_TEMPORARYCREDENTIALS']._serialized_end=2668
    _globals['_AWSCREDENTIALS']._serialized_start=2670
    _globals['_AWSCREDENTIALS']._serialized_end=2759
    _globals['_AZUREUSERDELEGATIONSAS']._serialized_start=2761
    _globals['_AZUREUSERDELEGATIONSAS']._serialized_end=2804
    _globals['_GCPOAUTHTOKEN']._serialized_start=2806
    _globals['_GCPOAUTHTOKEN']._serialized_end=2842
    _globals['_GENERATETEMPORARYMODELVERSIONCREDENTIAL']._serialized_start=2845
    _globals['_GENERATETEMPORARYMODELVERSIONCREDENTIAL']._serialized_end=3105
    _globals['_GENERATETEMPORARYMODELVERSIONCREDENTIAL_RESPONSE']._serialized_start=3031
    _globals['_GENERATETEMPORARYMODELVERSIONCREDENTIAL_RESPONSE']._serialized_end=3105
  ...
  RegisteredModelInfo = _reflection.GeneratedProtocolMessageType('RegisteredModelInfo', (_message.Message,), {
    ...
    '__module__' : 'mlflow.protos.unity_catalog_oss_messages_pb2'
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MODELVERSIONSTATUS._serialized_start=3107
    _MODELVERSIONSTATUS._serialized_end=3223
    _MODELVERSIONOPERATION._serialized_start=3225
    _MODELVERSIONOPERATION._serialized_end=3339
    _REGISTEREDMODELINFO._serialized_start=141
    _REGISTEREDMODELINFO._serialized_end=394
    _CREATEREGISTEREDMODEL._serialized_start=397
    _CREATEREGISTEREDMODEL._serialized_end=605
    _CREATEREGISTEREDMODEL_RESPONSE._serialized_start=522
    _CREATEREGISTEREDMODEL_RESPONSE._serialized_end=605
    _DELETEREGISTEREDMODEL._serialized_start=607
    _DELETEREGISTEREDMODEL._serialized_end=676
    _DELETEREGISTEREDMODEL_RESPONSE._serialized_start=522
    _DELETEREGISTEREDMODEL_RESPONSE._serialized_end=532
    _GETREGISTEREDMODEL._serialized_start=679
    _GETREGISTEREDMODEL._serialized_end=809
    _GETREGISTEREDMODEL_RESPONSE._serialized_start=522
    _GETREGISTEREDMODEL_RESPONSE._serialized_end=605
    _UPDATEREGISTEREDMODEL._serialized_start=812
    _UPDATEREGISTEREDMODEL._serialized_end=974
    _UPDATEREGISTEREDMODEL_RESPONSE._serialized_start=522
    _UPDATEREGISTEREDMODEL_RESPONSE._serialized_end=605
    _LISTREGISTEREDMODELS._serialized_start=977
    _LISTREGISTEREDMODELS._serialized_end=1189
    _LISTREGISTEREDMODELS_RESPONSE._serialized_start=1085
    _LISTREGISTEREDMODELS_RESPONSE._serialized_end=1189
    _MODELVERSIONINFO._serialized_start=1192
    _MODELVERSIONINFO._serialized_end=1514
    _CREATEMODELVERSION._serialized_start=1517
    _CREATEMODELVERSION._serialized_end=1728
    _CREATEMODELVERSION_RESPONSE._serialized_start=1651
    _CREATEMODELVERSION_RESPONSE._serialized_end=1728
    _DELETEMODELVERSION._serialized_start=1730
    _DELETEMODELVERSION._serialized_end=1798
    _DELETEMODELVERSION_RESPONSE._serialized_start=522
    _DELETEMODELVERSION_RESPONSE._serialized_end=532
    _FINALIZEMODELVERSION._serialized_start=1801
    _FINALIZEMODELVERSION._serialized_end=1938
    _FINALIZEMODELVERSION_RESPONSE._serialized_start=1651
    _FINALIZEMODELVERSION_RESPONSE._serialized_end=1728
    _GETMODELVERSION._serialized_start=1941
    _GETMODELVERSION._serialized_end=2073
    _GETMODELVERSION_RESPONSE._serialized_start=1651
    _GETMODELVERSION_RESPONSE._serialized_end=1728
    _UPDATEMODELVERSION._serialized_start=2076
    _UPDATEMODELVERSION._serialized_end=2228
    _UPDATEMODELVERSION_RESPONSE._serialized_start=1651
    _UPDATEMODELVERSION_RESPONSE._serialized_end=1728
    _LISTMODELVERSIONS._serialized_start=2231
    _LISTMODELVERSIONS._serialized_end=2410
    _LISTMODELVERSIONS_RESPONSE._serialized_start=2312
    _LISTMODELVERSIONS_RESPONSE._serialized_end=2410
    _TEMPORARYCREDENTIALS._serialized_start=2413
    _TEMPORARYCREDENTIALS._serialized_end=2668
    _AWSCREDENTIALS._serialized_start=2670
    _AWSCREDENTIALS._serialized_end=2759
    _AZUREUSERDELEGATIONSAS._serialized_start=2761
    _AZUREUSERDELEGATIONSAS._serialized_end=2804
    _GCPOAUTHTOKEN._serialized_start=2806
    _GCPOAUTHTOKEN._serialized_end=2842
    _GENERATETEMPORARYMODELVERSIONCREDENTIAL._serialized_start=2845
    _GENERATETEMPORARYMODELVERSIONCREDENTIAL._serialized_end=3105
    _GENERATETEMPORARYMODELVERSIONCREDENTIAL_RESPONSE._serialized_start=3031
    _GENERATETEMPORARYMODELVERSIONCREDENTIAL_RESPONSE._serialized_end=3105
  # @@protoc_insertion_point(module_scope)
