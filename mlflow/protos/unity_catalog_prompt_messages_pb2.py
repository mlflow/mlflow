...
if Version(google.protobuf.__version__).major >= 5:
  ...
  if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PROMPTVERSIONLINKENTRY']._serialized_start=2936
    _globals['_PROMPTVERSIONLINKENTRY']._serialized_end=3003
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PROMPTVERSIONLINKENTRY._serialized_start=2936
    _PROMPTVERSIONLINKENTRY._serialized_end=3003
  # @@protoc_insertion_point(module_scope)
