...
if Version(google.protobuf.__version__).major >= 5:
  ...
  if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PROMPTVERSIONLINKENTRY']._serialized_start=2557
    _globals['_PROMPTVERSIONLINKENTRY']._serialized_end=2612
    _globals['_LINKPROMPTVERSIONSTORUNSREQUEST']._serialized_start=2614
    _globals['_LINKPROMPTVERSIONSTORUNSREQUEST']._serialized_end=2734
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PROMPTVERSIONLINKENTRY._serialized_start=2557
    _PROMPTVERSIONLINKENTRY._serialized_end=2612
    _LINKPROMPTVERSIONSTORUNSREQUEST._serialized_start=2614
    _LINKPROMPTVERSIONSTORUNSREQUEST._serialized_end=2734
  # @@protoc_insertion_point(module_scope)
