...
if Version(google.protobuf.__version__).major >= 5:
  ...
  DatabricksRpcOptions = _reflection.GeneratedProtocolMessageType('DatabricksRpcOptions', (_message.Message,), {
    ...
    '__module__' : 'mlflow.protos.databricks_pb2'
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _VISIBILITY._serialized_start=696
    _VISIBILITY._serialized_end=759
    _ERRORCODE._serialized_start=762
    _ERRORCODE._serialized_end=2935
    _DATABRICKSRPCOPTIONS._serialized_start=114
    _DATABRICKSRPCOPTIONS._serialized_end=319
    _DATABRICKSGRAPHQLOPTIONS._serialized_start=321
    _DATABRICKSGRAPHQLOPTIONS._serialized_end=347
    _HTTPENDPOINT._serialized_start=349
    _HTTPENDPOINT._serialized_end=434
    _APIVERSION._serialized_start=436
    _APIVERSION._serialized_end=478
    _RATELIMIT._serialized_start=480
    _RATELIMIT._serialized_end=544
    _DOCUMENTATIONMETADATA._serialized_start=547
    _DOCUMENTATIONMETADATA._serialized_end=694
  # @@protoc_insertion_point(module_scope)
