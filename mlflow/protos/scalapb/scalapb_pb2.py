...
if Version(google.protobuf.__version__).major >= 5:
  ...
  _builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'mlflow.protos.scalapb.scalapb_pb2', _globals)
  if not _descriptor._USE_C_DESCRIPTORS:
    _globals['DESCRIPTOR']._loaded_options = None
    _globals['DESCRIPTOR']._serialized_options = b'\n\034org.mlflow.scalapb_interface'
    _globals['_SCALAPBOPTIONS']._serialized_start=82
    _globals['_SCALAPBOPTIONS']._serialized_end=158
    _globals['_MESSAGEOPTIONS']._serialized_start=160
    _globals['_MESSAGEOPTIONS']._serialized_end=193
    _globals['_FIELDOPTIONS']._serialized_start=195
    _globals['_FIELDOPTIONS']._serialized_end=223
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SCALAPBOPTIONS._serialized_start=82
    _SCALAPBOPTIONS._serialized_end=158
    _MESSAGEOPTIONS._serialized_start=160
    _MESSAGEOPTIONS._serialized_end=193
    _FIELDOPTIONS._serialized_start=195
    _FIELDOPTIONS._serialized_end=223
  # @@protoc_insertion_point(module_scope)
