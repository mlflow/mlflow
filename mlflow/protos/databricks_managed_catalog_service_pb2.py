...
if Version(google.protobuf.__version__).major >= 5:
  ...
  from . import databricks_unity_catalog_oss_messages_pb2 as databricks_unity_catalog_oss_messages_pb2
  from .scalapb import scalapb_pb2 as scalapb_dot_scalapb__pb2


  DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n(databricks_managed_catalog_service.proto\x12\x15mlflow.managedcatalog\x1a\x10\x64\x61tabricks.proto\x1a)databricks_managed_catalog_messages.proto\x1a+databricks_unity_catalog_oss_messages.proto\x1a\x15scalapb/scalapb.proto2\xd4\x02\n\x13UnityCatalogService\x12\x90\x01\n\x08getTable\x12\x1f.mlflow.managedcatalog.GetTable\x1a\'.mlflow.managedcatalog.GetTableResponse\":\xf2\x86\x19\x36\n2\n\x03GET\x12%/unity-catalog/tables/{full_name_arg}\x1a\x04\x08\x02\x10\x00\x10\x03\x12\xa9\x01\n\x15\x63reateRegisteredModel\x12,.mlflow.managedcatalog.CreateRegisteredModel\x1a\x35.mlflow.managedcatalog.CreateRegisteredModel.Response\"+\xf2\x86\x19\'\n#\n\x04POST\x12\x15/unity-catalog/models\x1a\x04\x08\x02\x10\x01\x10\x03\x42\x34\n\'com.databricks.api.proto.managedcatalog\x90\x01\x01\xa0\x01\x01\xe2?\x02\x10\x01')
  ...
  if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_UNITYCATALOGSERVICE']._serialized_start=197
    _globals['_UNITYCATALOGSERVICE']._serialized_end=537
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _UNITYCATALOGSERVICE._serialized_start=197
    _UNITYCATALOGSERVICE._serialized_end=537
