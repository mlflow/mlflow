...
if Version(google.protobuf.__version__).major >= 5:
  ...
  # source: mlflow/protos/databricks_managed_catalog_messages.proto
  ...
  TableInfo = _reflection.GeneratedProtocolMessageType('TableInfo', (_message.Message,), {
    ...
    '__module__' : 'mlflow.protos.databricks_managed_catalog_messages_pb2'
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _TABLEINFO._serialized_start=119
    _TABLEINFO._serialized_end=167
    _GETTABLE._serialized_start=170
    _GETTABLE._serialized_end=364
    _GETTABLERESPONSE._serialized_start=366
    _GETTABLERESPONSE._serialized_end=421
  # @@protoc_insertion_point(module_scope)
