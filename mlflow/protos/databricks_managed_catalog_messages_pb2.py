...
GetTable = _reflection.GeneratedProtocolMessageType('GetTable', (_message.Message,), {
  ...
  'Response' : _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), {
    'DESCRIPTOR' : _GETTABLE_RESPONSE,
    '__module__' : 'databricks_managed_catalog_messages_pb2'
    # @@protoc_insertion_point(class_scope:mlflow.managedcatalog.GetTable.Response)
    })
  ,
...
_sym_db.RegisterMessage(GetTable.Response)

if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'\n\'com.databricks.api.proto.managedcatalog\240\001\001\342?\002\020\001'
  _GETTABLE_RESPONSE.fields_by_name['table_info']._options = None
  _GETTABLE_RESPONSE.fields_by_name['table_info']._serialized_options = b'\200\207\031\001'
  _TABLEINFO._serialized_start=109
  _TABLEINFO._serialized_end=157
  _GETTABLE._serialized_start=160
  _GETTABLE._serialized_end=514
  _GETTABLE_RESPONSE._serialized_start=444
  _GETTABLE_RESPONSE._serialized_end=514
