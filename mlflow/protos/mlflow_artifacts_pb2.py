...
if Version(google.protobuf.__version__).major >= 5:
  ...
  if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GETPRESIGNEDDOWNLOADURL_RESPONSE_HEADERSENTRY']._loaded_options = None
    _globals['_GETPRESIGNEDDOWNLOADURL_RESPONSE_HEADERSENTRY']._serialized_options = b'8\001'
    ...
    _globals['_MLFLOWARTIFACTSSERVICE'].methods_by_name['getPresignedDownloadUrl']._loaded_options = None
    _globals['_MLFLOWARTIFACTSSERVICE'].methods_by_name['getPresignedDownloadUrl']._serialized_options = b'\362\206\031k\n=\n\003GET\0220/mlflow-artifacts/presigned/<path:artifact_path>\032\004\010\002\020\000\020\001*(Get Presigned URL for Multipart Download'
    ...
    _globals['_GETPRESIGNEDDOWNLOADURL']._serialized_start=934
    _globals['_GETPRESIGNEDDOWNLOADURL']._serialized_end=1134
    _globals['_GETPRESIGNEDDOWNLOADURL_RESPONSE']._serialized_start=962
    _globals['_GETPRESIGNEDDOWNLOADURL_RESPONSE']._serialized_end=1134
    _globals['_GETPRESIGNEDDOWNLOADURL_RESPONSE_HEADERSENTRY']._serialized_start=814
    _globals['_GETPRESIGNEDDOWNLOADURL_RESPONSE_HEADERSENTRY']._serialized_end=860
    _globals['_MLFLOWARTIFACTSSERVICE']._serialized_start=1137
    _globals['_MLFLOWARTIFACTSSERVICE']._serialized_end=2806
  ...
  _GETPRESIGNEDDOWNLOADURL = DESCRIPTOR.message_types_by_name['GetPresignedDownloadUrl']
  _GETPRESIGNEDDOWNLOADURL_RESPONSE = _GETPRESIGNEDDOWNLOADURL.nested_types_by_name['Response']
  _GETPRESIGNEDDOWNLOADURL_RESPONSE_HEADERSENTRY = _GETPRESIGNEDDOWNLOADURL_RESPONSE.nested_types_by_name['HeadersEntry']
  ...
  GetPresignedDownloadUrl = _reflection.GeneratedProtocolMessageType('GetPresignedDownloadUrl', (_message.Message,), {

    'Response' : _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), {

      'HeadersEntry' : _reflection.GeneratedProtocolMessageType('HeadersEntry', (_message.Message,), {
        'DESCRIPTOR' : _GETPRESIGNEDDOWNLOADURL_RESPONSE_HEADERSENTRY,
        '__module__' : 'mlflow_artifacts_pb2'
        # @@protoc_insertion_point(class_scope:mlflow.artifacts.GetPresignedDownloadUrl.Response.HeadersEntry)
        })
      ,
      'DESCRIPTOR' : _GETPRESIGNEDDOWNLOADURL_RESPONSE,
      '__module__' : 'mlflow_artifacts_pb2'
      # @@protoc_insertion_point(class_scope:mlflow.artifacts.GetPresignedDownloadUrl.Response)
      })
    ,
    'DESCRIPTOR' : _GETPRESIGNEDDOWNLOADURL,
    '__module__' : 'mlflow_artifacts_pb2'
    # @@protoc_insertion_point(class_scope:mlflow.artifacts.GetPresignedDownloadUrl)
    })
  _sym_db.RegisterMessage(GetPresignedDownloadUrl)
  _sym_db.RegisterMessage(GetPresignedDownloadUrl.Response)
  _sym_db.RegisterMessage(GetPresignedDownloadUrl.Response.HeadersEntry)
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GETPRESIGNEDDOWNLOADURL_RESPONSE_HEADERSENTRY._options = None
    _GETPRESIGNEDDOWNLOADURL_RESPONSE_HEADERSENTRY._serialized_options = b'8\001'
    ...
    _MLFLOWARTIFACTSSERVICE.methods_by_name['getPresignedDownloadUrl']._options = None
    _MLFLOWARTIFACTSSERVICE.methods_by_name['getPresignedDownloadUrl']._serialized_options = b'\362\206\031k\n=\n\003GET\0220/mlflow-artifacts/presigned/<path:artifact_path>\032\004\010\002\020\000\020\001*(Get Presigned URL for Multipart Download'
    ...
    _GETPRESIGNEDDOWNLOADURL._serialized_start=934
    _GETPRESIGNEDDOWNLOADURL._serialized_end=1134
    _GETPRESIGNEDDOWNLOADURL_RESPONSE._serialized_start=962
    _GETPRESIGNEDDOWNLOADURL_RESPONSE._serialized_end=1134
    _GETPRESIGNEDDOWNLOADURL_RESPONSE_HEADERSENTRY._serialized_start=814
    _GETPRESIGNEDDOWNLOADURL_RESPONSE_HEADERSENTRY._serialized_end=860
    _MLFLOWARTIFACTSSERVICE._serialized_start=1137
    _MLFLOWARTIFACTSSERVICE._serialized_end=2806
