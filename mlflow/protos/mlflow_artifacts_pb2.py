...
_LISTARTIFACTS_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="files",
            full_name="mlflow.artifacts.ListArtifacts.Response.files",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_LISTARTIFACTS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="path",
            full_name="mlflow.artifacts.ListArtifacts.path",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_FILEINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="path",
            full_name="mlflow.artifacts.FileInfo.path",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="is_dir",
            full_name="mlflow.artifacts.FileInfo.is_dir",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="file_size",
            full_name="mlflow.artifacts.FileInfo.file_size",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
...
DownloadArtifact = _reflection.GeneratedProtocolMessageType(
    "DownloadArtifact",
    (_message.Message,),
    dict(
...
UploadArtifact = _reflection.GeneratedProtocolMessageType(
    "UploadArtifact",
    (_message.Message,),
    dict(
        Response=_reflection.GeneratedProtocolMessageType(
...
MlflowArtifactsService = service_reflection.GeneratedServiceType(
    "MlflowArtifactsService",
    (_service.Service,),
    dict(DESCRIPTOR=_MLFLOWARTIFACTSSERVICE, __module__="mlflow_artifacts_pb2"),
)

MlflowArtifactsService_Stub = service_reflection.GeneratedServiceStubType(
    "MlflowArtifactsService_Stub",
    (MlflowArtifactsService,),
    dict(DESCRIPTOR=_MLFLOWARTIFACTSSERVICE, __module__="mlflow_artifacts_pb2"),
)
