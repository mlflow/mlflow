...
class Assessment(_message.Message):
    __slots__ = ("assessment_id", "assessment_name", "trace_identifier", "span_id", "source", "create_time", "last_update_time", "feedback", "expectation", "rationale", "metadata", "overrides", "valid")
    ...
    TRACE_IDENTIFIER_FIELD_NUMBER: _ClassVar[int]
