...
if Version(google.protobuf.__version__).major >= 5:
  ...
  Dataset = _reflection.GeneratedProtocolMessageType('Dataset', (_message.Message,), {
    'DESCRIPTOR' : _DATASET,
    '__module__' : 'mlflow.protos.datasets_pb2'
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DATASET._serialized_end=273
    _DATASETRECORD._serialized_start=276
    _DATASETRECORD._serialized_end=605
    _DATASETRECORDSOURCE._serialized_start=608
    _DATASETRECORDSOURCE._serialized_end=809
    _DATASETRECORDSOURCE_SOURCETYPE._serialized_start=722
    _DATASETRECORDSOURCE_SOURCETYPE._serialized_end=809
  # @@protoc_insertion_point(module_scope)
