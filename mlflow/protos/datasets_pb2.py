...
if Version(google.protobuf.__version__).major >= 5:
  ...
  if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DATASETRECORD']._serialized_end=574
    _globals['_DATASETRECORDSOURCE']._serialized_start=577
    _globals['_DATASETRECORDSOURCE']._serialized_end=778
    _globals['_DATASETRECORDSOURCE_SOURCETYPE']._serialized_start=691
    _globals['_DATASETRECORDSOURCE_SOURCETYPE']._serialized_end=778
  ...
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DATASETRECORD._serialized_end=574
    _DATASETRECORDSOURCE._serialized_start=577
    _DATASETRECORDSOURCE._serialized_end=778
    _DATASETRECORDSOURCE_SOURCETYPE._serialized_start=691
    _DATASETRECORDSOURCE_SOURCETYPE._serialized_end=778
  # @@protoc_insertion_point(module_scope)
