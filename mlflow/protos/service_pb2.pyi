...
class TraceInfoV4(_message.Message):
    ...
    class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        STATE_UNSPECIFIED: _ClassVar[TraceInfoV4.State]
        OK: _ClassVar[TraceInfoV4.State]
        ERROR: _ClassVar[TraceInfoV4.State]
        IN_PROGRESS: _ClassVar[TraceInfoV4.State]
    STATE_UNSPECIFIED: TraceInfoV4.State
    OK: TraceInfoV4.State
    ERROR: TraceInfoV4.State
    IN_PROGRESS: TraceInfoV4.State
...
class TraceV4(_message.Message):
    ...
    trace_info: TraceInfoV4
    spans: _containers.RepeatedCompositeFieldContainer[Span]
    def __init__(self, trace_info: _Optional[_Union[TraceInfoV4, _Mapping]] = ..., spans: _Optional[_Iterable[_Union[Span, _Mapping]]] = ...) -> None: ...
...
class DeleteTraceTagV4(_message.Message):
...
class CreateTrace(_message.Message):
    ...
    class Response(_message.Message):
        ...
        TRACE_INFO_FIELD_NUMBER: _ClassVar[int]
        trace_info: TraceInfoV4
        def __init__(self, trace_info: _Optional[_Union[TraceInfoV4, _Mapping]] = ...) -> None: ...
    TRACE_INFO_FIELD_NUMBER: _ClassVar[int]
    SQL_WAREHOUSE_ID_FIELD_NUMBER: _ClassVar[int]
    trace_info: TraceInfoV4
    sql_warehouse_id: str
    def __init__(self, trace_info: _Optional[_Union[TraceInfoV4, _Mapping]] = ..., sql_warehouse_id: _Optional[str] = ...) -> None: ...
