...
class DeleteDatasetRecords(_message.Message):
    __slots__ = ("dataset_id", "dataset_record_ids", "deleted_by")
    class Response(_message.Message):
    ...
    deleted_by: str
    def __init__(self, dataset_id: _Optional[str] = ..., dataset_record_ids: _Optional[_Iterable[str]] = ..., deleted_by: _Optional[str] = ...) -> None: ...
