...
_LOGBATCH_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='unprocessedMetrics', full_name='mlflow.LogBatch.Response.unprocessedMetrics', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unprocessedParams', full_name='mlflow.LogBatch.Response.unprocessedParams', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unprocessedTags', full_name='mlflow.LogBatch.Response.unprocessedTags', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BATCHLOGFAILURE.fields_by_name['error_code'].enum_type = databricks__pb2._ERRORCODE
_LOGBATCH_RESPONSE.fields_by_name['unprocessedMetrics'].message_type = _BATCHLOGFAILURE
_LOGBATCH_RESPONSE.fields_by_name['unprocessedParams'].message_type = _BATCHLOGFAILURE
_LOGBATCH_RESPONSE.fields_by_name['unprocessedTags'].message_type = _BATCHLOGFAILURE
