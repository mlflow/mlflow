...
# source: mlflow/api/proto/service.proto
...
Metric = _reflection.GeneratedProtocolMessageType('Metric', (_message.Message,), dict(
  DESCRIPTOR = _METRIC,
  __module__ = 'mlflow.api.proto.service_pb2'
