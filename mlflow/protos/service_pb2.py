...
_CONFIG = _descriptor.Descriptor(
  name='Config',
  full_name='mlflow.Config',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='mlflow.Config.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='mlflow.Config.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RUNDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='configs', full_name='mlflow.RunData.configs', index=3,
...
_LOGCONFIG_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflow.LogConfig.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LOGCONFIG = _descriptor.Descriptor(
  name='LogConfig',
  full_name='mlflow.LogConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_uuid', full_name='mlflow.LogConfig.run_uuid', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\210\265\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='key', full_name='mlflow.LogConfig.key', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\210\265\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='mlflow.LogConfig.value', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_LOGCONFIG_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
  is_extendable=False,
...
_LOGBATCH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='configs', full_name='mlflow.LogBatch.configs', index=4,
...
_RUNDATA.fields_by_name['configs'].message_type = _CONFIG
...
_LOGCONFIG_RESPONSE.containing_type = _LOGCONFIG
...
_LOGBATCH.fields_by_name['configs'].message_type = _CONFIG
...
Config = _reflection.GeneratedProtocolMessageType('Config', (_message.Message,), dict(
  DESCRIPTOR = _CONFIG,
  __module__ = 'service_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.Config)
  ))
...
LogConfig = _reflection.GeneratedProtocolMessageType('LogConfig', (_message.Message,), dict(
  ...
  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    DESCRIPTOR = _LOGCONFIG_RESPONSE,
    __module__ = 'service_pb2'
    # @@protoc_insertion_point(class_scope:mlflow.LogConfig.Response)
    ))
  ,
  DESCRIPTOR = _LOGCONFIG,
  __module__ = 'service_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.LogConfig)
  ))
_sym_db.RegisterMessage(LogConfig)
_sym_db.RegisterMessage(LogConfig.Response)
...
_LOGCONFIG.fields_by_name['run_uuid']._options = None
_LOGCONFIG.fields_by_name['key']._options = None
_LOGCONFIG.fields_by_name['value']._options = None
...
_MLFLOWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='logConfig',
    full_name='mlflow.MlflowService.logConfig',
    index=12,
    containing_service=None,
    input_type=_LOGCONFIG,
    output_type=_LOGCONFIG_RESPONSE,
    serialized_options=_b('\202\265\030=\n-\n\004POST\022\037/preview/mlflow/runs/log-config\032\004\010\002\020\000\020\001*\nLog Config'),
  ),
  _descriptor.MethodDescriptor(
    name='setTag',
