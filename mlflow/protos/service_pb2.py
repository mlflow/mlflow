...
_MLFLOWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\362\206\031|\n-\n\004POST\022\037/mlflow/runs/set-experiment-tag\032\004\010\002\020\000\n5\n\004POST\022\'/preview/mlflow/runs/set-experiment-tag\032\004\010\002\020\000\020\001*\022Set Experiment Tag'),
  ),
  _descriptor.MethodDescriptor(
    name='setTag',
