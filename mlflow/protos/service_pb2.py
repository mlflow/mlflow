...
_S3GETPRESIGNEDURL_RESPONSE_FIELDSENTRY = _descriptor.Descriptor(
  name='FieldsEntry',
  full_name='mlflow.S3GetPresignedUrl.Response.FieldsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='mlflow.S3GetPresignedUrl.Response.FieldsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='mlflow.S3GetPresignedUrl.Response.FieldsEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_S3GETPRESIGNEDURL_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflow.S3GetPresignedUrl.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='url', full_name='mlflow.S3GetPresignedUrl.Response.url', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fields', full_name='mlflow.S3GetPresignedUrl.Response.fields', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_S3GETPRESIGNEDURL_RESPONSE_FIELDSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_S3GETPRESIGNEDURL = _descriptor.Descriptor(
  name='S3GetPresignedUrl',
  full_name='mlflow.S3GetPresignedUrl',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='bucket_name', full_name='mlflow.S3GetPresignedUrl.bucket_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='key', full_name='mlflow.S3GetPresignedUrl.key', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='method', full_name='mlflow.S3GetPresignedUrl.method', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_S3GETPRESIGNEDURL_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
  is_extendable=False,
...
_S3GETPRESIGNEDURL_RESPONSE_FIELDSENTRY.containing_type = _S3GETPRESIGNEDURL_RESPONSE
_S3GETPRESIGNEDURL_RESPONSE.fields_by_name['fields'].message_type = _S3GETPRESIGNEDURL_RESPONSE_FIELDSENTRY
_S3GETPRESIGNEDURL_RESPONSE.containing_type = _S3GETPRESIGNEDURL
...
DESCRIPTOR.message_types_by_name['S3GetPresignedUrl'] = _S3GETPRESIGNEDURL
...
S3GetPresignedUrl = _reflection.GeneratedProtocolMessageType('S3GetPresignedUrl', (_message.Message,), dict(

  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(

    FieldsEntry = _reflection.GeneratedProtocolMessageType('FieldsEntry', (_message.Message,), dict(
      DESCRIPTOR = _S3GETPRESIGNEDURL_RESPONSE_FIELDSENTRY,
      __module__ = 'service_pb2'
      # @@protoc_insertion_point(class_scope:mlflow.S3GetPresignedUrl.Response.FieldsEntry)
      ))
    ,
    DESCRIPTOR = _S3GETPRESIGNEDURL_RESPONSE,
    __module__ = 'service_pb2'
    # @@protoc_insertion_point(class_scope:mlflow.S3GetPresignedUrl.Response)
    ))
  ,
  DESCRIPTOR = _S3GETPRESIGNEDURL,
  __module__ = 'service_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.S3GetPresignedUrl)
  ))
_sym_db.RegisterMessage(S3GetPresignedUrl)
_sym_db.RegisterMessage(S3GetPresignedUrl.Response)
_sym_db.RegisterMessage(S3GetPresignedUrl.Response.FieldsEntry)
...
_S3GETPRESIGNEDURL_RESPONSE_FIELDSENTRY._options = None
_S3GETPRESIGNEDURL._options = None
...
_MLFLOWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='s3GetPresignedUrl',
    full_name='mlflow.MlflowService.s3GetPresignedUrl',
    index=19,
    containing_service=None,
    input_type=_S3GETPRESIGNEDURL,
    output_type=_S3GETPRESIGNEDURL_RESPONSE,
    serialized_options=_b('\362\206\031\177\n/\n\003GET\022\"/mlflow/artifacts/s3/presigned-url\032\004\010\002\020\000\n7\n\003GET\022*/preview/mlflow/artifacts/s3/presigned-url\032\004\010\002\020\000\020\001*\021Get Presigned URL'),
  ),
  _descriptor.MethodDescriptor(
    name='getMetricHistory',
