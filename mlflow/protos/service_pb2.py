...
_DELETERUNBATCH_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflow.DeleteRunBatch.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_DELETERUNBATCH = _descriptor.Descriptor(
  name='DeleteRunBatch',
  full_name='mlflow.DeleteRunBatch',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_ids', full_name='mlflow.DeleteRunBatch.run_ids', index=0,
  ...
  nested_types=[_DELETERUNBATCH_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
  is_extendable=False,
...
_DELETERUNBATCH_RESPONSE.containing_type = _DELETERUNBATCH
...
DESCRIPTOR.message_types_by_name['DeleteRunBatch'] = _DELETERUNBATCH
...
DeleteRunBatch = _reflection.GeneratedProtocolMessageType('DeleteRunBatch', (_message.Message,), dict(

  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    DESCRIPTOR = _DELETERUNBATCH_RESPONSE,
    __module__ = 'service_pb2'
    # @@protoc_insertion_point(class_scope:mlflow.DeleteRunBatch.Response)
    ))
  ,
  DESCRIPTOR = _DELETERUNBATCH,
  __module__ = 'service_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.DeleteRunBatch)
  ))
_sym_db.RegisterMessage(DeleteRunBatch)
_sym_db.RegisterMessage(DeleteRunBatch.Response)
...
_MLFLOWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='deleteRunBatch',
    full_name='mlflow.MlflowService.deleteRunBatch',
    index=10,
    containing_service=None,
    input_type=_DELETERUNBATCH,
    output_type=_DELETERUNBATCH_RESPONSE,
    serialized_options=_b('\362\206\031n\n\'\n\004POST\022\031/mlflow/runs/delete-batch\032\004\010\002\020\000\n/\n\004POST\022!/preview/mlflow/runs/delete-batch\032\004\010\002\020\000\020\001*\020Delete Run Batch'),
  ),
  _descriptor.MethodDescriptor(
    name='restoreRun',
