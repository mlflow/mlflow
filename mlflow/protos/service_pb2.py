...
_SAFETOEDITRUN_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflow.SafeToEditRun.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='mlflow.SafeToEditRun.Response.value', index=0,
...
_SAFETOEDITRUN = _descriptor.Descriptor(
  name='SafeToEditRun',
  full_name='mlflow.SafeToEditRun',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_id', full_name='mlflow.SafeToEditRun.run_id', index=0,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_SAFETOEDITRUN_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
  is_extendable=False,
...
_SAFETOEDITRUN_RESPONSE.containing_type = _SAFETOEDITRUN
...
DESCRIPTOR.message_types_by_name['SafeToEditRun'] = _SAFETOEDITRUN
...
SafeToEditRun = _reflection.GeneratedProtocolMessageType('SafeToEditRun', (_message.Message,), dict(

  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    DESCRIPTOR = _SAFETOEDITRUN_RESPONSE,
    __module__ = 'service_pb2'
    # @@protoc_insertion_point(class_scope:mlflow.SafeToEditRun.Response)
    ))
  ,
  DESCRIPTOR = _SAFETOEDITRUN,
  __module__ = 'service_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.SafeToEditRun)
  ))
_sym_db.RegisterMessage(SafeToEditRun)
_sym_db.RegisterMessage(SafeToEditRun.Response)
...
_MLFLOWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='safeToEditRun',
    full_name='mlflow.MlflowService.safeToEditRun',
    index=17,
    containing_service=None,
    input_type=_SAFETOEDITRUN,
    output_type=_SAFETOEDITRUN_RESPONSE,
    serialized_options=_b('\362\206\031h\n0\n\003GET\022#/mlflow/config/safe_to_edit_run/get\032\004\010\002\020\000\020\001*2Returns true iff it\'s ok to edit this run in place'),
  ),
  _descriptor.MethodDescriptor(
    name='searchRuns',
