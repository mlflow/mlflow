...
if IS_PYDANTIC_V2_OR_NEWER:
    ...
    class ResponsesAgent(PythonModel, metaclass=ABCMeta):
        ...
        See https://mlflow.org/docs/latest/genai/serving/responses-agent for more details.
        """
        ...
        def predict(self, request: ResponsesAgentRequest) -> ResponsesAgentResponse:
            ...
            https://mlflow.org/docs/latest/genai/serving/responses-agent#simple-chat-example and
            https://mlflow.org/docs/latest/genai/serving/responses-agent#tool-calling-example.
            """
        ...
        def predict_stream(
            ...
            See more details at
            https://mlflow.org/docs/latest/genai/serving/responses-agent#streaming-agent-output.
        ...
        def create_text_delta(self, delta: str, item_id: str) -> dict[str, Any]:
            ...
            Read more at https://mlflow.org/docs/latest/genai/serving/responses-agent#streaming-agent-output.
            """
            return {
        ...
        def create_text_output_item(self, text: str, id: str) -> dict[str, Any]:
            ...
            Read more at https://mlflow.org/docs/latest/genai/serving/responses-agent#creating-agent-output.
