...
class ChatAgent(PythonModel, metaclass=ABCMeta):
    ...
    def predict(self, model_input: ChatAgentRequest) -> ChatAgentResponse:
        ...
        Args:
            model_input (:py:class:`ChatAgentRequest <mlflow.types.agent.ChatAgentRequest>`):
                A :py:class:`ChatAgentRequest <mlflow.types.agent.ChatAgentRequest>` object
                containing a list of (:py:class:`ChatAgentMessage <mlflow.types.agent.
                ChatAgentMessage>`) objects representing the chat history and a
                (:py:class:`ChatAgentParams <mlflow.types.agent.ChatAgentParams>`) object
                containing various parameters used to modify model behavior during inference.
