    ...
    **kwargs,
    ...
    Log a PyTorch model as an MLflow artifact for the current run.
        ...
        .. warning::
            ...
            For models without signatures, the MLflow Model Server relies on the default inferred data type from NumPy.
            However, PyTorch often expects different defaults, particularly when parsing floats.
            Include the signature to ensure that the model is logged with the correct data type so that the MLflow model
             server can correctly produce valid input to the model.
