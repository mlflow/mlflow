...
def autolog(
    ...
    **Note**: Autologging is only supported for PyTorch Lightning models,
    ...
    :param disable_for_unsupported_versions: If True, disable autologging for versions of pytorch and pytorch-lightning that have not been tested against this version of the MLflow client or are incompatible.
