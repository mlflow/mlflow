...
class Model(object):
    ...
    def log(cls, artifact_path, flavor, registered_model_name=None,
        ...
        :param signature: Note:: Experimental: This argument may change or be removed
                          release without warning. :py:class:`ModelSignature` describes model input
        ...
        :param input_example: Note:: Experimental: This argument may change or be removed in a
                              ...
                              what data to feed the model. The given example will be converted to a
                              Pandas DataFrame and then serialized to json using the Pandas
                              split-oriented format. Bytes are base64-encoded.
