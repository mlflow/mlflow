...
class ModelInfo:
    ...
    def __init__(
        ...
        """
        :param artifact_path: Run relative path identifying the logged model.
        :param flavors: A dictionary mapping the flavor name to how to serve
        ...
        :param model_uri: The ``model_uri`` of the logged model in the format
                          ``'runs:/<run_id>/<artifact_path>'``.
        :param model_uuid: The ``model_uuid`` of the logged model,
                           e.g., ``'39ca11813cfc46b09ab83972740b80ca'``.
        :param run_id: The ``run_id`` associated with the logged model,
                           e.g., ``'8ede7df408dd42ed9fc39019ef7df309'``
        :param saved_input_example_info: A dictionary that contains the metadata
                                         of the saved input example, e.g.,
                                         ``{"artifact_path": "input_example.json",
                                            "type": "dataframe",
                                            "pandas_orient": "split"}``.
        :param signature_dict: A dictionary that describes the model input and
                               output generated by :py:meth:`ModelSignature.to_dict()
                                <mlflow.models.ModelSignature.to_dict>`.
        :param signature: A :py:class:`ModelSignature <mlflow.models.ModelSignature>`
