...
class DefaultEvaluator(ModelEvaluator):
    ...
    def can_evaluate(self, *, model_type, evaluator_config, **kwargs):
        return model_type in MODEL_TYPE.get_all()
    ...
    def _log_model_explainability(self):
        ...
        is_multinomial_classifier = (
            self.model_type == MODEL_TYPE.CLASSIFIER and self.num_classes > 2
        )
    ...
    def _generate_model_predictions(self):
        ...
        """
        if self.model_type == MODEL_TYPE.CLASSIFIER:
            ...
            if self.predict_proba_fn is not None:
                ...
                self.y_probs = None
                self.y_prob = None
        elif self.model_type == MODEL_TYPE.REGRESSOR:
    ...
    def _evaluate(
        ...
        **kwargs,
        ...
        with TempDir() as temp_dir, matplotlib.rc_context(_matplotlib_config):
            ...
            if self.model_type not in MODEL_TYPE.get_all():
                raise MlflowException(
