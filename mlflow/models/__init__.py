...
class Model(object):
    ...
    def log(cls, artifact_path, flavor, **kwargs):
        ...
        :param flavor: Flavor module / object to save the model with. The module / object must have the
          ``save_model`` function that will persist the model as a valid MLflow model.
