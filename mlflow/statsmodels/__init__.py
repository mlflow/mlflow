...
_SAVE_MODEL_CALLED_FROM_AUTOLOG_KEY = "SAVE_MODEL_CALLED_FROM_AUTOLOG"
...
def save_model(
    ...
    if get_thread_local_var(_SAVE_MODEL_CALLED_FROM_AUTOLOG_KEY, False) and not remove_data:
        ...
        try:
            ...
            if should_autolog:
                ...
                if get_autologging_config(FLAVOR_NAME, "log_models", True):
                    set_thread_local_var(_SAVE_MODEL_CALLED_FROM_AUTOLOG_KEY, True)
                    ...
                    try:
                        ...
                        set_thread_local_var(_SAVE_MODEL_CALLED_FROM_AUTOLOG_KEY, False)
