...
`"anthropic:/claude-3.5-sonnet-20240620"`, or `"typesafe:/jev-latest"`. MLflow natively supports
`["openai", "anthropic", "bedrock", "mistral", "sap-ai-core", "typesafe"]`, and more providers
are supported through `LiteLLM <https://docs.litellm.ai/docs/providers>`_.
