...
def _call_llm(
    ...
    *,
    ...
    response = _invoke_litellm(
        ...
        # max_tokens issue:
        # gpt-5-mini: litellm.exceptions.BadRequestError: litellm.BadRequestError: OpenAIException - Unsupported parameter: 'max_tokens' is not supported with this model. Use 'max_completion_tokens' instead.
