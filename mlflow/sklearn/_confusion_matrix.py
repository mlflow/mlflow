...
# [CHANGED] `deprecated` is not used
...
class ConfusionMatrixDisplay:
    ...
    def plot(
        ...
        *,
        ...
        # [CHANGED] Specify `vmin` and `vmax` to fix the colorbar range to [0, 1]
        self.im_ = ax.imshow(cm, interpolation="nearest", cmap=cmap, vmin=0.0, vmax=1.0)
        self.text_ = None
        ...
        if include_values:
            ...
            for i, j in product(range(n_classes), range(n_classes)):
                # [CHANGED] Avoid making the plot too dense with annotations
                if (n_classes > 10) and (cm[i, j] < 0.1):
                    continue
...
# [CHANGED] MLflow doesn't need to raise this deprecation warning
# @deprecated(
