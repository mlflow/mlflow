...
[![Build Status](https://travis-ci.org/rstudio/mlflow.svg?branch=master)](https://travis-ci.org/rstudio/mlflow) [![CRAN_Status_Badge](https://www.r-pkg.org/badges/version/mlflow)](https://cran.r-project.org/package=mlflow) [![codecov](https://codecov.io/gh/rstudio/mlflow/branch/master/graph/badge.svg)](https://codecov.io/gh/rstudio/mlflow) 
...
Currently, the `mlflow` R package is not on CRAN; therefore, it is required to install the development version. Once released to CRAN, installation will look as follows:
...
Run results that we can view with `mlflow_ui()` or `mlflow_get_run()` as follows:
