...
if __name__ == "__main__":
    ...
    with mlflux.start_run():
        ...
        tracking_url_type_store = urlparse(mlflux.get_tracking_uri()).scheme
        ...
        if tracking_url_type_store != "file":
            ...
            # https://mlflux.org/docs/latest/model-registry.html#api-workflow
            mlflux.sklearn.log_model(lr, "model", registered_model_name="ElasticnetWineModel")
        else:
