...
|   Field Name    |                 Type                 |                            Description                            |
+=================+======================================+===================================================================+
| traces          | An array of :ref:`mlflowtraceinfov3` | The first trace of each session that matches the search criteria. |
+-----------------+--------------------------------------+-------------------------------------------------------------------+
| next_page_token | ``STRING``                           |                                                                   |
+-----------------+--------------------------------------+-------------------------------------------------------------------+
...
first trace (by ``timestamp_ms``) of a session. The ``filter`` and
``order_by`` are evaluated against the first trace of each session;
