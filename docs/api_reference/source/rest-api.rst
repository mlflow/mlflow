...
.. _mlflowMlflowServicecreateDistillationJob:
...
|                  Endpoint                  | HTTP Method |
+============================================+=============+
| ``2.0/mlflow/prompt-optimization/distill`` | ``POST``    |
+--------------------------------------------+-------------+

Create a prompt distillation job.
This endpoint initiates a knowledge distillation workflow:
1. Generates traces using the teacher model on the input dataset
2. Creates a distillation dataset from teacher traces
3. Optimizes the student prompt to match teacher responses




.. _mlflowCreateDistillationJob:
...
Request to create a distillation job for knowledge transfer between teacher and student models.


+-----------------------+----------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
|      Field Name       |            Type            |                                                                   Description                                                                   |
+=======================+============================+=================================================================================================================================================+
| experiment_id         | ``STRING``                 | ID of the MLflow experiment to track the distillation job in.                                                                                   |
+-----------------------+----------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
| teacher_prompt_uri    | ``STRING``                 | URI of the teacher prompt (e.g., "prompts:/aime_solver/9"). This prompt has model_config pointing to the teacher (larger/better) model.         |
+-----------------------+----------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
| student_prompt_uri    | ``STRING``                 | URI of the student prompt (e.g., "prompts:/aime_solver/10"). This prompt has model_config pointing to the student (smaller) model. The student  |
|                       |                            | prompt will be optimized to match teacher responses.                                                                                            |
+-----------------------+----------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
| dataset_id            | ``STRING``                 | ID of the EvaluationDataset containing input data for distillation.                                                                             |
+-----------------------+----------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
| optimizer_type        | :ref:`mlflowoptimizertype` | The optimizer type to use for student prompt optimization.                                                                                      |
+-----------------------+----------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
| optimizer_config_json | ``STRING``                 | JSON-serialized optimizer-specific configuration. Same format as CreatePromptOptimizationJob.config.optimizer_config_json                       |
+-----------------------+----------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+

.. _mlflowCreateDistillationJobResponse:
...
|       Field Name        |                Type                |                                                            Description                                                             |
+=========================+====================================+====================================================================================================================================+
| job                     | :ref:`mlflowpromptoptimizationjob` | The created distillation job (stored as PromptOptimizationJob with distillation tags).                                             |
+-------------------------+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------+
| distillation_dataset_id | ``STRING``                         | ID of the distillation dataset created from teacher traces. This dataset contains inputs + teacher responses as expected_response. |
+-------------------------+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------+----------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
| scorers               | An array of ``STRING``     | List of scorer names. Can be built-in scorer class names (e.g., "Correctness", "Safety") or registered scorer names. For distillation mode,     |
|                       |                            | this is ignored and SemanticMatch is used automatically.                                                                                        |
+-----------------------+----------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------+----------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
| teacher_prompt_uri    | ``STRING``                 | URI of the teacher prompt for distillation (e.g., "prompts:/my-prompt/1"). Required when optimizer_type is OPTIMIZER_TYPE_DISTILLATION. The     |
|                       |                            | teacher prompt's model config defines which LLM generates the target responses.                                                                 |
+-----------------------+----------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------------+------------------------------------------------------------------------------------------+
| OPTIMIZER_TYPE_DISTILLATION | Distillation optimizer - optimizes student prompt to match teacher model responses.      |
