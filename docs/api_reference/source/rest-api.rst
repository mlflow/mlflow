...
| created_by    | ``STRING``                     |                                                                                  |
+---------------+--------------------------------+----------------------------------------------------------------------------------+
| endpoint_id   | ``STRING``                     | Gateway endpoint this policy applies to. Required when target_scope is ENDPOINT. |
+---------------+--------------------------------+----------------------------------------------------------------------------------+
| principal     | ``STRING``                     | Principal (user identity) the budget applies to. Required for USER scope.        |
+---------------+--------------------------------+----------------------------------------------------------------------------------+
...
+------------------+------------+-----------------------------------------------------------------------------------+
| endpoint_id      | ``STRING`` | Gateway endpoint this window is scoped to (only set for ENDPOINT-scoped policies) |
+------------------+------------+-----------------------------------------------------------------------------------+
...
| endpoint_id      | ``STRING``                     | Gateway endpoint this policy applies to. Required when target_scope is ENDPOINT.                    |
+------------------+--------------------------------+-----------------------------------------------------------------------------------------------------+
| principal        | ``STRING``                     | Principal (user identity) the budget applies to. Required for USER scope, ignored for other scopes. |
+------------------+--------------------------------+-----------------------------------------------------------------------------------------------------+
