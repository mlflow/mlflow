...
+------------------+------------------------+----------------------------------------------------------------------+
| version          | ``INT32``              | Immutable dataset revision                                           |
+------------------+------------------------+----------------------------------------------------------------------+
...
+------------+------------+--------------------------------------------+
| version    | ``INT32``  | Optional immutable dataset revision        |
+------------+------------+--------------------------------------------+
...
| Field Name |    Type    |       Description        |
+============+============+==========================+
| dataset_id | ``STRING`` |  This field is required. |
+------------+------------+--------------------------+
...
.. _mlflowListDatasetVersionsResponse:
...
| Field Name |                      Type                       | Description |
+============+=================================================+=============+
| versions   | An array of :ref:`mlflowdatasetsdatasetversion` |             |
+------------+-------------------------------------------------+-------------+
