...
Create Prompt Permission
========================

+-----------------------------------------------------+-------------+
|                      Endpoint                       | HTTP Method |
+=====================================================+=============+
| ``2.0/mlflow/registered-models/permissions/create`` | ``POST``    |
+-----------------------------------------------------+-------------+
...
| Field Name |          Type           |       Description       |
+============+=========================+=========================+
| name       | ``STRING``              | Registered prompt name. |
+------------+-------------------------+-------------------------+
| username   | ``STRING``              | Username.               |
+------------+-------------------------+-------------------------+
| permission | :ref:`mlflowPermission` | Permission to grant.    |
...
|         Field Name          |                  Type                  |              Description              |
+=============================+========================================+=======================================+
| registered_model_permission | :ref:`mlflowRegisteredModelPermission` | A prompt permission object.            |
+-----------------------------+----------------------------------------+---------------------------------------+

===========================

Get Prompt Permission
=====================
