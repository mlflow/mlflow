...
.. code:: r
   ...
   cast_choice(x, choices, allow_null = FALSE)
...
.. code:: r
   ...
   cast_nullable_scalar_integer(x)
...
.. code:: r
   ...
   cast_scalar_double(x, allow_na = FALSE)
