...
By default, MLflow exports traces to the MLflow Tracking Server. To enable exporting traces to OpenTelemetry Collector, use :py:func:`mlflow.set_trace_exporter` to set the exporter configuration.

.. code-block:: python

    import mlflow

    mlflow.set_trace_exporter(type="otel", target_url="http://localhost:4317/v1/traces")
    ...
    # instead of the MLflow Tracking Server
