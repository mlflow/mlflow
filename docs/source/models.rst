...
Inference configuration can be changed at loading time by indicating `inference_config` parameter in the 
...
may be needed to compute the predictions for their specific samples.
