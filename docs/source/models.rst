...
:py:func:`sklearn.log_model() <mlflow.sklearn.log_model>`. More details on logging signature with the model are :ref:`here <how-to-log-models-with-signatures>`. The signature is stored in
