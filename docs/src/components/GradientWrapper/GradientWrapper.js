...
export function getGradientStyles(variant, direction = 'up', isFooter, height) {
...
export function GradientWrapper({ element: Element = 'div', variant, direction = 'up', isFooter = false, children, height, className, }) {
