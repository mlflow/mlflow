...
import { getProvider } from '@site/src/components/OpenAICompatibleProviders/config';
export const OpenAICompatibleTracingDoc = ({ providerId }) => {
...
await answerQuestion("What is the capital of France?");`}
      ...
      <ImageBox src="/images/llms/tracing/openai-trace-with-manual-span.png" alt={`${codeRefName} Tracing with Manual Tracing`}/>
