...
export function NotebookDownloadButton(_a) {
    var _this = this;
    var children = _a.children, href = _a.href;
    var handleClick = useCallback(function (e) { return __awaiter(_this, void 0, void 0, function () {
        var response, blob, url, link, filename;
