...
var footerVariants = cva('pb-30 flex flex-col pt-30 bg-bottom bg-no-repeat bg-cover bg-size-[auto_360px] 2xl:bg-size-[100%_360px]', {
    variants: {
        theme: {
            dark: 'bg-brand-black',
            light: 'bg-white',
...
var getLogo = function (isDarkMode) {
...
export var Footer = function (_a) {
    ...
    var Logo = getLogo(isDarkMode);
    return (<GradientWrapper variant={variant} isFooter className={footerVariants({ theme: colorMode })} element="footer" height={360}>
