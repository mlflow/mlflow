...
<CardGroup>
  <PageCard headerText="MLflow Tracking Quickstart Guide" link="notebooks/tracking_quickstart" text="Learn the basics of MLflow Tracking in a fast-paced guide with a focus on seeing your first model in the MLflow UI" />
</CardGroup>
...
<figure style={{ margin: 0, width: 1024, maxWidth: "100%", textAlign: "center" }}>
