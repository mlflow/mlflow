...
Then navigate to the "Workspace" tab on the left and click that link to expand the file navigation pane. 
...
Note that your experiment name must follow `/Users/<your email>/<experiment_name>` format when using a Databricks Workspace.
