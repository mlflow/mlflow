...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ...
  demo](/images/tutorials/introductory/logging-first-model/dogfood-diagram.svg)
  <figcaption>
...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ...
  test](/images/tutorials/introductory/logging-first-model/dogfood.gif)
...
<div className="center-div" style={{ width: 1024, maxWidth: "100%" }}>
  ...
  code](/images/tutorials/introductory/logging-first-model/training-annotation.png)
</div>
...
<div className="center-div" style={{ width: 1024, maxWidth: "100%" }}>
  ![Log the model to
  MLflow](/images/tutorials/introductory/logging-first-model/logging-first-model.gif)
</div>
