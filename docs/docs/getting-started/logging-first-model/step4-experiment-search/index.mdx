...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ...
  UI](/images/tutorials/introductory/logging-first-model/first-experiment-ui.gif)
...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ...
  Page](/images/tutorials/introductory/logging-first-model/experiment-page-elements.svg)
...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![Creating a new
  Experiment](/images/tutorials/introductory/logging-first-model/creating-experiment.gif)
