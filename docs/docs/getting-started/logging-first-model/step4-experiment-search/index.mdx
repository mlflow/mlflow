...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![View our new experiment in the UI](/images/tutorials/introductory/logging-first-model/first-experiment-ui.gif)
...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![Important Data on the Experiment View Page](/images/tutorials/introductory/logging-first-model/experiment-page-elements.svg)
...
```bash title="The metadata associated with a created Experiment"
...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![Creating a new Experiment](/images/tutorials/introductory/logging-first-model/creating-experiment.gif)
  <figcaption>Creating a new Experiment and searching based on an Experiment tag</figcaption>
</figure>
