...
<Link to="/getting-started/databricks-trial" target="_blank">Databricks Free Trial </Link>. It offers a personal Databricks account with service credits that are valid for a limited time period, letting you get started with MLflow and other ML/AI tools in minutes.
:::
