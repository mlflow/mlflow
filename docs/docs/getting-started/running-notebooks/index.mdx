...
<Link to="/databricks-trial.html" target="_blank">Databricks Free Trial </Link>. It offers an expedited access for a Databricks workspace and services with limited credits and time periods, let you get started with MLflow and other ML/AI tools in minutes.
:::
