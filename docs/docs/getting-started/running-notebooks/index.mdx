...
<Link to="/community-edition.html" target="_blank">Databricks Community Edition </Link>. It offers an expedited access for a Databricks workspace and services without the enterprise setup, let you get started with MLflow and other ML/AI tools in minutes.
:::
