...
to serve the inference endpoint. However, FastAPI does not support holizontal scalabiling natively and might not be suitable for production use cases
...
of Kubernetes to serve your model at scale. See [Serving Framework](/deployment/deploy-model-locally#serving-frameworks) for the detailed comparison between FastAPI and MLServer,
