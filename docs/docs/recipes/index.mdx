...
<a class="anchor-with-sticky-navbar" name="recipes-installation" />
...
<a class="anchor-with-sticky-navbar" name="steps-key-concept" />
...
<a class="anchor-with-sticky-navbar" name="recipes-key-concept" />
...
<a class="anchor-with-sticky-navbar" name="profiles-key-concept" />
...
<a class="anchor-with-sticky-navbar" name="step-cards-key-concept" />
...
4.  Iterate over step 2 and 3: make changes to an individual step, and test them by running
    ...
    <figure style={{ width: "60%" }}>
      ...
      <figcaption>
        Example Recipe.inspect() output, showing the dependency graph of recipe steps and artifacts
        each step produces.
      </figcaption>
    </figure>
...
<a class="anchor-with-sticky-navbar" name="regression-template" />
...
<a class="anchor-with-sticky-navbar" name="classification-template" />
...
- `steps`: A directory containing Python code modules used by the recipe steps. For example,
  ...
  <a class="anchor-with-sticky-navbar" name="profiles-directory" />
...
<Tabs>
  <TabItem value="python" label="Pyton" default>
    ```python
    import os
    from mlflow.recipes import Recipe
...
- **overrides**
  ...
  - If the `recipe.yaml` configuration file defines a [Jinja2](https://jinja.palletsprojects.com/)-templated
    ...
    Example `recipe.yaml` configuration file defining an overrideable
