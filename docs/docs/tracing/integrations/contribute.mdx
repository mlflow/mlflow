...
- [Tracing Concepts](/tracing/tutorials/concept/) - Understand what tracing is and the specific benefits for MLflow users.
...
<div class="quiz">
    ...
    <details>
        ...
        <em>Reference:</em> [MLflow Tracing API Guide](/tracing/api/client/)</p>
    </details>
...
- **Standardization**: Ensure consistency with other MLflow integrations for usability and downstream tasks. For example, retrieval spans should follow the [Retriever Schema](/tracing/tracing-schema#retriever-spans) for UI compatibility.
