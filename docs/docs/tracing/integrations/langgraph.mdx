...
[MLflow Tracing](../) provides automatic tracing capability for LangGraph, as a extension of its LangChain integration. By enabling auto-tracing for LangChain by calling the <APILink fn="mlflow.langchain.autolog" /> function, MLflow will
...
By combining auto-tracing with the [manual tracing APIs](../sdk/manual-instrumentation), you can add child spans inside a node or tool, to get more detailed insights for the step.
