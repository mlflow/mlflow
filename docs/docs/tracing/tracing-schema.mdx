...
To learn more about how `TraceInfo` metadata is used for searching, you can see examples [here](/tracing#searching-and-retrieving-traces).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        additional context, aid in [search functionality](/tracing#searching-and-retrieving-traces), or to
