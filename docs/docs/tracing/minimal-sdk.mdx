...
MLflow offers a lightweight tracing SDK package called `mlflow-tracing` that includes only the essential functionality for tracing and monitoring your GenAI applications. This package is designed for production environments where minimizing dependencies and deployment size is crucial.
...
<CardGroup cols={2}>
    ...
    <TitleCard
        ...
        description="A smaller set of dependencies means less work keeping up with dependency updates, security patches, and breaking changes from upstream libraries."
    />
    <TitleCard
        title="📦 Portability"
        description="With the less number of dependencies, MLflow Tracing can be easily deployed across different environments and platforms, without worrying about compatibility issues."
    />
    <TitleCard
...
Do not install the full `mlflow` package together with the lightweight SDK, as this may cause version conflicts.
    ...
    <div class="flex-column">
      <div class="flex-row">
        <div class="flex-item">
          ...
          GenAI application with MLflow Tracing. It provides an instant access to a fully functional monitoring dashboard for operational excellence and quality analysis.
    ...
    <div class="flex-column">
      <div class="flex-row">
        <div class="flex-item">
          ...
          MLflow is a **fully open-source project**, allowing you to self-host your own MLflow server and keep your data private. This is a great option if you want to have full control over your data and infrastructure.

          In self-hosting mode, you will be responsible for running the tracking server instance
          and scaling it to your needs. We **strongly recommend** using SQL-based tracking server
    ...
    <div class="flex-column">
      <div class="flex-row">
        <div class="flex-item">
          ...
          MLflow Tracing is **built on OpenTelemetry tracing spec**, an industry-standard framework for observability, making it vendor neutral solution for monitoring your GenAI applications.
...
<CardGroup cols={1}>
    <TitleCard
        ...
        description="MLflow Tracing SDK supports one-line integration with 15+ AI libraries including OpenAI, LangChain, LlamaIndex, Anthropic, Amazon Bedrock, DSPy, and more. This
    ...
    <TitleCard
        ...
        be used together, allowing you to trace an advanced applications with custom code and
        fine-grained control over the tracing behavior."
        link="/tracing/api/manual-instrumentation"
    />
    <TitleCard
        title="✍ Tagging and Filtering Traces"
        description="By annotating traces with custom tags, you can add more context to your traces for grouping and searching for them later. This is useful when you want to trace
