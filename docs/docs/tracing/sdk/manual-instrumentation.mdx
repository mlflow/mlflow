...
In addition to the [Auto Tracing](..#automatic-tracing) integrations, you can instrument your Python code with MLflow Tracing SDK. This is useful when you want to instrument your custom Python code.
...
Tags can be added to traces to provide additional metadata at the trace level. There are a few different ways to set tags on a trace. Please refer to the [how-to guide](sdk/how-to.md#setting-trace-tags) for the other methods.
