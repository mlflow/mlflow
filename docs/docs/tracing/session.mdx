...
Alternatively, you can use the <APILink fn="mlflow.search_traces" /> function to get these traces programmatically. Refer to [Searching and Retrieving Traces](/tracing/sdk/search) for more details.
