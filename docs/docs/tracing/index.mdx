...
:::tip
    ...
    When using MLflow Tracing in production environment, we recommend using the [Lightweight Tracing SDK](/tracing/minimal-sdk) (`mlflow-tracing`) that is optimized for reducing the footprint and dependencies.
