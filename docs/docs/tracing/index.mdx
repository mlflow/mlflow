    ...
    <div class="flex-column">
      ...
      <div class="flex-row">
        <div class="flex-item">
          ...
          #### Comprehensive Debugging Experience in Your IDE or Notebook
  ...
  <TabItem value="dataset" label="Evaluation Dataset">
    <div class="flex-column">
      <div class="flex-row">
        ...
        When combined with [MLflow LLM Evaluation](../llms/evaluate.mdx), MLflow offers a seamless experience for assessing and improving your application’s performance.
  ...
  <TabItem value="inspect-quality" label="Inspect Quality">
    <div class="flex-column">
      <div class="flex-row">
        ...
        After evaluating your model using [MLflow LLM Evaluation](../llms/evaluate.mdx), you can explore auto-generated traces during the evaluation run to identify root causes of quality issues — for instance, insufficiently retrieved documents.
...
3. [Grouping or annotating traces using a tag.](sdk/how-to.mdx#trace-tags)
4. [Disabling trace globally.](sdk/how-to.mdx#disabling-traces)
