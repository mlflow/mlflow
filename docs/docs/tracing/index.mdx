  ...
  <TabItem value="online-monitoring" label="Production Monitoring">
    <div class="flex-column">
      <div class="flex-row">
        ...
        Refer to [Monitoring GenAI Application in Production](/tracing/production) for more details.
...
<CardGroup isSmall>
  ...
  <SmallLogoCard link="/tracing/integrations/pydantic_ai">
    <span>![Smolagents Logo](/images/logos/pydanticai-logo.png)</span>
  </SmallLogoCard>
</CardGroup>
<br />
...
:::tip
    ...
    When using MLflow Tracing in a production environment, we recommend using the [Lightweight Tracing SDK](/tracing/lightweight-sdk) (`mlflow-tracing`) that is optimized for reducing the total installation size and minimizing the set of dependencies.
