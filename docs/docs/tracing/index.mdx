...
:::tip
    ...
    When using MLflow Tracing in a production environment, we recommend using the [Lightweight Tracing SDK](/tracing/minimal-sdk) (`mlflow-tracing`) that is optimized for reducing the total installation size and minimizing the set of dependencies.
