...
<Table>
  ...
  <tbody>
    ...
    <tr>
      <td>create_run</td>
      <td>Whether the packages in [PACKAGES_TO_CHECK_IMPORT](https://github.com/mlflow/mlflow/blob/c71fd0d677c1806ba2d5928398435c4de2c25c0e/mlflow/telemetry/constant.py#L19) is imported or not</td>
    </tr>
    <tr>
