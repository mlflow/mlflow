...
<Tabs>
  ...
  <TabItem label="Pitfalls" value="pitfalls">
    ...
    will always be easier than implementing a custom model. It is recommended to check the [supported GenAI flavors](/llms#native-mlflow-flavors-for-llms)
...
`mlflow.models.set_model`, passing an instance of our `BasicAgent`, to indicate which model object to use for
...
how the `model_config` parameter is utilized, [see the guide on model_config usage](/models#python-function-model-interfaces).
:::
...
with mlflow.start_run():
    model_info = mlflow.pyfunc.log_model(
        "model",
        # If needed, update `python_model` to the Python file containing your agent definition
