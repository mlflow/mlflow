...
## <span style={{color: "red"}}>TODO - fix above LINKs</span>
...
1. LLM judges assess specific quality aspects (such as correctness and groundedness) for each row. For details, see TODO LINK.
1. :re[agent-evaluation] combines individual judge’s assessments into an overall pass/fail score and root cause for any failures. For details, see TODO LINK.

For LLM judge trust and safety information, see LINK..
...
For details about the LLM judges used, see [here](/llms/evaluate-monitor/quality/built-in-judges/).
