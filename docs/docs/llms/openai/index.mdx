...
how to log your development usage of the OpenAI SDK, please visit the [guide to autologging tracing](/tracing#automatic-tracing) for this flavor.
...
<CardGroup>
  <PageCard headerText="MLflow OpenAI Tutorials and Guides" link="/llms/openai/notebooks/" text="Learn different ways that you can leverage the power of the OpenAI library, leveraging MLflow's APIs for tracking, inference, and tracing capabilities." />
</CardGroup>
