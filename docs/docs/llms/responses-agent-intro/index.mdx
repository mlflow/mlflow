...
Below are some helper methods you can use to create common output item types.
- <APILink fn="mlflow.pyfunc.ResponsesAgent.create_text_delta" />
    ...
    def predict(self, request: ResponsesAgentRequest) -> ResponsesAgentResponse:
        return ResponsesAgentResponse(
            output=[
                ...
                self.create_function_call_output_item(call_id="call_1", output="12\n"),
                self.create_text_output_item(text="The result of 4 * 3 in Python is 12.", id="msg_1"),
            ]
        )
```
