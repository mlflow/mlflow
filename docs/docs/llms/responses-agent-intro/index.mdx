...
```python
def create_text_output_item(text: str, id: str):
    return {
        "id": id,
        "content": [
            {
...
def create_function_call_item(id: str, call_id: str, name: str, arguments: str):
    return {
        "type": "function_call",
        "id": id,
        "call_id": call_id,
...
def create_function_call_output_item(call_id: str, output: str):
    return {
