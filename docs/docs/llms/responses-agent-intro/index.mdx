    ...
    def predict_stream(
        ...
        for event in self.client.responses.create(
            ...
            if (
                ...
                or event.type == "response.output_text.delta"
            ):
