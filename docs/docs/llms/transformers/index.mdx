...
<CardGroup>
  <PageCard
    ...
    link="tutorials/text-generation/text-generation/"
    text={
      <>
...
<CardGroup>
  <PageCard
    ...
    link="tutorials/fine-tuning/transformers-fine-tuning/"
    text={
      <>
  ...
  <PageCard
    ...
    link="tutorials/fine-tuning/transformers-peft/"
    text={
      <>
...
<CardGroup>
  <PageCard
    ...
    link="tutorials/audio-transcription/whisper/"
    text={
      <>
  ...
  <PageCard
    ...
    link="tutorials/translation/component-translation/"
    text={
      <>
  ...
  <PageCard
    ...
    link="tutorials/conversational/conversational-model/"
    text={
      <>
  ...
  <PageCard
    ...
    link="tutorials/conversational/pyfunc-chat-model/"
    text={
      <>
  ...
  <PageCard
    ...
    link="tutorials/prompt-templating/prompt-templating/"
    text={
      <>
...
- [Overriding Pytorch dtype](/llms/transformers/guide#scalability-for-inference) : Gain insights into optimizing `transformers` models for inference, focusing on memory optimization and data type configurations.
