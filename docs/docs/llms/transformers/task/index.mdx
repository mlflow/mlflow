...
[Model Signature](/model#model-signatures-and-input-examples), and provides a consistent <Link to="/api_reference/python_api/mlflow.pyfunc.html#inference-api" target="_blank">Pyfunc Inference API</Link>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>[Chat API spec](/llms/deployments#chat)</td>
    ...
    <tr>
      ...
      <td>`text-generation`</td>
      <td>[Completions API spec](/llms/deployments#completions)</td>
    ...
    <tr>
      ...
      <td>[Embeddings API spec](/llms/deployments#embeddings)</td>
...
[notebook tutorial](/llms/transformers/tutorials/conversational/pyfunc-chat-model/) to see more examples in action!
...
Please refer to the [documentation](/llms/transformers/large-models#transformers-save-pretrained-guide) for more details.
:::
