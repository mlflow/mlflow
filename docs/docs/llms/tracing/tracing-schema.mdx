---
sidebar_position: 5
sidebar_label: Trace Data Model
...
# <span style={{color: "red"}}>TODO: add in assessment</span>
# <span style={{color: "red"}}>TODO: add in details about chat messages & tools that we extract</span>
...
To learn more about how `TraceInfo` metadata is used for searching, you can see examples [here](/tracing/api/search/#example-usage-of-search-traces).
