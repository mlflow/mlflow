...
- [Tracing Concepts](/contribute/overview) - Understand what tracing is and the specific benefits for MLflow users.
- [Tracing Schema Guide](/contribute/tracing-schema) - Details on trace data structure and the information stored.
- [MLflow Tracing API Guide](/llms/tracing) - Practical guide to auto-instrumentation and APIs for manually creating traces.
...
<div class="quiz">
    <details>
        ...
        <em>Reference:</em> [Tracing Schema Guide](/contribute/tracing-shema)</p>
    </details>
    ...
    <details>
        ...
        <p>A. Use the `@mlflow.trace` decorator to capture inputs, outputs, and execution duration automatically.\
          <em>Reference:</em> [MLflow Tracing API Guide](/contribute#trace-decorator)</p>
    </details>
    ...
    <details>
        ...
        <em>Reference:</em> [MLflow Tracing API Guide](/contribute#tracing-client-apis)</p>
    </details>
    ...
    <details>
        ...
        <em>Reference:</em> [Tracing Schema Guide](/llms/tracing/tracing-schema)</p>
    </details>
    ...
    <details>
        ...
        <em>Reference:</em> [MLflow Tracing API Guide](/contribute#error-handling-with-traces)</p>
...
- **Standardization**: Ensure consistency with other MLflow integrations for usability and downstream tasks. For example, retrieval spans should follow the [Retriever Schema](/contribute/tracing-schema.html#retriever-schema) for UI compatibility.
...
1. Add the integrated library icon and example in the [main Tracing documentation](/llms/tracing).
2. If the library is already present in an existing MLflow model flavor, add a Tracing section in the flavor documentation ([example page](/llms/llama-index/index.html#enable-tracing)).
