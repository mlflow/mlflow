...
<img
  alt="MLflow Tracing"
  src="/images/intro/tracing-ui.gif"
  style={{ display: "block", margin: "auto", width: "80%" }}
/>
<br />

A good companion to the explanations in this guide is the [Tracing Schema](../tracing-schema/) guide which will show how MLflow Tracing constructs the
...
<img
  ...
  src="/images/llms/tracing/tracing-traditional-ml.png"
...
<img
  alt="Span Structure"
  src="/images/llms/tracing/span-anatomy.png"
...
<img
  ...
  src="/images/llms/tracing/trace-concept.png"
  style={{ display: "block", margin: "auto", width: "60%" }}
/>
...
<img
  ...
  src="/images/llms/tracing/chat-completions-architecture.png"
  style={{ display: "block", margin: "auto", width: "60%" }}
/>
...
<img
  ...
  src="/images/llms/tracing/rag-architecture.png"
  style={{ display: "block", margin: "auto", width: "60%" }}
/>
...
To learn how to utilize tracing in MLflow, see the [MLflow Tracing Guide](../introduction/).
