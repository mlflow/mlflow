...
:::warning
    ...
    The `prompts` parameter for associating prompts with models is only supported for GenAI flavors such as OpenAI, LangChain, LlamaIndex, DSPy, etc. Please refer to the GenAI flavors TODO LINK for the full list of supported flavors.
...
If you haven't already created a prompt, follow [this step](/llms/prompts#1-create-a-prompt) to create a new prompt.
