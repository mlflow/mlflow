...
development experience and an easier approach to deployment. To learn more, see [the guide to building GenAI applications with ChatModel](/llms/chat-model-guide).
:::
