...
If you'd like to assess your model's performance on specific metrics, MLflow provides the <APILink fn="mlflow.evaluate" />
...
The <APILink fn="mlflow.evaluate" /> API also supports [custom metrics](/llms/llm-evaluate#llm-eval-custom-metrics),
