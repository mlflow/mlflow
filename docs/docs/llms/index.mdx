...
<details>
  ...
  {/* TODO: make the mlflow.genai.evaluate link functional */}
  - **Simplified Evaluation**: Leverage MLflow's <APILink fn="mlflow.genai.evaluate" /> API and built-in harnesses to test your GenAI models with ease.
