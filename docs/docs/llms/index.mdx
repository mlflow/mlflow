...
<details>
  ...
  - **Model Signature**: MLflow's [model signature](/model#model-signature) feature allows you to define the input, optional parameters, and output schema of your model and additional parameters, making it easier to understand how to interface with the model and share it with others.
