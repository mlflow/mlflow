...
- **🤝 15+ GenAI Framework Support** - MLflow integrates with more than a dozen of GenAI libraries, including OpenAI, LangChain, LlamaIndex, DSPy, and more. This allows flexibility in choosing the right tool for your use case.
...
Experiment Tracking is a core fundamental of MLflow platform, allowing you to organize many assets and artifacts during your LLM/GenAI projects, such as models, prompts, traces, metrics, in a single place. [➡︎ Learn more](/tracking)
...
<details>
  ...
  - **Lineage Tracking**: MLflow captures the lineage of your LLM assets throughout the different stages of the project , allowing you to trace back to the source of your models, prompts, and other artifacts.
...
MLflow Tracing ensures LLM observability in your GenAI applications by capturing LLM calls and other important details, including retrieval, tool calls, allowing you to monitor and get deep insights into your applications. [➡︎ Learn more](/llms/tracing)
...
MLflow's model packaging empowers you to manage moving pieces of GenAI systems, including prompts, LLM parameters, fine-tuned weights, with frozen dependency versions. This allows you to manage experiment with high **reproduceability**.
...
<details>
  ...
  - **Unified prediction APIs**: MLflow models can be loaded as a convenient `PyFunc` wrapper that exposes a consistent `predict()` API, regardless of the underlying library. This simplified the process of evaluation and deployment of LLMs.

  - **Model Signature**: MLflow's [model signature](/models#model-signature) feature allows you to define the input and output schema of your model and additional parameters, making it easier to understand the model and share it with others.
...
<CardGroup isSmall>
  ...
  <SmallLogoCard link="/models#promptflow-promptflow-experimental">
