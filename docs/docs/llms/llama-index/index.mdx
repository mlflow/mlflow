...
<CardGroup>
  <PageCard
    ...
    link="/llms/llama-index/notebooks/llama_index_workflow_tutorial.html"
  ...
  <PageCard
    ...
    link="/llms/llama-index/notebooks/llama_index_quickstart.html"
...
Mlflow supports logging and loading a LlamaIndex Workflow via the [Model-from-Code](/models#models-from-code) feature. For a detailed example of logging and loading a LlamaIndex Workflow, see the [LlamaIndex Workflows with MLflow](/llms/llama-index/notebooks/llama_index_workflow_tutorial.html) notebook.
