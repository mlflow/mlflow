...
3. Create the UC function used in [the example script](https://github.com/mlflow/mlflow/blob/master/examples/deployments/uc_functions/run.py) in your Databricks workspace by running the following SQL command:
