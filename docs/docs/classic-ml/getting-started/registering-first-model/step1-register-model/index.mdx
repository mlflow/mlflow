...
[remote tracking server](https://mlflow.org/docs/latest/tracking/tutorials/remote-server.html).
...
can leverage any [supported model flavor](/model#models_built-in-model-flavors).
...
The next part of this tutorial centers on [Understanding Registered Models](/ml/getting-started/registering-first-model/step2-explore-registered-model) within the MLflow UI.