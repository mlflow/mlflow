...
Now that we have a very high-level understanding of what is logged, let's use the MLflow UI to
...
[facilitate model deployment](/ml/model-registry/#new-model-deployment-tools).
...
The next part of this tutorial centers on [Loading Models from the Registry](/ml/getting-started/registering-first-model/step3-load-model) within the MLflow UI.