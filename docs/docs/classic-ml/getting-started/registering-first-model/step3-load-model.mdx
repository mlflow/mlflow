...
_client.set_registered_model_alias_ with the same model name, alias name, and a **new** model version
ID. It's that easy!
...
Congratulations on finishing the in-depth tutorial for the MLflow Model Registry! You can now [return to the Getting Started](/ml/getting-started) content to learn more about MLflow.
