...
You can now [continue to the next section](/ml/getting-started/logging-first-model/step5-synthetic-data) of the tutorial, or [return to the tutorial listing](/ml/getting-started/logging-first-model).
