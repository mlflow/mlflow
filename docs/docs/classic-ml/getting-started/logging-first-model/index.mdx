...
To get started with the tutorial, select the first link below or navigate to the section that you're interested in:

- [Starting an MLflow Tracking Server](/ml/getting-started/logging-first-model/step1-tracking-server)
- [Using the MLflow Client API](/ml/getting-started/logging-first-model/step2-mlflow-client)
- [Creating Experiments](/ml/getting-started/logging-first-model/step3-create-experiment)
- [Searching Experiments](/ml/getting-started/logging-first-model/step4-experiment-search)
- [Create a dataset about apples](/ml/getting-started/logging-first-model/step5-synthetic-data)
- [Logging our first runs with MLflow](/ml/getting-started/logging-first-model/step6-logging-a-run)
- [Logging Your First MLflow Model Notebook](/ml/getting-started/logging-first-model/notebooks)
...
<NotebookDownloadButton href="https://raw.githubusercontent.com/mlflow/mlflow/master/docs/docs/getting-started/logging-first-model/notebooks/logging-first-model.ipynb">Download the Notebook</NotebookDownloadButton>
