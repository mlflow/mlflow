...
**MLflow Tracking Server** is a centralized HTTP server that allows you to access your experiments artifacts regardless of where you run your code. To use the Tracking Server, you can either run it locally or use a managed service. Refer to the [Self Hosting Guide](/self-hosting) for the instructions.
