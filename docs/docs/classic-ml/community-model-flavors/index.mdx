---
title: Community ML Model Flavors
description: Discover community-built MLflow model flavors for additional ML framework integrations.
---
...
uv pip install 'mlflow[sktime]'
uv pip install mlflavors

# Visualization and plotting

uv pip install mlflow-vizmod

# Big data and cloud platforms

uv pip install bigmlflow
uv pip install 'mlflow[aliyun-oss]'
...
<TabItem value="uv" label="uv" default>
```bash
uv pip install mlflow-go-backend
```
</TabItem>
<TabItem value="pip" label="pip">
```bash
