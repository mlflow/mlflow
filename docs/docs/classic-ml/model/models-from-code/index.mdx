...
mlflow.pyfunc.log_model(python_model=model_instance, artifact_path="model")
```
...
# Log script path
mlflow.pyfunc.log_model(python_model="my_model.py", artifact_path="model")
```
