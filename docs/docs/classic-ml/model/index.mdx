...
When opening the MLflow models page the serialized model artifact will show up, such as:
...
```bash
mlflow models serve -m models:/<model_id> --env-manager local --host 127.0.0.1
```
