...
The full guide, including tutorials and detailed documentation for using the `transformers` flavor is available in the [GenAI Docs](/genai).
...
provided in the [Community Model Flavors](/ml/plugins) page.
...
Go to the [Community Model Flavors](/ml/plugins)
