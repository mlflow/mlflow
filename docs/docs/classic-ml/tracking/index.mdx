...
description: Log parameters, metrics, and artifacts for ML experiments. Compare runs, visualize results, and reproduce models.
---
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Tracking Experiments using a Local Database</td>
      <td>Remote Experiment Tracking with MLflow Tracking Server</td>
    </tr>
  </tbody>
</Table>
...
the materials below for advanced configurations to meet your needs.
