...
[MLflow Tracking](/ml/tracking) provides Python, R, Java, or REST API to log your experiment data and models.

## [Auto Logging](/ml/tracking/autolog)

[Auto logging](/ml/tracking/autolog) is a powerful feature that allows you to log metrics, parameters, and models without the need for explicit log statements
...
See [Automatic Logging with MLflow Tracking](/ml/tracking/autolog) documentation for supported libraries and how to use autolog APIs with each of them.
...
Runs in Tracking UI by using [filter expression](/ml/search-runs#mlflow_tags).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Name of the branch of the executed code, if in a git repository. This tag is only logged within the context of [MLflow Projects](/ml/projects).</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>URL that the executed code was cloned from. This tag is only logged within the context of [MLflow Projects](/ml/projects).</td>
    </tr>
    <tr>
