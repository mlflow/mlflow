...
import { Package, TrendingUp, GitBranch } from "lucide-react";

# Prophet with MLflow

This guide covers MLflow's integration with Prophet for time series forecasting, including model logging, cross-validation tracking, and deployment.
