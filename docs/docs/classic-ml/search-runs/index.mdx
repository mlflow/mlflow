...
:::tip
Looking for how to search over logged models? See the [Search Logged Models](/ml/search-models) documentation.
:::
...
or `mlflow.set_tags`. In addition, [system tags](/tracking/tracking-api/#system_tags),
