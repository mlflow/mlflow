...
webhook = client.create_webhook(
    ...
    events=[WebhookEvent.from_str("model_version.created")],
...
webhook = client.create_webhook(
    ...
    events=[
        WebhookEvent.from_str("registered_model.created"),
        WebhookEvent.from_str("model_version.created"),
        WebhookEvent.from_str("model_version_tag.set"),
    ],
...
result = client.test_webhook(
    webhook.webhook_id,
    event=WebhookEvent.from_str("model_version_tag.set"),
)
```
