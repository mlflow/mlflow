...
```bash
# Clone MLflow and ensure MLflow is installed
git clone https://github.com/mlflow/mlflow
cd mlflow

# Install MLflow first (required dependency)
pip install -e .
...
The test plugin intentionally omits MLflow from its dependency list to avoid overwriting editable MLflow installations during development. Always ensure MLflow is installed in your environment before installing any MLflow plugins.
:::
