...
```bash
uv pip install 'mlflow[sqlserver]'
```
</TabItem>
...
<TabItem value="uv" label="uv" default>
```bash
uv pip install mlflow-elasticsearchstore
```
</TabItem>
<TabItem value="pip" label="pip">
```bash
