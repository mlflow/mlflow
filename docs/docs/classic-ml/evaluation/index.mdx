---
title: ML Model Evaluation | MLflow AI Platform
description: Evaluate and compare ML models with built-in metrics for classification, regression, and custom evaluation functions.
---
