  ...
  features={[
    {
      ...
      description: "Evaluate models, Python functions, or static datasets with mlflow.evaluate() using a consistent interface across different evaluation modes.",
    },
    {
      icon: BarChart,
...
- <APILink fn="mlflow.evaluate" /> - Main evaluation API
