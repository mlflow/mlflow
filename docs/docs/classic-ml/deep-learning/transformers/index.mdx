...
Prompt templating is supported for specific pipeline types. See the [guide](/ml/deep-learning/transformers/guide#saving-prompt-templates-with-transformer-pipelines) for details.
