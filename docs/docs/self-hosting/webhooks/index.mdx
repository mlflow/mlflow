...
MLflow webhooks support the following Model Registry, Prompt Registry, and AI Gateway events:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>budget_policy.exceeded</code></td>
      <td>Triggered when a budget policy limit is exceeded</td>
      <td><APILink fn="mlflow.webhooks.BudgetPolicyExceededPayload" >`BudgetPolicyExceededPayload`</APILink></td>
    </tr>
  </tbody>
</table>
...
1. **Set up MLflow server with webhook encryption:**
