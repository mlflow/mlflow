...
MLflow supports SSO (Single Sign-On) with custom plugins for authentication. The [mlflow-oidc-auth](https://github.com/mlflow/mlflow-oidc-auth) plugin provides OIDC support for MLflow.
