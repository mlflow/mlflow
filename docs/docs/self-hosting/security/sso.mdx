...
Use the following commands to deploy the MLflow server with the OIDC plugin in the local machine, note that we need to set a couple of environment variables correctly.
