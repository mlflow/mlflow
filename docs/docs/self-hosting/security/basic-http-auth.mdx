...
- <Link to="https://mlflow.org/docs/latest/api_reference/auth/rest-api.html" target="_blank"><span>MLflow Authentication REST API</span></Link>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <Link to="https://mlflow.org/docs/latest/api_reference/auth/rest-api.html#create-user" target="_blank">
    ...
    <tr>
      <td>
        <Link to="https://mlflow.org/docs/latest/api_reference/auth/rest-api.html#get-user" target="_blank">
          <span>Get User</span>
        </Link>
      </td>
    ...
    <tr>
      <td>
        <Link to="https://mlflow.org/docs/latest/api_reference/auth/rest-api.html#update-user-password" target="_blank">
    ...
    <tr>
      <td>
        <Link to="https://mlflow.org/docs/latest/api_reference/auth/rest-api.html#update-user-admin" target="_blank">
    ...
    <tr>
      <td>
        <Link to="https://mlflow.org/docs/latest/api_reference/auth/rest-api.html#delete-user" target="_blank">
    ...
    <tr>
      <td>
        <Link to="https://mlflow.org/docs/latest/api_reference/auth/rest-api.html#grant-user-permission" target="_blank">
    ...
    <tr>
      <td>
        <Link to="https://mlflow.org/docs/latest/api_reference/auth/rest-api.html#revoke-user-permission" target="_blank">
    ...
    <tr>
      <td>
        <Link to="https://mlflow.org/docs/latest/api_reference/auth/rest-api.html#check-user-permission" target="_blank">
...
MLflow provides <Link to="https://mlflow.org/docs/latest/api_reference/auth/rest-api.html#create-user" target="_blank">REST APIs</Link>
