...
Supported resources include `Experiment`, `Registered Model`, `Registered Prompt`, and `Scorer`.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <Link to="/api_reference/auth/rest-api.html#create-prompt-permission" target="_blank">
          <span>Create Prompt Permission</span>
        </Link>
      </td>
      <td>`2.0/mlflow/registered-models/permissions/create`</td>
      <td>`POST`</td>
    ...
    <tr>
      <td>
        <Link to="/api_reference/auth/rest-api.html#get-prompt-permission" target="_blank">
          <span>Get Prompt Permission</span>
        </Link>
      </td>
      <td>`2.0/mlflow/registered-models/permissions/get`</td>
      <td>`GET`</td>
    ...
    <tr>
      <td>
        <Link to="/api_reference/auth/rest-api.html#update-prompt-permission" target="_blank">
          <span>Update Prompt Permission</span>
        </Link>
      </td>
      <td>`2.0/mlflow/registered-models/permissions/update`</td>
      <td>`PATCH`</td>
    ...
    <tr>
      <td>
        <Link to="/api_reference/auth/rest-api.html#delete-prompt-permission" target="_blank">
          <span>Delete Prompt Permission</span>
        </Link>
      </td>
      <td>`2.0/mlflow/registered-models/permissions/delete`</td>
      <td>`DELETE`</td>
...
#### Granting Prompt Permissions

You can grant permissions on a registered prompt using
<APILink fn="mlflow.server.auth.client.AuthServiceClient.create_prompt_permission" />.
...
auth_client = get_app_client("basic-auth", tracking_uri=tracking_uri)
auth_client.create_user(username="user2", password="pw2")
auth_client.create_prompt_permission(
    prompt_name="my-prompt", username="user2", permission="READ"
)
```
