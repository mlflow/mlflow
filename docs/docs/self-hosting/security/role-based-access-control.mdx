...
Editing a run in experiment 42, to show how the two combine. The first five rows
hold in any configuration, because an explicit grant on the experiment settles the
container check:
