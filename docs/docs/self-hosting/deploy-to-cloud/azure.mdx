...
- Image and tag: `ghcr.io/mlflow/mlflow:<version>-full` (The version is value like `v3.10.0`, you can find available MLflow images in this [page](https://github.com/mlflow/mlflow/pkgs/container/mlflow))
