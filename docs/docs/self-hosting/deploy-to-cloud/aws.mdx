...
- Set the "Image URI" to a certain version MLflow image, e.g. `ghcr.io/mlflow/mlflow:3.10.0`. You can find available MLflow images in this ![page](https://github.com/mlflow/mlflow/pkgs/container/mlflow).
