...
you are required to use the legacy serialization methods outlined in the [Custom Python Model](/model#custom-python-models) documentation.
:::
...
<Tabs>
  ...
  <TabItem label="Models From Code with LangChain" value="models-from-code-with-langchain">
    ...
    This script utilizes the LangChain library along with MLflow's `autolog` feature for enabling the [capture of traces](/tracing).
...
- [Model API Documentation](/model#model-api)
