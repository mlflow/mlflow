...
<Tabs>
  <TabItem value="generation" label="Generation" default>
    **During Application Execution**: Traces are created as your LLM application or AI agent processes requests
...
**[LLM Evaluation Guide](/genai/eval-monitor)**: Learn how to evaluate your LLM applications and AI agents
...
_Feedback concepts form the foundation for systematic quality assessment in MLflow. By understanding how feedback objects work and integrate with traces, you can build comprehensive evaluation strategies that improve your LLM applications and AI agents over time._
