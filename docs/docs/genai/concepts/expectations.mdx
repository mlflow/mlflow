...
<FeatureHighlights features={[
  {
    ...
    description: "Establish clear, measurable standards for what your LLM application or AI agent should produce. For example, define expected answers for factual questions or desired formats for structured outputs."
  },
  {
    icon: Users,
...
<TilesGrid>
  <TileCard
    ...
    description="Learn how to annotate ground truth expectations for your LLM applications and AI agents"
