...
![Span links shown in the trace explorer Links tab](/images/llms/tracing/span-links-tab.png)

For detailed usage patterns and examples, see [Manual Tracing — Span Links](/genai/tracing/app-instrumentation/manual-tracing#span-links).
