...
:::note
For new deployments, we recommend using the [Gateway Quickstart](/genai/governance/ai-gateway/quickstart) which provides a modern web interface for managing endpoints, API keys, and routing configurations with zero-downtime updates.
:::
