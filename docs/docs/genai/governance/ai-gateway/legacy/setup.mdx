---
title: AI Gateway Server Setup
description: Step-by-step guide to install and configure the legacy MLflow AI Gateway Server, set up YAML-based provider configs, and start serving LLM endpoints.
---
...
import { Settings, Play, ArrowUpRight } from "lucide-react";
...
<TilesGrid>
  ...
  <TileCard
    icon={ArrowUpRight}
    title="Main AI Gateway"
    description="Explore the modern AI Gateway with enhanced features and UI management"
    href="/genai/governance/ai-gateway/"
    linkText="View AI Gateway →"
  />
</TilesGrid>
