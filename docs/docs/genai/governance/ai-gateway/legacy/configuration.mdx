---
title: AI Gateway Server Configuration
description: Configure providers, endpoints, and advanced settings for the legacy MLflow AI Gateway Server using YAML-based configuration for OpenAI, Anthropic, and other LLM providers.
---
...
<TilesGrid>
  <TileCard
    ...
    href="/genai/governance/ai-gateway/legacy/usage"
