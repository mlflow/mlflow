...
Navigate to the Endpoints tab and click Create Endpoint to begin configuring a new endpoint. Start by choosing a unique name for your endpoint, such as `my-endpoint`. This name becomes part of the API path you'll use to call the endpoint.
