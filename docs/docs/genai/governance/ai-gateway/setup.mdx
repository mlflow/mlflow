...
<details>
<summary>How to rotate the encryption passphrase (KEK)</summary>
...
<details>
<summary>How to rotate provider API keys</summary>
...
Endpoints define how requests are routed to AI models. For advanced routing features like traffic splitting and fallbacks, see the [Advanced Routing](/genai/governance/ai-gateway/routing) guide.
