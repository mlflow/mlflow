...
| **Passthrough** | TypeSafe | `POST /gateway/typesafe/v1/systemone` | Structured evaluation with Jev models. |
...
TypeSafe evaluation endpoints display System One examples and a structured request test panel. See [TypeSafe passthrough](/genai/governance/ai-gateway/endpoints/model-providers#typesafe) for usage. These endpoints support System One rather than chat completions or embeddings.
