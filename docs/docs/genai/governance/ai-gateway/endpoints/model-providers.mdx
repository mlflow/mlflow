...
[Portkey](https://portkey.ai) is a unified LLM gateway that lets you route requests to any LLM provider through a single OpenAI-compatible API. Use it to switch models, add fallbacks, and manage costs without changing your application code.
...
4. Enter the model name as recognised by Portkey (e.g. `openai/gpt-4o`, `anthropic/claude-3-5-sonnet`)
