...
See [OpenAI Embeddings API Reference](https://platform.openai.com/docs/api-reference/embeddings) for complete documentation.
...
response = client.embeddings.create(
    model="my-endpoint", input="The food was delicious and the waiter..."
)
