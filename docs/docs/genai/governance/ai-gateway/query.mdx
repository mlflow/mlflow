...
The request body follows the OpenAI chat completions format with these supported parameters:
...
The OpenAI passthrough API exposes the full OpenAI API including Chat Completions, Embeddings, and Responses (Realtime) endpoints. See [OpenAI API Reference](https://platform.openai.com/docs/api-reference) for complete documentation.
...
The Responses API provides a WebSocket-based interface for real-time bidirectional communication with speech-to-speech models.
...
# Use the realtime.sessions.create() method for WebSocket connections
# See OpenAI Realtime API documentation for full examples
```

</TabItem>
</Tabs>

For detailed Realtime API usage, see [OpenAI Realtime API Guide](https://platform.openai.com/docs/guides/realtime).
