...
<Link className="button button--primary" to="/genai/governance/ai-gateway/guides">
...
- **gemini**: This is used for models offered by [Gemini](https://ai.google.dev/api/models#rest-resource:-models).
