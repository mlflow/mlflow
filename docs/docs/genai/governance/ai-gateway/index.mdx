...
**2. Start the MLflow server with a SQL backend:**
...
Navigate to `http://localhost:5000/#/gateway` and create your first endpoint `my-chat-endpoint` through the web interface. Select your provider, model, and configure your API key.
