---
title: Traffic Routing & Fallbacks
description: Configure traffic splitting for A/B testing and automatic fallback chains for high availability in MLflow AI Gateway. Distribute LLM requests across multiple providers by weight.
---
