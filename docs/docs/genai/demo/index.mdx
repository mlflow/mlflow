...
Using `uvx` runs MLflow directly without installing it globally. If you prefer, you can also use `pip install mlflow` followed by `mlflow demo`.
:::
...
- [**Set Up Your Environment**](/genai/getting-started/connect-environment) - Configure MLflow for your own projects
- [**Start Tracing**](/genai/tracing/quickstart) - Add observability to your GenAI app
- [**Run Evaluations**](/genai/eval-monitor/quickstart) - Systematically test your application
- [**Manage Prompts**](/genai/prompt-registry/create-and-edit-prompts) - Version and iterate on prompts
