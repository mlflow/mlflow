...
- **Downgrading Models**: Moving from `gpt-4o` → `gpt-4o-mini` to reduce costs
...
# Define your prediction function using the source model (gpt-4o)
@mlflow.trace
...
result = mlflow.genai.optimize_prompts(
    ...
    scorers=[OutputEquivalence(model="openai:/gpt-4o")],
)
...
inputs = [
    ...
    {"inputs": {"text": "It meets the basic requirements. Nothing more, nothing less."}},
