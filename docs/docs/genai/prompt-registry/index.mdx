...
description: Version, track, and reuse prompts across your organization with MLflow Prompt Registry. Maintain consistency and streamline prompt engineering.
---
...
**MLflow Prompt Registry** is a powerful tool that streamlines [prompt engineering](https://mlflow.org/prompt-optimization) and management in your LLM applications and AI agents. It enables you to version, track, and reuse prompts across your organization, helping maintain consistency and improving collaboration in prompt development.
...
<FeatureHighlights features={[
  ...
  },
  {
    icon: LineChart,
    title: "Lineage",
    description: "Seamlessly integrated with MLflow's Tracing, Evaluation, and Monitoring capabilities for agent observability and quality improvement."
  },
  {
    icon: Users,
    title: "Collaboration",
...
To use a prompt in your LLM application or AI agent, you can load it with the <APILink fn="mlflow.genai.load_prompt"/> API and fill in the variables using the <APILink fn="mlflow.entities.Prompt.format"/> method of the prompt object.
...
target_text = """
MLflow is the largest open source AI engineering platform. It enables teams of all sizes
to debug, evaluate, monitor, and optimize production-quality agents and LLM applications,
