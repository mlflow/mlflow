...
<Tabs>
  ...
  <TabItem value="agent" label="Coding agent">
    <div class="flex-column">
      Prefer to let a coding agent do it? Paste this prompt into your coding agent of choice and it will create and test your first prompt for you.

      ```text
      Help me create and test my first MLflow registered prompt. Take it one step at a time:
