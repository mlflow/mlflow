...
- [Optimizing Prompts for LangChain](/genai/prompt-registry/optimize-prompts/langchain-optimization): Learn how to optimize LangChain chains with minimal code changes
- [Optimizing Prompts for LangGraph](/genai/prompt-registry/optimize-prompts/langgraph-optimization): Learn how to optimize LangGraph agents
- [Optimizing Prompts for OpenAI Agents](/genai/prompt-registry/optimize-prompts/openai-agent-optimization): Learn how to optimize OpenAI Agent prompts
- [Optimizing Prompts for Pydantic AI](/genai/prompt-registry/optimize-prompts/pydantic-ai-optimization): Learn how to optimize Pydantic AI agents
