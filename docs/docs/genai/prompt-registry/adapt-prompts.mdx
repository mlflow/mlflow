---
sidebar_position: 6
sidebar_label: Adapt Prompts 🆕
---

import { APILink } from "@site/src/components/APILink";

# Adapt Prompts (Experimental)
...
- **No Ground Truth Requirement**: No human lebeling is required if you optimize prompts based on the existing outputs
