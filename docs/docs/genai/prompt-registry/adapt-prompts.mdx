...
dataset = [
    ...
    {"inputs": {"question": "What is the capital of Netherlands?"}, "outputs": "Amsterdam"},
...
void additional context, complete sentences, or extraneous information in your response. 
