...
```bash
uv pip install openai-agents mlflow gepa nest_asyncio
```
</TabItem>
...
predict_fn(
    context="MLflow is the largest open source AI engineering platform for agents and LLMs, providing tools to build production-quality AI applications",
