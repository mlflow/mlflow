...
![UI for Prompt-trace linkage](/images/llms/prompt-registry/prompt-trace-linking)

### Prompt-run linking UI
![Prompt-run linking in run overview](/images/llms/prompt-registry/prompt-run-linking)