...
### Prompt-trace linking UI

![UI for Prompt-trace linkage](/images/llms/prompt-registry/prompt-trace-linking.png)

### Prompt-run linking UI

![Prompt-run linking in run overview](/images/llms/prompt-registry/prompt-run-linking.png)
