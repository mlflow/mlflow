...
<Tabs>
  <TabItem default label="VS Code" value="vscode">

Add to your VS Code `.vscode/mcp.json` or MCP configuration:
...
- **Databricks**: Use your Databricks workspace URL and set appropriate authentication
