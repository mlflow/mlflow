...
|-------|-------------|----------------|
| `genai` (default) | GenAI-focused tools for tracing and evaluation | `traces`, `scorers` |
| `ml` | Traditional ML workflow tools | `experiments`, `runs`, `artifacts`, `models`, `deployments` |
