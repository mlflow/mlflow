...
### Inspecting Prompts Linked to Models

Once models are logged with prompt dependencies, you can typically inspect these relationships through the MLflow UI (on the model version page) or query them via the MLflow API.
