...
If you haven't already created a prompt, follow [the instructions in this page](/genai/prompt-version-mgmt/prompt-registry/create-and-edit-prompts) to create a new prompt.
