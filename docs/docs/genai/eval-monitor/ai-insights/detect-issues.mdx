...
Analysis is limited to trace data. It does not read source code, configuration files, or prompt templates stored outside MLflow. Recommendations describe patterns in traces and suggest instrumentation or evaluation changes.
