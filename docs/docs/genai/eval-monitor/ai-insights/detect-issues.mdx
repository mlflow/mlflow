...
**On April 16, 2026**, we ran an internal benchmark sweep of issue detection across several chat models. The numbers below are **indicative only**—your wall time, tokens, and dollar cost will differ with trace length, category selection, provider pricing, and product changes.
...
| Traces | Typical time | Typical cost | Issues found |
| ------ | ------------ | ------------ | ------------ |
| 50     | 63–158s      | $0.08–$0.42  | 5–9          |
| 100    | 97–296s      | $0.11–$0.53  | 8–13         |
| 250    | 129–583s     | $0.16–$0.93  | 10–22        |

**Full model breakdown:**

| Model             | Traces | Time (s) | Input tokens | Output tokens | Cost (USD) | Issues found |
| ----------------- | -----: | -------: | -----------: | ------------: | ---------: | -----------: |
| gpt-5.4           |     50 |     62.8 |       38,004 |         6,549 |       0.19 |            9 |
| o3                |     50 |     70.9 |       25,253 |        10,866 |       0.14 |            6 |
| claude-opus-4-6   |     50 |    111.8 |       44,219 |         7,935 |       0.42 |            6 |
| claude-sonnet-4-6 |     50 |     87.2 |       45,139 |         7,837 |       0.25 |            8 |
| gemini-3.1-pro    |     50 |    157.7 |       22,537 |         2,732 |       0.08 |            5 |
| gpt-5.4           |    100 |     97.2 |       59,085 |         9,976 |       0.30 |           13 |
| o3                |    100 |    128.4 |       51,508 |        25,789 |       0.31 |            8 |
| claude-opus-4-6   |    100 |    127.0 |       56,128 |         9,985 |       0.53 |            9 |
| claude-sonnet-4-6 |    100 |    132.6 |       80,965 |        15,062 |       0.47 |           11 |
| gemini-3.1-pro    |    100 |    296.3 |       32,128 |         3,949 |       0.11 |            8 |
| gpt-5.4           |    250 |    165.7 |      114,285 |        20,578 |       0.59 |           22 |
| o3                |    250 |    128.7 |       61,733 |        30,173 |       0.36 |           12 |
| claude-opus-4-6   |    250 |    168.5 |       94,152 |        18,174 |       0.93 |           10 |
| claude-sonnet-4-6 |    250 |    143.9 |       97,299 |        18,062 |       0.56 |           14 |
| gemini-3.1-pro    |    250 |    582.9 |       43,080 |         6,155 |       0.16 |           12 |
