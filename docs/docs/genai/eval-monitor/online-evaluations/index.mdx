...
1. Navigate to your experiment and select the **Judges** tab
   ...
   <img src={require('@site/static/images/genai/eval-monitor/judges-tab.png').default} alt="Judges tab" width="120" />

2. Click **+ New LLM judge**

   <img src={require('@site/static/images/genai/eval-monitor/new-llm-judge-button.png').default} alt="New LLM judge button" width="180" />
...
5. **Evaluation settings**:
   ...
   <img src={require('@site/static/images/genai/eval-monitor/evaluation-settings.png').default} alt="Evaluation settings" width="400" />
6. Click **Save**
