...
For API reference, see [`Scorer.start()`](/api_reference/python_api/mlflow.genai.html), [`Scorer.update()`](/api_reference/python_api/mlflow.genai.html), and [`Scorer.stop()`](/api_reference/python_api/mlflow.genai.html).
