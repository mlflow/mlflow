...
1. Navigate to your experiment and select the **Judges** tab
   <img src="/images/genai/eval-monitor/judges-tab.png" alt="Judges tab" style={{ width: '15%', display: 'block' }} />
2. Click **+ New LLM judge**
   <img src="/images/genai/eval-monitor/new-llm-judge-button.png" alt="New LLM judge button" style={{ width: '20%', display: 'block' }} />
3. **Select scope**:
...
5. **Evaluation settings**:
   ...
   <img src="/images/genai/eval-monitor/evaluation-settings.png" alt="Evaluation settings" style={{ width: '50%', display: 'block' }} />
6. Click **Save**
