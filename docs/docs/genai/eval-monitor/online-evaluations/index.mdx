...
1. Navigate to your experiment and select the **Judges** tab
   ...
   <img src={require('@site/static/images/genai/eval-monitor/judges-tab.png').default} alt="Judges tab" width="120" style={{ borderRadius: '8px', border: '1px solid #ddd', boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }} />
...
6. Click **Save**
7. To edit or disable an existing judge, click on it in the **Judges** tab and modify the settings.

   <img src={require('@site/static/images/genai/eval-monitor/edit-llm-judge-button.png').default} alt="Edit LLM judge button" width="180" style={{ borderRadius: '8px', border: '1px solid #ddd', boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }} />
