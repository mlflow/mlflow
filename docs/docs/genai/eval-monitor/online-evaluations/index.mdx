...
Assessments from online evaluation appear directly in the MLflow UI. Navigate to your experiment's **Traces** or **Sessions** tab to see assessment scores.
...
<ImageBox
  ...
  caption="Assessment scores from online evaluation appear as columns in the traces table"
  width="80%"
/>
