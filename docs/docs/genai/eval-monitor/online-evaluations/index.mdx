...
This example shows how to set up an LLM judge that automatically evaluates traces as they're logged, and how to update or disable existing judges. For more details on creating LLM judges, see [LLM-as-a-Judge](/genai/eval-monitor/scorers/llm-judge/).
