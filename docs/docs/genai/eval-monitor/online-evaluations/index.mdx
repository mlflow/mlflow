...
1. Navigate to your experiment and select the **Judges** tab
   <ImageBox src="/images/genai/eval-monitor/judges-tab.png" alt="Judges tab" width="15%" />
2. Click **+ New LLM judge**
   <ImageBox src="/images/genai/eval-monitor/new-llm-judge-button.png" alt="New LLM judge button" width="20%" />
3. **Select scope**:
...
5. **Evaluation settings**:
   ...
   <ImageBox src="/images/genai/eval-monitor/evaluation-settings.png" alt="Evaluation settings" width="50%" />
6. Click **Save**
