...
The new <APILink fn="mlflow.genai.judges.make_judge">make_judge</APILink> API (MLflow 3.4.0+) provides a more streamlined approach for creating custom judges with template-based instructions, version control, and improved data organization.
