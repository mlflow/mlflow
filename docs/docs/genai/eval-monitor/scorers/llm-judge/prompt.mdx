...
See the [make_judge documentation](/genai/eval-monitor/scorers/llm-judge/custom-judges) for migration guidance.
:::
...
MLflow supports all major LLM providers, such as OpenAI, Anthropic, Google, xAI, and more. See [Supported Models](/genai/eval-monitor/scorers/llm-judge/custom-judges/supported-models) for more details.
