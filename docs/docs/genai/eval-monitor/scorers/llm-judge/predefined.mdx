...
| <APILink fn="mlflow.genai.scorers.Completeness">Completeness</APILink> 🧪                  | Does the AI address all questions in a single user prompt?   | No                     | No                    |
...
### Multi-Turn Scorers 🧪 {#multi-turn-scorers}
...
| ----------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | ----------------- |
| <APILink fn="mlflow.genai.scorers.ConversationCompleteness">ConversationCompleteness</APILink> 🧪    | Does the AI address all user questions throughout the conversation?   | Yes               |
