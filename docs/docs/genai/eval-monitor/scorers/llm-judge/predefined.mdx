...
See [custom LLM judges](/genai/eval-monitor/scorers/llm-judge/guidelines) guide for detailed examples.
...
See [Supported Models](/genai/eval-monitor/scorers/llm-judge/custom-judges#supported-models) for more details.
