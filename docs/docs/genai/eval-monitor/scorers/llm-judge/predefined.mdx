...
Multi-turn judges evaluate entire conversation sessions rather than individual turns. They require traces with session IDs. See [Track Users and Sessions](/genai/tracing/track-users-sessions/)
