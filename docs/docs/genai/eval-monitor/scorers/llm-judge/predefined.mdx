...
| <APILink fn="mlflow.genai.scorers.ConversationalCoherence">ConversationalCoherence</APILink>\*\*                   | Does the conversation maintain logical flow and consistency?               | Yes               |
