...
Using legacy judge functions? Check out our [migration guide](/genai/eval-monitor/scorers/llm-judge/migration-guide) to learn how to upgrade to the new `make_judge` API for more flexibility and features.
