...
- **Best for**: Creating any type of custom judge with a unified, template-based interface. Perfect for teams who want flexibility without complexity.
- **How it works**: Write natural language templates with variable substitution. Register and version your judges for team collaboration. Supports all evaluation scenarios with clean separation of inputs, outputs, and expectations.
