...
- **Best for**: Creating custom judges with natural language instructions, supporting both field-based and agentic (Agent as a Judge) evaluation. Includes built-in versioning and human feedback alignment.
