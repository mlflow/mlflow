...
description: How agentic judges use tools to deeply analyze execution traces
---
...
Agentic judges use MCP (Model Context Protocol) tools to investigate traces. These tools enable the judge to act like an experienced debugger, systematically exploring your application's execution.
...
Here's how an agentic judge analyzes a complex multi-step workflow:
