...
#### TODO: Add visual of code-based vs llm vs agent

## How it works

Agent-as-a-Judge uses MCP (Model Context Protocol) tools to investigate traces logged to the MLflow backend. These tools enable the judge to act like an experienced debugger, systematically exploring your application's execution.
...
traces = mlflow.search_traces(
    filter_string="timestamp > 1727174400000"
)
...
### TODO: Add screenshot once this works example works
