...
description: Use agentic judges to evaluate complex agent behaviors and multi-step workflows
---
...
Agentic judges excel at evaluating complex agent behaviors that are impossible to assess from inputs and outputs alone. They can understand reasoning chains, tool selection strategies, and decision-making processes.
...
Integrate agentic judges into your evaluation workflow:
...
# Run evaluation with agentic judges
...
5. **Combine with Field-Based Evaluation**: Use both agentic and field-based judges for complete coverage
