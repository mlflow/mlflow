...
Custom judges are LLM-based judges that evaluate your LLM applications and AI agents against specific quality criteria. This tutorial shows you how to create custom judges and use them to evaluate a customer support agent using <APILink fn="mlflow.genai.judges.make_judge">`make_judge()`</APILink>.
...
<TilesGrid>
  <TileCard
    icon={BarChart3}
    title="Evaluate and improve your application"
