...
| -------------------------------------------------------------------------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Built-in judges](/genai/eval-monitor/scorers/llm-judge/predefined/#available-judgess) | Minimal                | Quickly try LLM evaluation with built-in judges such as `Correctness` and `RetrievalGroundedness`.                                                                    |
...
See the [complete list of built-in judges](/genai/eval-monitor/scorers/llm-judge/predefined/#available-judges) for details on each judge and their usage.
...
Once you've created custom judges, you can further improve their accuracy by [aligning them with human feedback](/genai/eval-monitor/scorers/llm-judge/alignment).
...
For a list of supported models, see the [MLflow documentation](/genai/model-providers).
