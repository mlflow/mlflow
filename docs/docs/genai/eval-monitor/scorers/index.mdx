...
The <APILink fn="mlflow.genai.judges.make_judge">make_judge</APILink> API provides a unified interface for creating custom LLM judges with template-based instructions, version control capabilities, and improved flexibility for handling various evaluation scenarios.
