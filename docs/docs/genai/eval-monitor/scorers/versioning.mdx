...
When you create a judge using the [Judge Builder UI](/genai/eval-monitor/scorers/llm-judge/make-judge), it is automatically registered to the current experiment as version 1.
