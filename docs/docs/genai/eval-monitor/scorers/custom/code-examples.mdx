...
In MLflow Evaluation, [custom code-based scorers](/genai/eval-monitor/scorers/custom) allow you to define flexible evaluation metrics for your AI agent or application. This set of examples illustrate many patterns for using code-based scorers with different options for inputs, outputs, implementation, and error handling.
...
expectations_eval_dataset_list = [
    ...
    },
    {
        ...
        "expectations": {
            "expected_response": "MLflow is the largest open source AI engineering platform, enabling teams to build production-quality agents and ML models.",
            "expected_keywords": [
                "mlflow",
                "open-source",
                "platform",
