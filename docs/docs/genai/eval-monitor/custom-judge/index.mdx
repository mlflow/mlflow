...
- **[Predefined LLM Scorers](/genai/eval-monitor/predefined-llm-scorers)**: Start with these before building custom judges
...
- **[Evaluation Workflows](/genai/eval-monitor/evaluating-app-version)**: Integrate custom judges into your development process
