...
- [Python file: `1_evaluate_your_app.py`](https://github.com/databricks/genai-cookbook/blob/main/mlflow_docs_examples/guides/evaluation/1_evaluate_your_app.py)
- [Databricks Notebook `1_evaluate_your_app_notebook.py`](https://github.com/databricks/genai-cookbook/blob/main/mlflow_docs_examples/guides/evaluation/1_evaluate_your_app_notebook.py) -->

## Next steps

Continue your journey with these recommended actions and tutorials.

<!-- - [Set up CI/CD testing](/genai/eval-monitor/ci-cd-testing) - Automatically evaluate new versions in your deployment pipeline -->
