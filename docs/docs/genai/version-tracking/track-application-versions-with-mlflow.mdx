...
description: Learn how to track versions of your LLM application or AI agent when your app's code resides in Git, using MLflow's automatic Git versioning capabilities.
---
...
```bash
uv pip install 'mlflow>=3.4' openai
```
</TabItem>
