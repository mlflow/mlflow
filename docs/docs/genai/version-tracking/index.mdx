...
- **MLflow 3.0+** (`uv pip install --upgrade 'mlflow>=3.1'` or `pip install --upgrade 'mlflow>=3.1'`)
- **Git repository** for your application code
- **Python 3.10+**
- **LLM API access** (OpenAI, Anthropic, etc.)

:::tip
For Databricks-hosted MLflow Tracking: `uv pip install --upgrade 'mlflow[databricks]>=3.1'` or `pip install --upgrade 'mlflow[databricks]>=3.1'`
:::
