...
```bash
uv pip install --upgrade mlflow langchain-openai
```
</TabItem>
<TabItem value="pip" label="pip">
```bash
pip install --upgrade mlflow langchain-openai
```
</TabItem>
</Tabs>
</TabsWrapper>
...
<TilesGrid>
  <TileCard
    ...
    description="Learn advanced version tracking patterns for production LLM applications and AI agents"
    icon={Code2}
  />
  <TileCard
  ...
  <TileCard
    ...
    description="Build comprehensive evaluation pipelines for production LLM applications and AI agents"
    icon={Rocket}
  />
</TilesGrid>
