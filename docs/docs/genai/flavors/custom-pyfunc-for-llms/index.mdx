...
:::note
This tutorial utilizes the <APILink fn="mlflow.pyfunc.PythonModel">`mlflow.pyfunc.PythonModel`</APILink> class to create a custom PyFunc model for building custom LLM and AI agent solutions.
...
development experience and an easier approach to deployment. To learn more, see [the guide to building LLM applications and AI agents with ChatModel](/genai/flavors/chat-model-guide).
:::
