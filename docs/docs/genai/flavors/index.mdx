...
# MLflow Native GenAI Integrations

MLflow 3 delivers built-in support for the GenAI frameworks you know and love—no more boilerplate or glue code. Whether you're calling OpenAI directly, orchestrating chains with LangChain or LangGraph, indexing documents in LlamaIndex, wiring up agent patterns via ChatModel and ResponseAgent, or rolling your own with a PythonModel, MLflow gives you one consistent API, unified experiment tracking, and out-of-the-box reproducibility.
...
- **Unified Tracking & Models**: All calls, parameters, artifacts, and prompt templates become tracked entities within MLflow Experiments. Serialized GenAI application code becomes a LoggedModel—viewable and referencable within the MLflow UI and APIs.
...
### 🧪 Evaluation & QA
- [LLM Evaluation Framework](/genai/getting-started/eval)
