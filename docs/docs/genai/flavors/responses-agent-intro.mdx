...
from mlflow.pyfunc import ResponsesAgent
from mlflow.types.responses import ResponsesAgentRequest, ResponsesAgentResponse
from mlflow.types.responses_utils import output_to_responses_items_stream, prep_msgs_for_cc_llm
...
class SimpleResponsesAgent(ResponsesAgent):
    ...
    def predict_stream(self, request: ResponsesAgentRequest):
        messages = prep_msgs_for_cc_llm([i.model_dump() for i in request.input])
...
class LangGraphResponsesAgent(ResponsesAgent):
    ...
    def predict_stream(
        ...
        cc_msgs = prep_msgs_for_cc_llm([i.model_dump() for i in request.input])
