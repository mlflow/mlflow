...
import { Bot, Code, Users, TrendingUp, Shield, Eye, Database, FileText, Target, Book, MousePointer, Plus, ListCheck, Type, Settings, FileInput, MessageSquare, Search, Edit, Save, MoreVertical } from "lucide-react";
...
<WorkflowSteps
  ...
  screenshot={{
    src: "/images/assessments/add_feedback_ui.png",
    alt: "Add Feedback"
  }}
/>
...
<WorkflowSteps
  ...
  screenshot={{
    src: "/images/assessments/edit_feedback_ui.png",
    alt: "Edit Feedback"
  }}
/>
...
<WorkflowSteps
  ...
  screenshot={{
    src: "/images/assessments/additional_feedback_ui.png",
