...
import { FileText, TrendingUp, ListCheck, Type, Settings, FileInput, MessageSquare } from "lucide-react";
...
Expectations define the ground truth for what your AI should produce. Follow these steps:

<WorkflowSteps
  steps={[
    {
      icon: ListCheck,
      title: "Select \"Expectation\" in the Assessment Type dropdown",
    ...
    {
      icon: FileInput,
      title: "Enter the expected values",
      description: "Define what the AI should have produced for this specific input"
    },
    {
      icon: MessageSquare,
      title: "Optionally add rationale to explain the expectation",
...
Feedback captures evaluations of how well the AI performed. Follow these steps:

<WorkflowSteps
  steps={[
    {
      icon: ListCheck,
      title: "Select \"Feedback\" in the Assessment Type dropdown",
      description: "Choose Assessment Type to evaluate quality rather than define expectations"
    },
    {
      icon: Type,
      title: "Add a specific name for the quality aspect",
      description: "Use clear names like \"accuracy\", \"helpfulness\", \"relevance\", or \"safety\""
    },
    {
      icon: Settings,
      title: "Choose the appropriate data type",
    ...
    {
      icon: MessageSquare,
      title: "Optionally add rationale to explain your assessment",
      description: "Document why you gave this evaluation for future reference and learning"
    }
  ]}
/>
...
<TilesGrid>
  <TileCard
    icon={FileText}
    title="MLflow Tracing Guide"
    description="Learn how feedback and expectations integrate with trace data"
    href="/genai/tracing"
  ...
  <TileCard
    ...
    description="Discover systematic evaluation strategies using feedback and expectations"
