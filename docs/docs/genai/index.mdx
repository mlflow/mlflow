...
<FeatureHighlights features={[
  {
    icon: Heart,
    title: "Open Source",
    description: "Join thousands of teams building agents and LLM applications with MLflow - with 26K+ GitHub Stars and 30M+ monthly downloads. As part of the Linux Foundation, MLflow ensures your AI infrastructure remains open and vendor-neutral."
  },
  {
    icon: Zap,
    title: "OpenTelemetry",
