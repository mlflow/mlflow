...
:::tip Try MLflow GenAI Demo

The quickest way to learn about MLflow GenAI is to try the demo.

Explore everything MLflow has to offer for GenAI observability, evaluation, prompt management, with pre-populated demo data. No setup required, open a terminal and run the following command:
