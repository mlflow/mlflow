...
<Tabs>
  <TabItem value="search" label="Search" default>
    ...
    <video src={useBaseUrl("/images/llms/tracing/trace-session-id.mp4")} controls loop autoPlay muted />
  ...
  <TabItem value="delete" label="Delete">
    ...
    <video src={useBaseUrl("/images/llms/tracing/trace-delete.mp4")} controls loop autoPlay muted />

  </TabItem>
  <TabItem value="edit-tags" label="Edit Tags">
    You can also edit key-value tags on your traces via the UI.

    <video src={useBaseUrl("/images/llms/tracing/trace-set-tag.mp4")} controls loop autoPlay muted />
