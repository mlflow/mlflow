...
:::tip
For the full guide on supported formats, framework-specific examples, and how to attach multimodal
content to traces, see [Multimodal Content in Traces](/genai/tracing/observe-with-traces/multimodal).
:::
