...
The trace detail view renders multimodal content in chat-style spans, including images and audio.
...
<div class="flex-item" style={{ flex: 6, minWidth: 0 }}>
...
<div class="flex-item padding-md" style={{ flex: 4 }}>
