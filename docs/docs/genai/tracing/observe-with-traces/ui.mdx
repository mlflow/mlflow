...
:::tip
MLflow renders images and audio inline in the trace viewer. For details on supported formats,
framework examples, and how to attach multimodal content to traces, see
[Multimodal Content in Traces](/genai/tracing/observe-with-traces/multimodal).
:::
