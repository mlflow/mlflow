...
[Span Links](/genai/concepts/span#span-links) connect spans across different traces without establishing a parent-child relationship. This is useful for tracking causal relationships in multi-agent systems, async workflows, and retry chains.
