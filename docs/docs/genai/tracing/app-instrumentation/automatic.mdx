...
<Tabs>
  <TabItem value="openai" label="OpenAI" default>
    ...
    [Full OpenAI Integration Guide](/tracing/integrations/openai)
  </TabItem>
  <TabItem value="langchain" label="LangChain">
    ...
    [Full LangChain Integration Guide](/tracing/integrations/langchain)
  </TabItem>
  <TabItem value="langgraph" label="LangGraph">
    ...
    [Full LangGraph Integration Guide](/tracing/integrations/langgraph)
  </TabItem>
  <TabItem value="anthropic" label="Anthropic">
    ...
    [Full Anthropic Integration Guide](/tracing/integrations/anthropic)
  </TabItem>
  <TabItem value="dspy" label="DSPy">
    ...
    [Full DSPy Integration Guide](/tracing/integrations/dspy)
  </TabItem>
  <TabItem value="bedrock" label="Amazon Bedrock">
    ...
    [Full Bedrock Integration Guide](/tracing/integrations/bedrock)
  </TabItem>
  <TabItem value="autogen" label="AutoGen">
    ...
    [Full AutoGen Integration Guide](/tracing/integrations/autogen)
  </TabItem>
</Tabs>
...
1. 🤖 **Direct OpenAI API calls** for language model interactions

2. 🔗 **LangChain chains** for structured workflows

3. ⚙️ **Custom logic between the calls** for business-specific processing

All of this is captured in a single trace, making it easy to:

1. 🐛 **Debug issues** by seeing exactly where problems occur

2. ⚡ **Monitor performance** across all components

3. 🗺️ **Understand the flow of the request** through your system

4. 📊 **Track which parts of the system are being used** most frequently
...
**[Integration Guides](/tracing/integrations/)**: Explore detailed guides for specific libraries and frameworks
