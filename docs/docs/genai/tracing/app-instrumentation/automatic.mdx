...
import { PenLine, LayoutDashboard, Search } from "lucide-react";
...
<ImageBox src="/images/llms/anthropic/anthropic-tracing.png" alt="Automatic Tracing with MLflow" />
...
```bash
uv pip install --upgrade langchain langchain-openai
```
</TabItem>
...
<TilesGrid>
  <TileCard
    ...
    description="Learn how to add custom tracing to your application logic"
    href="/genai/tracing/app-instrumentation/manual-tracing"
    linkText="Add custom spans →"
  />
  <TileCard
    icon={LayoutDashboard}
    title="Viewing Traces"
    description="Explore and analyze your traces in the MLflow UI"
  ...
  <TileCard
    ...
    description="Programmatically search and retrieve trace data for analysis"
