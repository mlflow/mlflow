...
**[Manual Tracing](#manual-tracing)**: Designed for custom logic and complex workflows, manual tracing gives you full control over what gets traced and how.
...
<Tabs>
  <TabItem value="learn-more" label="Learn More" default>
    ...
    **[Combining Approaches](/genai/tracing/app-instrumentation/manual-tracing#combining-with-auto-tracing)**: Mix automatic and manual tracing for optimal observability
