...
# Decorators & Context Managers (Recommended)
...
<DatabricksCallout docsPath="/mlflow3/genai/tracing/app-instrumentation/manual-tracing/decorators-context-managers" />
...
- 🎯 **`span_type` parameter** to set the type of span. Set either one of built-in [Span Types](/genai/tracing/data-model#span-types) or a string.
...
- 🛠️ Precise control of span start and end points
