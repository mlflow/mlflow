  ...
  <div className="flex-column">
    <div className="flex-row">
      <div className="flex-item">
        ...
        The [Production Tracing SDK (`mlflow-tracing`)](/genai/tracing/production-sdk) is a smaller package that only includes the minimum set of dependencies to instrument your code/models/agents with MLflow Tracing.
