...
- **Explore More Integrations:** MLflow supports a wide range of LLM providers and agent frameworks. See the full list in the [Integrations Overview](/genai/tracing/integrations).
...
- **Attach Feedback & Evaluate Quality:** Add human or automated feedback to your traces. See how in [Attaching Feedback](/genai/assessments/feedback/) or try [automated evaluation](/genai/eval-monitor) for scoring conversation responses.
