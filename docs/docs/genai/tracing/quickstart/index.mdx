...
If you have existing MLflow experiments stored in `mlruns/`, the MLflow UI may default to the file-based backend and not show newly generated traces.

To ensure you can see your new traces, start the MLflow UI with:
