---
title: Tracing txtai
description: Trace txtai embeddings database and LLM orchestration workflows with MLflow for full observability into semantic search and language model pipelines.
sidebar_position: 13
sidebar_label: Txtai
keywords: [txtai, tracing, mlflow, embeddings, semantic search, llm]
image: /images/llms/tracing/txtai-rag-tracing.png
---
