---
title: Tracing Google Agent Development Kit (ADK)
description: Trace Google Agent Development Kit agent executions with MLflow via OpenTelemetry for full observability into modular AI agent workflows.
sidebar_position: 5
sidebar_label: Google ADK
keywords: [google adk, tracing, mlflow, ai agent, opentelemetry, google]
image: /images/llms/tracing/google-adk-tracing.png
---
...
```bash
uv pip install 'mlflow>=3.6.0' google-adk opentelemetry-exporter-otlp-proto-http
```
</TabItem>
