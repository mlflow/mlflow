...
MLflow automatically captures token usage and cost statistics for supported Bedrock models and APIs. See the [Token Usage and Cost Tracking](/genai/tracing/token-usage-cost) documentation for details on accessing this information programmatically.
