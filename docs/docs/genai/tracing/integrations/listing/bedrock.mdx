---
title: Tracing Amazon Bedrock with MLflow
description: Trace Amazon Bedrock foundation model calls with MLflow for full observability into LLM interactions across providers like Anthropic, Cohere, Meta, and Mistral.
sidebar_position: 4.5
sidebar_label: Bedrock
keywords: [bedrock, tracing, mlflow, aws, foundation models, llm]
image: /images/llms/tracing/bedrock-tracing-agent.png
---
