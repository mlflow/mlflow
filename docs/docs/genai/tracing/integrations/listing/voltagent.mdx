---
title: Tracing VoltAgent
description: Trace VoltAgent AI agent workflows with MLflow via OpenTelemetry for full observability into TypeScript-based agent orchestration.
sidebar_position: 7
sidebar_label: VoltAgent
keywords: [voltagent, tracing, mlflow, typescript, opentelemetry, ai agent]
image: /images/llms/tracing/voltagent-tracing.png
---
...
Since this integration is built on OpenTelemetry, you can combine the automatically generated traces with the [MLflow Tracing SDK](/genai/tracing) (`@mlflow/core`) to add custom spans, set tags, and update trace metadata within the same trace.
