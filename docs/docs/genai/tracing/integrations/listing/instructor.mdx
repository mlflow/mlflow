---
title: Tracing Instructor
description: Trace Instructor structured LLM output generation with MLflow for full observability into validated, type-safe AI responses.
sidebar_position: 12
sidebar_label: Instructor
keywords: [instructor, tracing, mlflow, structured output, pydantic, llm]
image: /images/llms/tracing/instructor-tracing.png
---
