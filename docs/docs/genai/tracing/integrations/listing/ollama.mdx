...
MLflow automatically tracks token usage and cost for Ollama models through the OpenAI SDK integration. See the [Token Usage and Cost Tracking](/genai/tracing/token-usage-cost) documentation for details on accessing this information programmatically.
