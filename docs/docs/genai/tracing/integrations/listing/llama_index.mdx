---
title: Tracing LlamaIndex🦙
description: Trace LlamaIndex data-augmented LLM application workflows with MLflow for full observability into indexing, retrieval, and generation pipelines.
sidebar_position: 4
sidebar_label: LlamaIndex
keywords: [llamaindex, tracing, mlflow, rag, indexing, retrieval, llm]
---
...
The `Workflow` is LlamaIndex's next-generation AI agent orchestration framework. It is designed as a flexible and interpretable framework for building arbitrary LLM applications such as an agent, a RAG flow, a data extraction pipeline, etc. MLflow supports tracking, evaluating, and tracing the Workflow objects, which makes them more observable and maintainable.
