---
title: Tracing Arize / Phoenix
description: Mirror Arize Phoenix OpenInference traces to MLflow via OpenTelemetry for unified AI observability across instrumented applications.
sidebar_position: 14
sidebar_label: Arize / Phoenix
keywords: [arize, phoenix, tracing, mlflow, opentelemetry, openinference, observability]
---
...
[Arize Phoenix](https://arize.com/phoenix/) is the open-source AI observability option from [Arize AI](https://arize.com/?utm_source=mlflow-docs&utm_medium=partner&utm_campaign=partner-docs&utm_content=tracing-arize-phoenix). Its [OpenInference](https://github.com/Arize-ai/openinference) instrumentation libraries produce OpenTelemetry spans with rich AI-specific attributes for model providers like OpenAI, Anthropic, and others.

This page focuses on mirroring OpenInference traces to MLflow. Teams that need managed cloud or enterprise self-hosted observability and evaluation for production AI systems can use [Arize AX](https://arize.com/products/ax/) with the same OpenInference trace data.
...
For evaluation workflows that build on trace data, see Arize's [agent evaluation guide](https://arize.com/guides/ai-agent-handbook/agent-evaluation/) and [LLM evaluation guide](https://arize.com/resources/llm-evaluation/).
