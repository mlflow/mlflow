---
title: Tracing PydanticAI
description: Trace PydanticAI agent workflows with MLflow for full observability into type-safe, production-grade generative AI applications.
sidebar_position: 7
sidebar_label: PydanticAI
keywords: [pydantic ai, tracing, mlflow, type safety, agent, llm]
image: /images/llms/pydantic-ai/pydanticai-tracing.png
---
...
[MLflow Tracing](/genai/tracing) provides automatic tracing capability for [​PydanticAI](https://ai.pydantic.dev/), an open source framework for building multi-agent applications. By enabling auto tracing for ​PydanticAI by calling the <APILink fn="mlflow.pydantic_ai.autolog" /> function, MLflow will capture nested traces for ​PydanticAI workflow execution and log them to the active MLflow Experiment.
