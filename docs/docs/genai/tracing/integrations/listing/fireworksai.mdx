---
title: Tracing FireworksAI
description: Trace Fireworks AI inference calls with MLflow using OpenAI-compatible auto-tracing for full observability into open-source model interactions.
sidebar_position: 12
sidebar_label: FireworksAI
keywords: [fireworks ai, tracing, mlflow, openai-compatible, llm, inference]
image: /images/llms/tracing/fireworks-ai-tracing.png
---
