...
- If you send telemetry directly to MLflow without a collector, point the OTLP endpoint at `http://localhost:5000/v1/traces` and include the `x-mlflow-experiment-id` header.
