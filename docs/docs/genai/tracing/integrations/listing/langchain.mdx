...
MLflow captures image content parts passed through LangChain models. See [Multimodal Content in Traces](/genai/tracing/observe-with-traces/multimodal) for details.
:::
