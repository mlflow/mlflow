---
title: Tracing Smolagents
description: Trace Smolagents AI agent executions with MLflow for full observability into lightweight agent workflows and tool usage.
sidebar_position: 11
sidebar_label: Smolagents
keywords: [smolagents, tracing, mlflow, hugging face, ai agent]
image: /images/llms/smolagents/smolagents-tracing.png
---
