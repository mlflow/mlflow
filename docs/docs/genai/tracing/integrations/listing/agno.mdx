---
title: Tracing Agno
description: Trace Agno agent pipelines including LLM calls, reasoning steps, and tool usage with MLflow for full observability into AI agent workflows.
sidebar_position: 8
sidebar_label: Agno
keywords: [agno, tracing, mlflow, ai agent, agent framework]
image: /images/llms/agno/agno-tracing-basic.png
---
...
```bash
uv pip install 'mlflow>=3.3' agno anthropic yfinance
```
</TabItem>
