---
title: Tracing CrewAI
description: Trace CrewAI multi-agent workflows and role-based AI agent interactions with MLflow for full observability into autonomous agent orchestration.
sidebar_position: 7
sidebar_label: CrewAI
keywords: [crewai, tracing, mlflow, multi-agent, agent orchestration, ai agent]
---
