---
title: Tracing Goose
description: Trace Goose AI coding agent interactions with MLflow via OpenTelemetry for full observability into autonomous engineering task automation.
sidebar_label: Goose
keywords: [goose, tracing, mlflow, ai agent, opentelemetry, coding assistant, block]
image: /images/llms/tracing/goose-tracing.png
---
