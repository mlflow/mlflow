...
:::tip Multimodal Support
MLflow automatically captures images sent to Anthropic models and normalizes them to the standard trace format. See [Multimodal Content in Traces](/genai/tracing/observe-with-traces/multimodal) for examples.
:::
