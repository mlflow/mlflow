...
image: /images/llms/anthropic/anthropic-tracing.png
---
...
MLflow automatically captures images sent to Anthropic models and normalizes them to the standard trace format. See [Image and Audio (Multimodal) Content in Traces](/genai/tracing/observe-with-traces/multimodal) for examples.
:::
