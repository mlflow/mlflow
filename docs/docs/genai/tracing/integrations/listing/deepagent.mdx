---
title: Tracing LangChain Deep Agent
description: Trace LangChain Deep Agent autonomous task planning and execution with MLflow for full observability into complex AI agent workflows.
sidebar_position: 60
sidebar_label: LangChain Deep Agent
toc_max_heading_level: 2
keywords: [langchain, deep agent, tracing, mlflow, ai agent, langgraph, autonomous]
image: /images/llms/tracing/deepagent-tracing.png
---
...
```bash
uv pip install deepagents tavily-python mlflow
```
</TabItem>
<TabItem value="pip" label="pip">
```bash
pip install deepagents tavily-python mlflow
```
</TabItem>
</Tabs>
</TabsWrapper>
