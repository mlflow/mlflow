---
title: Tracing Semantic Kernel
description: Trace Semantic Kernel AI middleware executions with MLflow for full observability into LLM orchestration across Python, C#, and Java applications.
sidebar_position: 6
sidebar_label: Semantic Kernel
keywords: [semantic kernel, tracing, mlflow, microsoft, ai middleware, llm]
image: /images/llms/tracing/semantic-kernel-tracing.png
---
...
```bash
uv pip install 'mlflow>=3.2.0' semantic_kernel openai
```
</TabItem>
