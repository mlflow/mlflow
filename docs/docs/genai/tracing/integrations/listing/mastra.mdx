---
title: Tracing Mastra
description: Trace Mastra AI agent workflows with MLflow via OpenTelemetry for full observability into modular agent orchestration.
sidebar_position: 6
sidebar_label: Mastra
keywords: [mastra, tracing, mlflow, ai agent, opentelemetry, agent framework]
image: /images/llms/tracing/mastra-tracing.png
---
