...
MLflow automatically captures images and audio sent to OpenAI models. See [Multimodal Content in Traces](/genai/tracing/observe-with-traces/multimodal) for examples and supported formats.
:::
