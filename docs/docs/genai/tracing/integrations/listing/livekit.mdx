---
title: Tracing LiveKit Agents
description: Trace LiveKit Agents real-time multimodal AI interactions with MLflow via OpenTelemetry for full observability into voice and video AI applications.
sidebar_position: 6
sidebar_label: LiveKit Agents
keywords: [livekit, tracing, mlflow, opentelemetry, real-time, multimodal, ai agent]
image: /images/llms/tracing/livekit-tracing.png
---
...
```bash
uv pip install livekit-agents livekit-plugins-openai livekit-plugins-silero
```
</TabItem>
