---
title: Tracing Databricks AI Gateway
description: Trace Databricks AI Gateway requests with MLflow for full observability into governed access to generative AI models and serving endpoints.
sidebar_position: 101
sidebar_label: Databricks
keywords: [databricks, ai gateway, tracing, mlflow, model serving, governance]
---
