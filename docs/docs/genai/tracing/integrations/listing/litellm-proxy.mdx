---
title: Tracing LiteLLM Proxy
description: Trace LiteLLM Proxy gateway requests with MLflow for full observability into unified LLM routing, load balancing, and spend tracking.
sidebar_position: 102
sidebar_label: LiteLLM Proxy
keywords: [litellm, proxy, tracing, mlflow, ai gateway, load balancing, llm]
image: /images/llms/litellm-proxy/litellm-proxy-tracing.png
---
