...
Configure the MLflow connection using environment variables. For persistence across sessions, add these to your shell profile (e.g., `~/.bashrc`, `~/.zshrc`) or a `.env` file in your project root:
