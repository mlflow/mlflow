---
title: Tracing OpenCode
description: Trace OpenCode terminal-based AI coding agent interactions with MLflow for full observability into AI-assisted software development workflows.
sidebar_position: 10
sidebar_label: OpenCode
keywords: [opencode, tracing, mlflow, coding assistant, terminal, ai agent]
image: /images/llms/opencode/opencode-tracing.png
---
