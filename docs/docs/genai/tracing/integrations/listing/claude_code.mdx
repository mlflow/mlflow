...
![Claude Code Tracing via CLI autolog](/images/llms/anthropic/claude-code-tracing.gif)
...
- MLflow installed (`pip install -U mlflow`)
...
3. **View Results**: Use the MLflow experiment UI to explore your traces
