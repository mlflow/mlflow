---
title: Tracing Haystack
description: Trace Haystack AI pipeline executions with MLflow for full observability into LLM-powered search, retrieval, and generation workflows.
sidebar_position: 8
sidebar_label: Haystack
keywords: [haystack, tracing, mlflow, deepset, rag, pipeline, llm]
image: /images/llms/haystack/haystack-tracing.png
---
