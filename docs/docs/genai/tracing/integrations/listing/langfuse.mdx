---
title: Tracing Langfuse
description: Mirror Langfuse traces to MLflow via OpenTelemetry for unified observability across LLM engineering workflows.
sidebar_position: 13
sidebar_label: Langfuse
keywords: [langfuse, tracing, mlflow, opentelemetry, observability, llm engineering]
---
...
```bash
uv pip install mlflow langfuse
```
</TabItem>
