---
title: Tracing OpenAI Agent🤖
description: Trace OpenAI Agents SDK multi-agent workflows with MLflow for full observability into agent orchestration, tool usage, and handoffs.
sidebar_position: 3
sidebar_label: OpenAI Agents SDK
keywords: [openai, agents sdk, tracing, mlflow, multi-agent, agent orchestration]
image: /images/llms/tracing/openai-agent-tracing.png
---
