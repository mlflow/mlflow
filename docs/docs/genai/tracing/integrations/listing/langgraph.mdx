---
title: Tracing LangGraph🦜🕸️
description: Trace LangGraph stateful multi-agent workflows with MLflow for full observability into graph-based AI agent orchestration.
sidebar_position: 3
sidebar_label: LangGraph
toc_max_heading_level: 2
keywords: [langgraph, tracing, mlflow, multi-agent, stateful, langchain, agent]
...
```bash
uv pip install langgraph langchain-openai mlflow
```
</TabItem>
