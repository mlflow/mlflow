---
title: Tracing AG2🤖
description: Trace AG2 multi-agent workflows and interactions with MLflow for full observability into autonomous AI agent orchestration.
sidebar_position: 6
sidebar_label: AG2
keywords: [ag2, tracing, mlflow, multi-agent, agent orchestration, autogen]
image: /images/llms/ag2/ag2-trace.png
---
