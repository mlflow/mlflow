...
<CardGroup isSmall>
  ...
  <SmallLogoCard link="/genai/tracing/integrations/listing/semantic_kernel">
    <span>![Semantic Kernel Logo](/images/logos/semantic-kernel-logo.png)</span>
  </SmallLogoCard>
  ...
  <SmallLogoCard link="/genai/tracing/integrations/listing/haystack">
    <span>![Haystack Logo](/images/logos/haystack-logo.png)</span>
  </SmallLogoCard>
