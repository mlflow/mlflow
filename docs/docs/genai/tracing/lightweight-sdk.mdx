...
<Tabs>
    ...
    <div class="flex-column">
      <div class="flex-row">
        <div class="flex-item">
          ...
          [Sign up for free](https://signup.databricks.com/?destination_url=/ml/experiments-signup?source=TRY_MLFLOW&dbx_source=TRY_MLFLOW&signup_experience_step=EXPRESS) and [get started in a minute](https://docs.databricks.com/aws/en/generative-ai/agent-evaluation/monitoring) to run your GenAI application with complete observability.
        </div>
  ...
  <TabItem value="self-hosting" label="Self-Hosted MLflow">
    <div class="flex-column">
      <div class="flex-row">
        <div class="flex-item">
    ...
    <div class="flex-column">
      <div class="flex-row">
        <div class="flex-item">
          ...
          MLflow Tracing offers a one-line solution for [tracing Amazon Bedrock](/genai/tracing/integrations/bedrock), making it the best suitable solution for monitoring GenAI application powered by AWS and Amazon Bedrock.
  ...
  <TabItem value="nebius" label="Nebius">
    <div class="flex-column">
      <div class="flex-row">
        ...
        <div class="flex-item padding-md">
          <img src="/images/logos/nebius-logo.png" alt="Nebius Logo" width="80%" />
        </div>
      </div>
    </div>
  </TabItem>
...
def handle_user_request(user_id: str, session_id: str, message: str):
    ...
    try:
        ...
        # Log success metrics
        mlflow.update_current_trace(
            attributes={"response_length": len(response), "processing_successful": True}
        )
...
|---------|------|--------------|----------|
| `mlflow` | ~50MB | 20+ packages | Development, experimentation, full ML lifecycle |
| `mlflow-tracing` | ~5MB | 5-8 packages | Production tracing, monitoring, observability |

The lightweight SDK is **90% smaller** than the full MLflow package, making it ideal for:
