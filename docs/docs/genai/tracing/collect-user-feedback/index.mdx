...
<ComingSoon docsPath="/mlflow3/genai/tracing/collect-user-feedback" additionalText="Databricks currently offers a comprehensive user feedback and assessment system. Please see the linked docs for more information."/>
...
positive_count = len([t for t in recent_feedback 
                     if t.data.tags.get('feedback_positive') == 'true'])
