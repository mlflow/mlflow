...
import PythonLogoImageUrl from '@site/static/images/logos/python-logo.png';
import TypescriptLogoImageUrl from '@site/static/images/logos/javascript-typescript-logo.png';
