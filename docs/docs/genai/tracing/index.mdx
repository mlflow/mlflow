...
- Use `mlflow.tracing.get_tracing_context_headers_for_http_request()` on the client to inject headers, see full API reference: [mlflow.tracing.get_tracing_context_headers_for_http_request](/api_reference/python_api/mlflow.tracing.html#mlflow.tracing.get_tracing_context_headers_for_http_request)

- Use `mlflow.tracing.set_tracing_context_from_http_request_headers(headers)` on the server to extract and set the current context for the duration of the request, See full API reference: [mlflow.tracing.set_tracing_context_from_http_request_headers](/api_reference/python_api/mlflow.tracing.html#mlflow.tracing.set_tracing_context_from_http_request_headers)
