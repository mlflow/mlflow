...
import GenAITraceDebugImageUrl from '@site/static/images/llms/tracing/genai-trace-debug.png';
...
<div style={{display: 'flex', justifyContent: 'center'}}>
  <img src={TraceArchitectureImageUrl} alt="Trace Architecture" style={{width: '70%'}} />
</div>
