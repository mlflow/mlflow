...
<div style={{display: 'flex', justifyContent: 'center'}}>
  <img src="/images/llms/tracing/schema/feedback_architecture.png" alt="Feedback Architecture" style={{width: '60%'}} />
</div>
...
<TilesGrid>
  <TileCard
    ...
    description="Learn how to collect automated and human feedback on your GenAI applications"
  ...
  <TileCard
    ...
    description="Complete reference for the feedback API with practical examples"
