...
# Ingesting OpenInference Traces into MLflow

[OpenInference](https://github.com/Arize-ai/openinference) is a set of semantic conventions and instrumentation libraries for GenAI frameworks. With MLflow OpenTelemetry endpoint, you can ingest OpenInference traces info MLflow and visualize, evaluate, and optimize your GenAI applications.
...
<ImageBox
  src="/images/llms/tracing/opentelemetry/openinference-trace.png"
  alt="The MLflow UI showing the OpenInference traces"
  width="100%"
/>
...
```bash
%pip install openai openinference-instrumentation-openai -qU
```
