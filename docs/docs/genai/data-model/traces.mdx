...
graph TB
    ...
    classDef infoStyle fill:#e3f2fd,stroke:#0277bd,stroke-width:3px,color:#000
    classDef headerStyle fill:#f5f5f5,stroke:#424242,stroke-width:2px,color:#000
    classDef componentStyle fill:#fff3e0,stroke:#ef6c00,stroke-width:2px,color:#000
    classDef titleStyle fill:#f5f5f5,stroke:#424242,stroke-width:2px,color:#000
    
    class INFO infoStyle
    class IDENTITY,TIMING,CONTEXT headerStyle
    class ID1,ID2,ID3,T1,T2,T3,C1,C2,C3 componentStyle
    class TITLE titleStyle
```
...
graph TB
    ...
    classDef spanStyle fill:#e8f5e8,stroke:#2e7d32,stroke-width:3px,color:#000
    classDef headerStyle fill:#f5f5f5,stroke:#424242,stroke-width:2px,color:#000
    classDef componentStyle fill:#fff3e0,stroke:#ef6c00,stroke-width:2px,color:#000
    classDef titleStyle fill:#f5f5f5,stroke:#424242,stroke-width:2px,color:#000
    
    class SPAN spanStyle
    class IDENTITY_HEADER,TIMING_HEADER,CONTENT_HEADER headerStyle
    class SI1,SI2,SI3,SI4,ST1,ST2,ST3,SC1,SC2,SC3,SC4 componentStyle
    class TITLE titleStyle
```
...
| **ai.model.name** | Model identification | Specific model used (e.g., "gpt-4") |
| **ai.response.tokens.total** | Usage tracking | Token consumption metrics |
