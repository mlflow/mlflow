...
2. **[Evaluation Workflows](/genai/evaluation)**: Create systematic version comparison processes  
...
5. **[Custom Scorers](/genai/evaluation/custom-scorers)**: Build version-aware automated evaluation functions
