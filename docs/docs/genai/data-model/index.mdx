...
results = mlflow.genai.evaluate(
    ...
    scorers=[relevance_metric],
    dataset_name="model_relevance_eval",  # Optional: Custom name for tracking
)
```
...
results = mlflow.genai.evaluate(
    ...
    dataset_name="production_eval_v2",  # Optional: Custom name for tracking
