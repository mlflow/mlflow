...
A Run represents a single evaluation iteration of your GenAI model - think of it as a snapshot of how your model performed during a specific testing session.
...
**Key relationships:**
- **Models own Runs**: Each run belongs to a specific model version
