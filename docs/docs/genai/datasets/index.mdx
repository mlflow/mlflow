---
title: Building Agent & LLM Evaluation Datasets | MLflow AI Platform
description: Create labeled and unlabeled evaluation datasets to systematically test and improve your agent and LLM applications with MLflow.
---
...
<TabItem value="for-simulation" label="For Conversation Simulation">

Store test cases for [conversation simulation](/genai/eval-monitor/running-evaluation/conversation-simulation) to enable reproducible multi-turn testing:
