---
description: "Learn how to connect your development environment to MLflow for GenAI application development, whether using OSS MLflow or Managed MLflow (Databricks)."
last_update:
  date: 2025-05-18
---
...
This guide shows you how to connect your development environment to an MLflow Experiment. MLflow supports both OSS MLflow (self-hosted) and Managed MLflow (Databricks) environments.

:::note[MLflow Experiments]
An MLflow Experiment is the container for your GenAI application. Learn more about the Experiment and what it contains in the [data model](/genai/data-model/index) section.
:::
...
<Tabs>
  ...
  <TabItem value="managed" label="Managed MLflow (Databricks)">
...
<Tabs>
  ...
  <TabItem value="databricks-notebook" label="Databricks - Notebook">
    ...
    Creating a Databricks Notebook will create an MLflow Experiment that is the container for your GenAI application. Learn more about the Experiment and what it contains in the [data model](/genai/data-model/index) section.
...
- **Evaluate your app's quality**: Use the [evaluation quickstart](/genai/getting-started/eval) to systematically test and improve your app's quality
- **Collect human feedback**: Try the [human feedback quickstart](/genai/getting-started/human-feedback) to gather domain expert and end-user insights
