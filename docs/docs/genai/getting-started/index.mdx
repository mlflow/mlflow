---
title: "Get Started: MLflow for Agents & LLMs | MLflow AI Platform"
description: "Build, evaluate, and deploy production-ready agent and LLM applications with MLflow's comprehensive LLMOps platform."
sidebar_position: 1
---
...
# Getting Started with MLflow for Agents and LLM Applications

## The Largest Open Source AI Engineering Platform for Agents and LLM Applications

MLflow transforms how software engineers build, evaluate, and deploy LLM applications and AI agents. Get complete observability, systematic evaluation, and deployment confidence—all while maintaining the flexibility to use any framework or model provider.
...
<div style={{margin: '2rem 0', textAlign: 'center'}}>
  <video
    ...
    autoPlay
    muted
    aria-label="MLflow Tracing UI showing detailed LLM application and AI agent observability"
    style={{maxWidth: '100%', borderRadius: '8px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.15)'}}
  />
</div>

## The LLM Application and AI Agent Development Lifecycle

MLflow provides a complete platform that supports every stage of LLM application and AI agent development. From initial prototyping to production monitoring, these integrated capabilities ensure you can build, test, and deploy with confidence.
...
## Why Open Source MLflow for LLMs and AI Agents?

As the original open source AI engineering platform, MLflow brings battle-tested reliability and community-driven innovation to agent and LLM application development. No vendor lock-in, no proprietary formats—just powerful tools that work with your stack.
...
## Start Building Production LLM Applications and AI Agents

MLflow transforms LLM application and AI agent development from complex instrumentation to simple, one-line integrations. See how easy it is to add comprehensive observability, evaluation, and deployment to your AI applications. Visit the [Tracing guide](/genai/tracing) for more information.

### Add Complete Observability in One Line

Transform any LLM or AI agent application into a fully observable system:
...
Master these core capabilities to build robust LLM applications and AI agents with MLflow. Start with observability, then add systematic evaluation and deployment.
...
<TilesGrid>
  <TileCard
    ...
    description="Configure MLflow tracking, connect to registries, and set up your development environment for LLM application and AI agent workflows"
  ...
  <TileCard
    ...
    description="Auto-instrument your LLM application or AI agent to capture every LLM call, prompt, and tool interaction for complete visibility"
...
These three foundations will give you the observability and quality confidence needed for production LLM application and AI agent development. Each tutorial includes real code examples and best practices from production deployments.

---

## Advanced LLM Application and AI Agent Capabilities

Once you've mastered the essentials, explore these advanced features to build sophisticated LLM applications and AI agents with enterprise-grade reliability.
...
<TilesGrid>
  ...
  <TileCard
    ...
    description="Deploy LLM applications and AI agents to production with built-in serving, scaling, and monitoring capabilities"
    href="/genai/serving"
...
These capabilities enable you to build production-ready LLM applications and AI agents with systematic quality management and robust deployment infrastructure.

---

## Framework-Specific Integration Guides

MLflow provides deep integrations with popular LLM and AI agent frameworks. Choose your framework to get started with optimized instrumentation and best practices.
...
## Start Your LLM Application and AI Agent Journey with MLflow

Ready to build production-ready LLM applications and AI agents? Start with the Environment Setup guide above, then explore tracing for complete observability into your AI systems. Join thousands of engineers who trust MLflow's open source platform for their LLM application and AI agent development.
