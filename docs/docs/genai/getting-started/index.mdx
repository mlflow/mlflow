...
<div style={{margin: '2rem 0', textAlign: 'center'}}>
  <img
    src="/images/llms/tracing/tracing-top.gif"
...
### Deploy Models with Zero Configuration

Turn any prompt into a production-ready API endpoint:

```python
# Log your optimized prompt as a deployable model
...
# mlflow models serve -m "models:/customer_support_bot/1" -p 5000
```

Your prompt is now a scalable REST API with automatic logging, monitoring, and version control.
...
<TilesGrid>
  <TileCard
    ...
    href="/genai/prompt-version-mgmt/prompt-engineering"
