...
# Prepare training data with inputs and expected outputs
train_data = [
    {"inputs": {"question": "What is 15 + 27?"}, "outputs": "42"},
    {"inputs": {"question": "Calculate 8 × 9"}, "outputs": "72"},
    {"inputs": {"question": "What is 100 - 37?"}, "outputs": "63"},
    # ... more examples
]
