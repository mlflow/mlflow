...
- MLflow 3.0+ installed (`pip install --upgrade mlflow`)
...
**[Learn how to evaluate your application →](/genai/getting-started/eval)**
...
After completing the quickstarts, dive deeper with our comprehensive tutorials:

### 🎓 Hands-On Tutorials
- [Debug Complex AI Workflows with Tracing](/genai/tutorials/debug-tracing)
- [Build Quality Into Your Development Process](/genai/tutorials/dev-quality-iteration)
- [Enhance Applications Using Trace Insights](/genai/tutorials/enhance-quality)
