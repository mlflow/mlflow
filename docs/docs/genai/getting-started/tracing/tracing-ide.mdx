...
This quickstart helps you integrate your GenAI app with [MLflow Tracing](/genai/tracing/index) using MLflow OSS in your local IDE development environment.
...
<Tabs>
  <TabItem value="openai" label="OpenAI">
    ...
    2. Create a Python file named `app.py` in your project directory:
       ...
       Here, we use the [`@mlflow.trace` decorator](/genai/tracing/app-instrumentation/manual-tracing/index) that makes it easy to trace any Python application combined with the [OpenAI automatic instrumentation](/genai/tracing/integrations/openai) to capture the details of the call to the OpenAI SDK.
