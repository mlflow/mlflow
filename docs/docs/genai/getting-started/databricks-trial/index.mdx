...
See the [Databricks unified authentication documentation](https://docs.databricks.com/aws/en/dev-tools/auth/unified-auth) for all supported authentication methods.
