...
#### Alternative: Databricks Unified Authentication
...
# MLFLOW_ENABLE_DB_SDK=true is the default, so no need to set it explicitly
...
See the [Databricks unified authentication documentation](https://docs.databricks.com/en/dev-tools/auth/index.html#unified-authentication) for all supported authentication methods.
