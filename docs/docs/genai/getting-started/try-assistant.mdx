...
sidebar_position: 4
sidebar_label: "Try MLflow's AI Assistant"
---
...
The MLflow AI Assistant is a powerful AI-powered helper that transforms cutting-edge coding agents like Claude Code into experienced AI engineers by your side. Unlike typical chatbots, MLflow AI Assistant is **aware of your codebase and context**. It is not just a question-answering tool, but a full-fledged AI engineer that can find root causes for issues, setup quality tests, and apply LLMOps best practices into your project.

<ImageBox src="/images/assistant/hero.png" alt="MLflow AI Assistant" />

## What's Unique About MLflow AI Assistant?
...
<details>
<summary><strong>Is MLflow AI Assistant really free?</strong></summary>
