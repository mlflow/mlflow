...
model to use Tensorflow flavor, but if you are interested, please refer to [MLflow pyfunc model](/models#how-to-load-and-score-python-function-models).
...
<div className="center-div" style={{ width: "90%" }}>
  ![Tensorflow Model
  Signature](/images/deep-learning/tensorflow/guide/tensorflow-model-signature.png)
</div>
