...
<Tabs>
  ...
  <TabItem value="python" label="Python" default>
    <div class="flex-column">
      ...
      # Optional: Set tags that apply to the prompt (across versions)
      mlflow.genai.set_prompt_tag("summarization-prompt", "task", "summarization")
      mlflow.genai.set_prompt_tag("summarization-prompt", "language", "en")

      # The prompt object contains information about the registered prompt
      print(f"Created prompt '{text_prompt.name}' (version {text_prompt.version})")
      ```
    </div>
