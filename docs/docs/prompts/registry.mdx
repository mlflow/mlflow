...
<Tabs>
  ...
  <TabItem value="python" label="Python" default>
    <div class="flex-column">
      ...
      mlflow.set_prompt_alias("Summarization Prompt", alias="production", version=4)
      ```
    </div>
  </TabItem>
</Tabs>
...
When you evaluate prompt performance with [MLflow LLM Evaluation](/llms/llm-evaluate), the relationships between prompts, models, and evaluation results are automatically recorded:
