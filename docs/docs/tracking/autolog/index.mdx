...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>--</td>
      <td>Model checkpoints are logged to a ‘models’ directory; [MLflow Model](/model) (fastai Learner model) on training end; Model summary text is logged</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>--</td>
      <td>Model summary on training start; [MLflow Model](/model) (Keras model); TensorBoard logs on training end</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
      - Traces;
      - [MLflow Model](/model) (LangChain model) with model signature on training end;
      - Input example
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>--</td>
      <td>[MLflow Model](/model) (LightGBM model) with model signature on training end; feature importance; input example;</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>--</td>
      <td>
      - [MLflow Model](/model) (OpenAI model) with model signature on training end;
      - Input example
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>--</td>
      <td>[MLflow Model](/model) (Paddle model) with model signature on training end</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        - [MLflow Model](/model) containing a fitted estimator
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>`fit()` parameters; optimizer name; learning rate; epsilon.</td>
      <td>--</td>
      <td>Model summary on training start, [MLflow Model](/model) (PyTorch model) on training end;</td>
    </tr>
    <tr>
      ...
      <td>--</td>
      <td>Model summary on training start; [MLflow Model](/model) (PyTorch model) on training end; Best PyTorch model checkpoint, if training stops due to early stopping callback.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>--</td>
      <td>[MLflow Model](/model) (statsmodels.base.wrapper.ResultsWrapper) on training end</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>--</td>
      <td>[MLflow Model](/model) (XGBoost model) with model signature on training end; feature importance; input example</td>
    </tr>
  </tbody>
</table>
