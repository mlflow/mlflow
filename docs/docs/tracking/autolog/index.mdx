...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Logs optimizer data as parameters. For example, `epochs`, `lr`, `opt_func`, etc; Logs the parameters of the [EarlyStoppingCallback](https://docs.fast.ai/callbacks.html#EarlyStoppingCallback) and [OneCycleScheduler](https://docs.fast.ai/callbacks.html#OneCycleScheduler) callbacks</td>
      <td>--</td>
