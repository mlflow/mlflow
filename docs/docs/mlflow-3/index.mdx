...
This quickstart example demonstrates how to use the LoggedModel lineage feature in MLflow 3.0 with a custom Python model, showcasing its integration with runs and traces.
...
Clicking on the logged model takes you to the model page, where you can view its details, including the model ID, source run, associated metrics, traces and artifacts:
...
<div className="center-div" style={{ width: "100%" }}>
    ![The MLflow UI showing the logged model artifacts](/images/mlflow-3/simple_example_artifacts.png)
</div>
