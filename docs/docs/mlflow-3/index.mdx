...
We strongly recommend upgrading **both client and server** to MLflow 3.0.0 for the best experience. A mismatch between client and server versions may lead to unexpected behavior.
