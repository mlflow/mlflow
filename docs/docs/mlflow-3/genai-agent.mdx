...
**As an initial step, set an active model with <APILink fn="mlflow.set_active_model" /> API to enable linking any traces generated in the app development stage to it.**
