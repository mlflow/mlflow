...
**What's changing:** MLflow Recipes (previously known as MLflow Pipelines) has been completely removed from MLflow ([[#15250](https://github.com/mlflow/mlflow/pull/15250)](https://github.com/mlflow/mlflow/pull/15250)).
...
**What's changing:** The 'routes' and 'route_type' config keys in the gateway server configuration have been removed ([[#15331](https://github.com/mlflow/mlflow/pull/15331)](https://github.com/mlflow/mlflow/pull/15331)).
...
**What's changing:** The MLflow deployment server application and the `start-server` CLI command have been removed ([[#15327](https://github.com/mlflow/mlflow/pull/15327)](https://github.com/mlflow/mlflow/pull/15327)).
...
**What's changing:** The `fastai` model flavor has been completely removed ([[#15255](https://github.com/mlflow/mlflow/pull/15255)](https://github.com/mlflow/mlflow/pull/15255)).
...
**What's changing:** The `mleap` flavor has been removed from MLflow ([[#15259](https://github.com/mlflow/mlflow/pull/15259)](https://github.com/mlflow/mlflow/pull/15259)).
...
**What's changing:** The `run_uuid` attribute has been removed from the `RunInfo` object ([[#15342](https://github.com/mlflow/mlflow/pull/15342)](https://github.com/mlflow/mlflow/pull/15342)).
...
**What's changing:** The run tags `mlflow.gitBranchName` and `mlflow.gitRepoURL` have been removed ([[#15366](https://github.com/mlflow/mlflow/pull/15366)](https://github.com/mlflow/mlflow/pull/15366)).
...
**What's changing:** The `every_n_iter` parameter has been removed from TensorFlow autologging ([[#15412](https://github.com/mlflow/mlflow/pull/15412)](https://github.com/mlflow/mlflow/pull/15412)).
...
- `example_no_conversion` parameter from model logging APIs ([[#15322](https://github.com/mlflow/mlflow/pull/15322)](https://github.com/mlflow/mlflow/pull/15322))
- `code_path` parameter from model logging and model saving APIs ([[#15368](https://github.com/mlflow/mlflow/pull/15368)](https://github.com/mlflow/mlflow/pull/15368))
- `requirements_file` parameter from `pytorch` flavor model logging and saving APIs ([[#15369](https://github.com/mlflow/mlflow/pull/15369)](https://github.com/mlflow/mlflow/pull/15369))
- `inference_config` parameter from `transformers` flavor model logging and saving APIs ([[#15415](https://github.com/mlflow/mlflow/pull/15415)](https://github.com/mlflow/mlflow/pull/15415))
...
**What's changing:** The `signature_dict` property has been removed from the `ModelInfo` object ([[#15367](https://github.com/mlflow/mlflow/pull/15367)](https://github.com/mlflow/mlflow/pull/15367)).
...
**What's changing:** The `baseline_model` parameter and related parameters have been removed from the evaluation API ([[#15362](https://github.com/mlflow/mlflow/pull/15362)](https://github.com/mlflow/mlflow/pull/15362)).
...
**What's changing:** The `higher_is_better` parameter has been removed from the constructor of class `MetricThreshold` ([[#15343](https://github.com/mlflow/mlflow/pull/15343)](https://github.com/mlflow/mlflow/pull/15343)).
...
**What's changing:** The `custom_metrics` parameter has been removed from the evaluation API ([[#15361](https://github.com/mlflow/mlflow/pull/15361)](https://github.com/mlflow/mlflow/pull/15361)).
...
**What's changing:** The environment variable `MLFLOW_GCS_DEFAULT_TIMEOUT` configuration has been removed ([[#15365](https://github.com/mlflow/mlflow/pull/15365)](https://github.com/mlflow/mlflow/pull/15365)).
...
For detailed guidance on migrating specific code, please consult the [[MLflow 3.0 documentation](https://mlflow.org/docs/3.0.0/index.html)](https://mlflow.org/docs/3.0.0/index.html) or join the [[MLflow community forum](https://github.com/mlflow/mlflow/discussions)](https://github.com/mlflow/mlflow/discussions) for assistance.
