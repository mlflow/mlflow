            ...
            items: [
                {
                    type: 'link',
                    label: 'Python API',
                    href: "".concat(apiReferencePrefix(), "api_reference/python_api/index.html"),
                },
                {
                    type: 'link',
                    label: 'Java API',
                    href: "".concat(apiReferencePrefix(), "api_reference/java_api/index.html"),
                },
                {
                    type: 'link',
                    label: 'R API',
                    href: "".concat(apiReferencePrefix(), "api_reference/R-api.html"),
                },
                {
                    type: 'link',
                    label: 'REST API',
                    href: "".concat(apiReferencePrefix(), "api_reference/rest-api.html"),
                },
                {
                    type: 'link',
                    label: 'CLI',
                    href: "".concat(apiReferencePrefix(), "cli.html"),
                },
            ],
        },
        {
