      ...
      items: [
        {
          ...
          items: [
            ...
            {
              type: 'doc',
              id: 'human-feedback/expert-feedback/label-existing-traces',
            },
            {
              type: 'doc',
              id: 'human-feedback/expert-feedback/live-app-testing',
            },
            {
              type: 'doc',
        ...
        {
          type: 'category',
          label: 'Concepts & References',
          items: [
            {
              type: 'autogenerated',
              dirName: 'human-feedback/concepts',
            }
          ]
        },
      ],
