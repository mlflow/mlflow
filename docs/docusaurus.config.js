...
var baseUrl = ((_a = process.env.DOCS_BASE_URL) !== null && _a !== void 0 ? _a : '/').replace(/\/?$/, '/');
var config = {
    title: 'MLflow',
    ...
    themeConfig: {
        ...
        navbar: {
            ...
            items: [
                ...
                {
                    to: "".concat(apiReferencePrefix(), "api_reference/index.html"),
                    position: 'left',
                    label: 'API Reference',
                },
                {
        ...
        footer: {
            ...
            copyright: "Copyright \u00A9 ".concat(new Date().getFullYear(), " MLflow Project, a Series of LF Projects, LLC."),
        },
        prism: {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/, postProcessSidebar(sidebarItems)];
                            }
                        });
                    });
                },
