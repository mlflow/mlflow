...
Please also follow the recommendations from the [Advanced R - Style Guide](http://adv-r.had.co.nz/Style.html) regarding naming and styling, run `lintr::lint_package()` to find styling issues.
