...
- [Tracking] Move non-util functions in `mlflow/data/digest_utils.py` into its own module (#11269, @chenmoneygithub)
- [Docs / Models] Merge PEFT feature branch (#11240, @B-Step62)
- [UI] MLflow UI Sync (#11233, @daniellok-db)
- [] Add an API to enable async logging (#11138, @chenmoneygithub)
- [] Make it possible to log a dataset without loading anything (#11172, @chenmoneygithub)
- [Tracking] Keras automatic checkpoint (#11197, @WeichenXu123)
- [Server-infra] Increase GetMetricHistoryBulk request limit to 100 (#11231, @daniellok-db)
...
- [Tracking] Support derived metrics (#10812, @annzhang-db)
...
- [Deployments] Gateway streaming for Cohere (#10856, @gabrielfu)

Bug fixes:

- [Model Registry] Fix ignorance of the default credential file in model registry (#11261, @B-Step62)
- [] Fix issue with aliases not appearing in table of model versions within registered model detail page (#11223, @smurching)
- [Models] Call load_context() when enforcing ChatModel output (#11150, @daniellok-db)
- [] Fix keras output dtype in signature (#11230, @chenmoneygithub)
...
- [] Fix dbutils error in universe driver local suite (#11060, @WeichenXu123)
- [] Improve the auth validation for `mlflow.login()` (#11039, @chenmoneygithub)
...
- [] Make RestException pickleable (#10936, @WeichenXu123)
- [] Handle unrecognized response error code (#10918, @chenmoneygithub)
