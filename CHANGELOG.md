...
- [Tracing] feat(ts-sdk): add `MLFLOW_WORKSPACE` support to OSS auth provider (#23927, @Nehanth)
- [] Add cached token pricing to Databricks model catalog (#23901, @TomeHirata)
...
- [] Add rule-based built-in scorers: `RegexMatch`, `PIIDetection`, `ResponseLength` (#22571, @debu-sinha)
...
- [] Add MlflowWalSpanExporter to hand traces off to the WAL daemon (#23641, @aaronteo-db)
...
- [] Add OpenAI `/responses/compact` passthrough route to AI Gateway (#23353, @id-jazzx)
- [] Add 21 new models to Databricks model catalog (#23520, @TomeHirata)
...
- [] Fix JSON response format for Gemini and Anthropic gateway providers (#23932, @tanghaoji)
...
- [] Fix AI Gateway SSE large-frame read limit (#23880, @yashjiv15-jazzx)
- [Evaluation] Honor `OPENAI_BASE_URL` env var in OpenAI provider config (#23862, @B-Step62)
- [Build] fix: @mlflow/XXXX package root points to missing dist/index.js (#23874, @WeichenXu123)
- [Build] Add auth extra for full docker image (#23892, @WeichenXu123)
- [] Return 404 for missing Azure blob artifacts (#23832, @feynmanliang)
...
- [] Expose workspace on experiment response (#23593, @joshuawong-db)
- [] fix: handle missing clipboard API in insecure HTTP contexts (#23598) (#23601, @srinjoy356)
...
- [Tracing] fix: extend `mlflow.sourceRun` metrics filter to cover post-hoc linked OTLP traces (#23591, @RudraDudhat2509)
- [Tracing] fix: UI does not show Judge costs (#23586, @WeichenXu123)
...
- [Docs] docs: document MLFLOW_STATIC_PREFIX behavior change in migration guide (#23851, @Sanket2329)
