...
- [] Complete Bedrock provider with Converse API support (#21999, @TomeHirata)
- [] Add native Vertex AI gateway provider (#21998, @TomeHirata)
- [] Add native Databricks gateway provider (#21997, @TomeHirata)
- [] Add native Ollama gateway provider (#21995, @TomeHirata)
- [] Add native xAI (Grok) gateway provider (#21993, @TomeHirata)
...
- [UI] feat: add multi metric bar chart support (#21258, @RenzoMXD)
- [Tracking] Add TCP keepalive to HTTP sessions to detect stale connections and reduce timeout hangs (#21514, @mobaniha)
- [Evaluation] Feature/proxy url make judge (#21185, @yukimori)
...
- [] Support `tool_reference` content blocks in Anthropic Chat UI parser (#22331, @B-Step62)
- [Tracing] Fix online scoring failure when trace spans are stored in artifact repo (#20784, @Mr-Neutr0n)
- [] Fix: adding a tag with a key but empty value in the Experiments table silently failed with no user feedback (#22320, @WeichenXu123)
- [Docs / Models] Bump minimum `uv` version requirement from `0.5.0` to `0.6.10` (#22313, @copilot-swe-agent)
- [Scoring] fix(pyfunc): exclude Serverless from `use_dbconnect_artifact` path in `spark_udf` (#22300, @franciffu723)
...
- [Tracing / Tracking] Add trace_location parameter to create_experiment (#22075, @dbrx-euirim)
- [] Fix discovery pipeline `_call_llm_via_gateway` to handle `gateway:/` URIs (#22153, @TomeHirata)
...
- [] Fix misleading `"Discarded unknown message"` log in Anthropic gateway provider (#21942, @copilot-swe-agent)
...
- [] Enforce auth on logged model artifact download AJAX endpoint (#21708, @B-Step62)
...
- [] Fix `build-system` in `examples/uv-dependency-management/pyproject.toml` (#21752, @copilot-swe-agent)
...
- [] Fix `MLFLOW_ENABLE_ASYNC_TRACE_LOGGING` docs to reflect OSS default behavior (#21731, @copilot-swe-agent)
