...
MLflow 3.9.0 includes several major features and improvements

Features:

- [Docs / Evaluation] Parallelize LLM calls in MemAlign guideline distillation (#20291, @veronicalyu320)
...
- [Tracking] Add skops saving format for lightgbm flavor (#20151, @WeichenXu123)
- [Docs / Evaluation] Documentation for online evaluation / scoring (#20103, @dbczumar)
- [UI] Current Page context to assistant (#20139, @joelrobin18)
- [Evaluation / Prompts / Tracing] Add GePaAlignmentOptimizer for judge instruction optimization (#19882, @alkispoly-db)
...
- [Models] Safe model serialization: Support saving pytorch model via `torch.export.save` (#19692, @WeichenXu123)
...
- [] Fix Anthropic and Gemini streaming for LiteLLM providers (#20398, @TomeHirata)
...
- [] Fix Vertex AI model configuration (#20242, @TomeHirata)
...
- [] Move gateway invocation validation to fastapi middleware (#20111, @TomeHirata)
...
- [] Remove MLflow-specific auth_mode from LiteLLMConfig (#20059, @TomeHirata)
