...
## 1.25.2.dev0 (2022-05-13)

MLflow 1.25.2.dev0 includes several major features and improvements:

Features:

- Add endpoint changes to the deployment CLI. (#5731, @trangevi)
- Dev env setup script (#5717, @BenWilson2)
- Update mlflow.set_tracking_uri to support pathlib.Path (#5820) (#5824, @cacharle)
- Scoring server timeout #5381 (#5663, @sniafas)
- [FIX-5789] Added sticky header to experiment run list (#5818, @hubertzub-db)
- Added mechanism to delete artifacts from GCS repository using MLFlow garbage collection (#5811, @aditya-iyengar-rtl-de)
- Pass in the `pos_label` parameter to `eval_and_log_metrics` (#5807, @yxiong)
- Show latest, minimum and maximum metric values on metric page (#5574, @adamreeve)
- Autologging of input example and signature for pyspark ml (#5719, @bali0019)
- Add virtualenv support for `mlflow models docker-build` (#5728, @harupy)
- feat: support using wildcards in log_model_allowlist (#5723, @serena-ruan)
- Add virtualenv support for MLflow projects (#5631, @harupy)
- Document virtualenv suppport for MLflow projects (#5727, @harupy)
- Make `pyfunc.spark_udf` support virtualenv (#5676, @WeichenXu123)
- Added autologging of input example and signature for tf.estimator and keras fit_generator (#5510, @bali0019)
- Adds JSON Schema Validation (#5458, @mrkaye97)
- Update UI (#5711, @harupy)
- Introducing abstract endpoint methods (#5378, @trangevi)
- Adding end time and run duration to Compare Runs view (#3378, @RealArpanBhattacharya)
- Use schema when parsing csv (#5531, @vvijay-bolt)

Bug fixes and documentation updates:

- Spark Datasource autologging: Fix REPL ID propagation from datasource listener to publisher (#5826, @dbczumar)
- Update ag-grid and implement getRowId to improve runs table performance (#5725, @adamreeve)
- Fix tf-serving parsing when input are columnar formatter (#5825, @arjundc-db)
- Fix log_artifact for large model in HDFS (#5812, @hitchhicker)
- fix metric names with "@" signs for lightgbm autolog (#5785, @mengchendd)
- Pyfunc: Fix code dir resolution of subdirectories (#5806, @dbczumar)
- fix: fix mlflow server starts in R on windows (#5767, @serena-ruan)
- Preview images with full width (#5606, @szczeles)
- When loading spark model, bind spark.driver.bindAddress to 127.0.0.1 (#5753, @WeichenXu123)
- Added autologging safety validation exemptions, and fixed autolog does not log implicit batch_size for tf keras fit method (#5683, @MarkYHZhang)
- Adds JSON Schema Validation (#5458, @mrkaye97)
- #4299 log_batch actually writes in batches (#5460, @erensahin)
- Scoring server timeout #5381 (#5663, @sniafas)

Small bug fixes and doc updates (#5854, #5845, #5829, #5842, #5834, #5795, #5777, #5794, #5766, #5778, #5765, #5763, #5768, #5769, #5760, #5727, #5748, #5726, #5721, #5710, #5708, #5703, #5702, #5696, #5695, #5380, #5669, #5670, #5668, #5661, #5638, @harupy; #5749, @arpitjasa-db; #5675, @Davidswinkels; #5743, @kzhang01; #5650, #5805, #5724, #5720, #5662, @BenWilson2; #5627, @cterrelljones; #5646, @kutal10; #5758, @davideli-db; #5810, @rahulporuri; #5816, #5764, @shrinath-suresh; #5803, #5797, @ahlag; #5715, #5737, #5752, #5677, #5636, @WeichenXu123; #5735, @subramaniam02; #5746, @akaigraham; #5734, #5685, @lucalves; #5761, @marcelatoffernet; #5707, @aashish-khub; #5808, @ketangangal; #5730, #5700, @shaikmoeed; #5775, @dbczumar; #5747, @zhixuanevelynwu)
