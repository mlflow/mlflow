...
- [Recipes] Support custom data splitting logic in the Classification and Regression Recipes (#7588, @sunishsheth2009)
- [Recipes] Introduce customizable MLflow Run names for recipes (#7746, @kamalesh0406)
...
- [Model Registry / Java] Introduce the ``searchModelVersions()`` API to the Java client (#7880, @gabrielfu)
...
- [Scoring] Publish official Docker images for MLflow Model scoring server at github.com/mlflow/mlflow/pkgs (#7759, @dbczumar)

Bug fixes:

- [Model Registry] Fix handling of deleted model versions in FileStore (#7716, @harupy)
- [Model Registry] Correctly initialize SQL databases when separate tracking and registry storage are used (#7704, @harupy)
