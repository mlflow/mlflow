...
- [Tracking] Supporting kwargs in log figure (#9179, @stroblme)
- [Gateway] Add support for MLflow serving to MLflow AI Gateway (#9199, @BenWilson2)
- [Artifacts] Add progress bar (#9195, @serena-ruan)
- [Models] Support logging the retriever model (#8808, @liangz1)
- [Tracking] Add support to log customized tags to runs created by autolog (#9114, @thinkall)
- [Models / Scoring] Inference params support (#9068, @serena-ruan)

Bug fixes:

- [] Enable F402 (#9305, @KekmaTime)
...
- [Models] Mark mleap as deprecated (#9311, @BenWilson2)
