...
- [Build] Docker compose (#17065, @joelrobin18)
...
- [] Fix version selector on API Reference page by adding missing CSS class and versions.json generation (#17247, @copilot-swe-agent)
