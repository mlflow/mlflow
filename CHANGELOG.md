...
- 🔍 **Automatic Issue Identification**: Let AI identify quality issues in your traces automatically! Use LLM judges to analyze your traces and surface potential problems across categories like quality, safety, and performance directly from the UI. Issues are linked to traces for easy investigation, with comprehensive support for viewing and managing discovered issues in the traces table. (#21431, #21204, #21165, #21163, #21161, @smoorjani, @serena-ruan)
