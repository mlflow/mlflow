...
protoc -I="$PROTOS" \
    ...
    "$PROTOS"/databricks_fs_service.proto
...
sed -i'.old' -e "s/$OLD_SCALAPB/$NEW_SCALAPB/g" "$PROTOS/databricks_pb2.py" "$PROTOS/service_pb2.py" "$PROTOS/model_registry_pb2.py" "$PROTOS/databricks_artifacts_pb2.py" "$PROTOS/mlflow_artifacts_pb2.py" "$PROTOS/internal_pb2.py" "$PROTOS/databricks_managed_catalog_service_pb2.py" "$PROTOS/databricks_managed_catalog_messages_pb2.py" "$PROTOS/databricks_uc_registry_service_pb2.py" "$PROTOS/databricks_uc_registry_messages_pb2.py" "$TEST_PROTOS/test_message_pb2.py" "$PROTOS/databricks_fs_service_pb2.py"
...
sed -i'.old' -e "s/$OLD_DATABRICKS_UC_REGISTRY/$NEW_DATABRICKS_UC_REGISTRY/g"  "$PROTOS/databricks_uc_registry_service_pb2.py" "$PROTOS/databricks_uc_registry_messages_pb2.py"  "$TEST_PROTOS/test_message_pb2.py" "$PROTOS/databricks_fs_service_pb2.py"
...
rm "$PROTOS/databricks_fs_service_pb2.py.old"
