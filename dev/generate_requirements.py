...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        required=True,
        help="Local directory path where the generated requirements.txt files will be saved.",
    )
    parser.add_argument(
        "--package-names",
...
def main(args):
    ...
    for package_name in args.package_names:
        package_yaml_path = os.path.join(
            args.requirements_yaml_location, f"{package_name}-requirements.yaml"
        )
        ...
        output_txt_path = os.path.join(
            args.requirements_txt_output_location, f"{package_name}-requirements.txt"
        )
