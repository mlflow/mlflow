...
"""
    ...
    assert violations[0].loc == Location(Offset(1, 33))  # callable
    assert violations[1].loc == Location(Offset(1, 46))  # callable
    assert violations[2].loc == Location(Offset(4, 28))  # any
    assert violations[3].loc == Location(Offset(4, 36))  # any
