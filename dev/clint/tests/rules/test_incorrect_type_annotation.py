...
"""
    ...
    assert violations[0].loc == Range(Position(1, 33))  # callable
    assert violations[1].loc == Range(Position(1, 46))  # callable
    assert violations[2].loc == Range(Position(4, 28))  # any
    assert violations[3].loc == Range(Position(4, 36))  # any
