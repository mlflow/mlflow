...
"""
    ...
    assert (violations[0].loc.lineno, violations[0].loc.col_offset) == (1, 33)  # callable
    assert (violations[1].loc.lineno, violations[1].loc.col_offset) == (1, 46)  # callable
    assert (violations[2].loc.lineno, violations[2].loc.col_offset) == (4, 28)  # any
    assert (violations[3].loc.lineno, violations[3].loc.col_offset) == (4, 36)  # any
