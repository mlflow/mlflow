...
"""
    ...
    assert violations[0].rng == Range(Position(4, 1))  # @experimental without args
    assert violations[1].rng == Range(Position(9, 1))  # @experimental() without version
    assert violations[2].rng == Range(Position(14, 1))  # invalid version format
    assert violations[3].rng == Range(Position(19, 1))  # pre-release version
    assert violations[4].rng == Range(Position(24, 1))  # non-string version
