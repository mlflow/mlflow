...
"""
    ...
    assert violations[0].loc == Location(Position(4, 0))  # mlflow.set_active_model call
    assert violations[1].loc == Location(Position(10, 0))  # from mlflow import set_active_model
    assert violations[2].loc == Location(Position(11, 0))  # direct set_active_model call
