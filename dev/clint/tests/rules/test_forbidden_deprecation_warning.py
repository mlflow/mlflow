...
"""
    ...
    assert (results[0].loc.lineno, results[0].loc.col_offset) == (4, 34)  # First warnings.warn call
    assert (results[1].loc.lineno, results[1].loc.col_offset) == (
        7,
        13,
    )  # Second warnings.warn call
