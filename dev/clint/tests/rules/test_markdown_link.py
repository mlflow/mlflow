...
'''
    ...
    assert (violations[0].loc.lineno, violations[0].loc.col_offset) == (3, 4)
    assert (violations[1].loc.lineno, violations[1].loc.col_offset) == (8, 4)
    assert (violations[2].loc.lineno, violations[2].loc.col_offset) == (13, 4)
