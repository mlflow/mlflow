...
def test_os_chdir_in_test(index: SymbolIndex) -> None:
    code = """
import os
...
def test_os_chdir_in_test_with_from_import(index: SymbolIndex) -> None:
    code = """
...
def test_os_chdir_in_test_no_violation_outside_test(index: SymbolIndex) -> None:
    code = """
import os
...
def test_os_chdir_in_test_with_alias(index: SymbolIndex) -> None:
    code = """
...
def test_os_chdir_in_test_nested_functions_not_caught(index: SymbolIndex) -> None:
    """
...
def test_os_chdir_not_os_module(index: SymbolIndex) -> None:
    code = """
class FakeOs:
    @staticmethod
    def chdir(path):
