...
def test_git_ls_files_empty_output():
...
def test_git_ls_files_with_pathspecs():
...
def test_git_ls_files_subprocess_error():
...
def test_git_ls_files_os_error():
...
def test_resolve_paths_default_current_dir():
...
def test_resolve_paths_filters_by_extension():
...
def test_resolve_paths_case_insensitive_extensions():
...
def test_resolve_paths_filters_non_existent_files():
...
def test_resolve_paths_returns_sorted_list():
...
def test_resolve_paths_deduplicates_results():
...
def test_resolve_paths_with_multiple_pathspecs():
