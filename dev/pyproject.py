...
class PackageType(Enum):
    ...
    RELEASE = "release"
    DEV = "dev"
    # NB: pyproject.toml for mlflow-tracing sub package is maintained manually because
    # it has carefully curated dependencies and modules, as well as hand-crafted
    # README to explain the purpose of the package.
