...
| :------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------- |
| `MLFLOW_TRACES_DESTINATION`            | Global destination URI for the trace repository (trace span storage). Overridable per workspace via `workspaces.traces_destination`.                                                                                   | Same as `--artifact-destination` |
