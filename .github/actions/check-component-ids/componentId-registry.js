...
module.exports = {
  ...
  "account.new_password": "New-password input on the change-password form",
  "account.no_user": "Empty state shown when no user cookie is present",
  "account.role_admin_tag": "Tag indicating the user has the workspace-admin role",
  "account.roles.admin_header": "'Admin' column header on the user's roles table",
  "account.roles.name_header": "'Name' column header on the user's roles table",
  "account.roles.workspace_header": "'Workspace' column header on the user's roles table",
  "admin.role.add_permission_button": "Button that opens the add-permission modal",
  "admin.role.add_permission_level": "Permission-level select inside the add-permission modal",
  "admin.role.add_permission_modal": "Modal for adding a permission row to a role",
  "admin.role.add_permission_pattern": "Resource-pattern input inside the add-permission modal",
  "admin.role.add_permission_resource_type": "Resource-type select inside the add-permission modal",
  "admin.role.admin_tag": "Tag rendered next to a role that grants workspace-admin",
  "admin.role.assign_user_button": "Button that opens the assign-user modal",
  "admin.role.assign_user_modal": "Modal for assigning a user to a role",
  "admin.role.assign_user_select": "Username select inside the assign-user modal",
  "admin.role.assigned_actions_header": "'Actions' column header on the assigned-users table",
  "admin.role.assigned_user_id_header": "'User ID' column header on the assigned-users table",
  "admin.role.assigned_username_header": "'Username' column header on the assigned-users table",
  "admin.role.assignments.error": "Inline error alert on the assigned-users section",
  "admin.role.assignments.fetch_error": "Error alert shown when fetching role assignments fails",
  "admin.role.breadcrumb_admin": "Breadcrumb link back to the admin page from role detail",
  "admin.role.edit_button": "Button that opens the edit-role modal",
  "admin.role.edit_description": "Description input inside the edit-role modal",
  "admin.role.edit_modal": "Modal for editing role metadata",
  "admin.role.edit_name": "Name input inside the edit-role modal",
  "admin.role.edit_permission_button": "Button that opens the edit-permission modal for a row",
  "admin.role.edit_permission_level": "Permission-level select inside the edit-permission modal",
  "admin.role.edit_permission_modal": "Modal for editing an existing permission row on a role",
  "admin.role.error": "Inline error alert on the role detail page",
  "admin.role.invalid_id": "Empty state shown when the role_id URL param is invalid",
  "admin.role.load_error": "Error alert shown when role data fails to load",
  "admin.role.perm_actions_header": "'Actions' column header on the role permissions table",
  "admin.role.perm_permission_header": "'Permission' column header on the role permissions table",
  "admin.role.perm_resource_pattern_header":
    "'Resource pattern' column header on the role permissions table",
  "admin.role.perm_resource_type_header":
    "'Resource type' column header on the role permissions table",
  "admin.role.permission_level_tag": "Tag rendering a permission level on a row",
  "admin.role.permission_resource_type_tag": "Tag rendering a resource type on a permission row",
  "admin.role.permissions.error": "Inline error alert on the permissions section",
  "admin.role.remove_permission_button":
    "Button that opens the remove-permission confirmation modal",
  "admin.role.remove_permission_modal": "Confirmation modal for removing a permission row",
  "admin.role.unassign_button": "Unassign-user button on an assigned-users row",
  ...
  "admin.roles.create_name": "Name input inside the create-role modal",
  "admin.roles.create_workspace": "Workspace input inside the create-role modal",
  "admin.roles.delete_button": "Button that opens the delete-role confirmation modal",
  "admin.roles.delete_modal": "Confirmation modal for deleting a role",
  "admin.roles.description_header": "'Description' column header on the roles list table",
  "admin.roles.error": "Inline error alert on the roles tab",
  ...
  "admin.users.create_password": "Password input inside the create-user modal",
  "admin.users.create_username": "Username input inside the create-user modal",
  ...
  "dev.user_switcher.admin_tag": "Tag indicating an admin user inside the dev user switcher",
  "dev.user_switcher.error": "Inline error alert inside the dev user switcher",
  "dev.user_switcher.password_input": "Password input inside the dev user switcher modal",
  "dev.user_switcher.password_modal": "Password-prompt modal inside the dev user switcher",
  ...
  // -- mlflow.sidebar --
  "mlflow.sidebar.account_tab_link": "Sidebar link to the Account page",
  "mlflow.sidebar.admin_tab_link": "Sidebar link to the Admin page (admin-only)",
