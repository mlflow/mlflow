...
class ColSpec(object):
    ...
    def __init__(
        ...
        if not isinstance(self.type, DataType):
            raise TypeError(
                "Expected mlflux.models.signature.Datatype or str for the 'type' "
...
class TensorInfo(object):
    ...
    def __init__(
        ...
        if dtype.char in ["U", "S"] and not dtype.name.isalpha():
            raise MlflowException(
                "mlflux does not support size information in flexible numpy data types. Use"
...
class Schema(object):
    ...
    @property
    @deprecated(alternative="mlflux.types.Schema.inputs", since="1.14")
    def columns(self) -> List[ColSpec]:
        """
        .. deprecated:: 1.14
          Please use :func:`mlflux.types.Schema.inputs`
    ...
    @deprecated(alternative="mlflux.types.Schema.input_names", since="1.14")
    def column_names(self) -> List[Union[str, int]]:
        """
        .. deprecated:: 1.14
          Please use :func:`mlflux.types.Schema.input_names()`
    ...
    @deprecated(alternative="mlflux.types.Schema.has_input_names", since="1.14")
    def has_column_names(self) -> bool:
        """
        .. deprecated:: 1.14
          Please use :func:`mlflux.types.Schema.has_input_names()`
    ...
    @deprecated(alternative="mlflux.types.Schema.input_types", since="1.14")
    def column_types(self) -> List[DataType]:
        """
        .. deprecated:: 1.14
          Please use :func:`mlflux.types.Schema.input_types()`
