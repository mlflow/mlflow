...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='mlflux',
  syntax='proto2',
  serialized_options=_b('\n\037com.databricks.api.proto.mlflux\220\001\001\240\001\001\342?\002\020\001'),
  serialized_pb=_b('\n\x1a\x64\x61tabricks_artifacts.proto\x12\x06mlflow\x1a\x15scalapb/scalapb.proto\x1a\x10\x64\x61tabricks.proto\"\xdf\x01\n\x16\x41rtifactCredentialInfo\x12\x0e\n\x06run_id\x18\x01 \x01(\t\x12\x0c\n\x04path\x18\x02 \x01(\t\x12\x12\n\nsigned_uri\x18\x03 \x01(\t\x12:\n\x07headers\x18\x04 \x03(\x0b\x32).mlflux.ArtifactCredentialInfo.HttpHeader\x12,\n\x04type\x18\x05 \x01(\x0e\x32\x1e.mlflux.ArtifactCredentialType\x1a)\n\nHttpHeader\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t\"\x95\x02\n\x15GetCredentialsForRead\x12\x14\n\x06run_id\x18\x01 \x01(\tB\x04\xf8\x86\x19\x01\x12\x0c\n\x04path\x18\x02 \x03(\t\x12\x12\n\npage_token\x18\x03 \x01(\t\x1a\x63\n\x08Response\x12\x38\n\x10\x63redential_infos\x18\x02 \x03(\x0b\x32\x1e.mlflux.ArtifactCredentialInfo\x12\x17\n\x0fnext_page_token\x18\x03 \x01(\tJ\x04\x08\x01\x10\x02:_\xe2?(\n&com.databricks.rpc.RPC[$this.Response]\xe2?1\n/com.databricks.mlflux.api.MlflowTrackingMessage\"\x96\x02\n\x16GetCredentialsForWrite\x12\x14\n\x06run_id\x18\x01 \x01(\tB\x04\xf8\x86\x19\x01\x12\x0c\n\x04path\x18\x02 \x03(\t\x12\x12\n\npage_token\x18\x03 \x01(\t\x1a\x63\n\x08Response\x12\x38\n\x10\x63redential_infos\x18\x02 \x03(\x0b\x32\x1e.mlflux.ArtifactCredentialInfo\x12\x17\n\x0fnext_page_token\x18\x03 \x01(\tJ\x04\x08\x01\x10\x02:_\xe2?(\n&com.databricks.rpc.RPC[$this.Response]\xe2?1\n/com.databricks.mlflux.api.MlflowTrackingMessage*V\n\x16\x41rtifactCredentialType\x12\x11\n\rAZURE_SAS_URI\x10\x01\x12\x15\n\x11\x41WS_PRESIGNED_URL\x10\x02\x12\x12\n\x0eGCP_SIGNED_URL\x10\x03\x32\xe4\x02\n DatabricksMlflowArtifactsService\x12\x9c\x01\n\x15getCredentialsForRead\x12\x1d.mlflux.GetCredentialsForRead\x1a&.mlflux.GetCredentialsForRead.Response\"<\xf2\x86\x19\x38\n4\n\x04POST\x12&/mlflux/artifacts/credentials-for-read\x1a\x04\x08\x02\x10\x00\x10\x03\x12\xa0\x01\n\x16getCredentialsForWrite\x12\x1e.mlflux.GetCredentialsForWrite\x1a\'.mlflux.GetCredentialsForWrite.Response\"=\xf2\x86\x19\x39\n5\n\x04POST\x12\'/mlflux/artifacts/credentials-for-write\x1a\x04\x08\x02\x10\x00\x10\x03\x42,\n\x1f\x63om.databricks.api.proto.mlflux\x90\x01\x01\xa0\x01\x01\xe2?\x02\x10\x01')
  ,
...
_ARTIFACTCREDENTIALTYPE = _descriptor.EnumDescriptor(
  ...
  full_name='mlflux.ArtifactCredentialType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_ARTIFACTCREDENTIALINFO_HTTPHEADER = _descriptor.Descriptor(
  name='HttpHeader',
  full_name='mlflux.ArtifactCredentialInfo.HttpHeader',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='mlflux.ArtifactCredentialInfo.HttpHeader.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='mlflux.ArtifactCredentialInfo.HttpHeader.value', index=1,
...
_ARTIFACTCREDENTIALINFO = _descriptor.Descriptor(
  ...
  full_name='mlflux.ArtifactCredentialInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_id', full_name='mlflux.ArtifactCredentialInfo.run_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='path', full_name='mlflux.ArtifactCredentialInfo.path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='signed_uri', full_name='mlflux.ArtifactCredentialInfo.signed_uri', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='headers', full_name='mlflux.ArtifactCredentialInfo.headers', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='mlflux.ArtifactCredentialInfo.type', index=4,
...
_GETCREDENTIALSFORREAD_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflux.GetCredentialsForRead.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='credential_infos', full_name='mlflux.GetCredentialsForRead.Response.credential_infos', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='mlflux.GetCredentialsForRead.Response.next_page_token', index=1,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETCREDENTIALSFORREAD = _descriptor.Descriptor(
  ...
  full_name='mlflux.GetCredentialsForRead',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_id', full_name='mlflux.GetCredentialsForRead.run_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='path', full_name='mlflux.GetCredentialsForRead.path', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='mlflux.GetCredentialsForRead.page_token', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETCREDENTIALSFORWRITE_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflux.GetCredentialsForWrite.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='credential_infos', full_name='mlflux.GetCredentialsForWrite.Response.credential_infos', index=0,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='mlflux.GetCredentialsForWrite.Response.next_page_token', index=1,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETCREDENTIALSFORWRITE = _descriptor.Descriptor(
  ...
  full_name='mlflux.GetCredentialsForWrite',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_id', full_name='mlflux.GetCredentialsForWrite.run_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\370\206\031\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='path', full_name='mlflux.GetCredentialsForWrite.path', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='mlflux.GetCredentialsForWrite.page_token', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ArtifactCredentialInfo = _reflection.GeneratedProtocolMessageType('ArtifactCredentialInfo', (_message.Message,), dict(
  ...
  HttpHeader = _reflection.GeneratedProtocolMessageType('HttpHeader', (_message.Message,), dict(
    ...
    # @@protoc_insertion_point(class_scope:mlflux.ArtifactCredentialInfo.HttpHeader)
    ))
  ,
  DESCRIPTOR = _ARTIFACTCREDENTIALINFO,
  __module__ = 'databricks_artifacts_pb2'
  # @@protoc_insertion_point(class_scope:mlflux.ArtifactCredentialInfo)
  ))
...
GetCredentialsForRead = _reflection.GeneratedProtocolMessageType('GetCredentialsForRead', (_message.Message,), dict(
  ...
  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    ...
    __module__ = 'databricks_artifacts_pb2'
    # @@protoc_insertion_point(class_scope:mlflux.GetCredentialsForRead.Response)
    ))
  ,
  DESCRIPTOR = _GETCREDENTIALSFORREAD,
  __module__ = 'databricks_artifacts_pb2'
  # @@protoc_insertion_point(class_scope:mlflux.GetCredentialsForRead)
  ))
...
GetCredentialsForWrite = _reflection.GeneratedProtocolMessageType('GetCredentialsForWrite', (_message.Message,), dict(
  ...
  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    ...
    __module__ = 'databricks_artifacts_pb2'
    # @@protoc_insertion_point(class_scope:mlflux.GetCredentialsForWrite.Response)
    ))
  ,
  DESCRIPTOR = _GETCREDENTIALSFORWRITE,
  __module__ = 'databricks_artifacts_pb2'
  # @@protoc_insertion_point(class_scope:mlflux.GetCredentialsForWrite)
  ))
...
_DATABRICKSMLFLOWARTIFACTSSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='mlflux.DatabricksMlflowArtifactsService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='getCredentialsForRead',
    full_name='mlflux.DatabricksMlflowArtifactsService.getCredentialsForRead',
    index=0,
    containing_service=None,
    input_type=_GETCREDENTIALSFORREAD,
    output_type=_GETCREDENTIALSFORREAD_RESPONSE,
    serialized_options=_b('\362\206\0318\n4\n\004POST\022&/mlflux/artifacts/credentials-for-read\032\004\010\002\020\000\020\003'),
  ),
  _descriptor.MethodDescriptor(
    name='getCredentialsForWrite',
    full_name='mlflux.DatabricksMlflowArtifactsService.getCredentialsForWrite',
    index=1,
    containing_service=None,
    input_type=_GETCREDENTIALSFORWRITE,
    output_type=_GETCREDENTIALSFORWRITE_RESPONSE,
    serialized_options=_b('\362\206\0319\n5\n\004POST\022\'/mlflux/artifacts/credentials-for-write\032\004\010\002\020\000\020\003'),
  ),
])
