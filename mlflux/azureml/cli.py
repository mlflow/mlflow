...
def commands():
    """
    Serve models on Azure ML. **These commands require that mlflux be installed with Python 3.**
...
@commands.command(
    short_help=(
        "Register an mlflux model with Azure ML and build an Azure ML"
...
def build_image(
    ...
    """
    Register an mlflux model with Azure ML and build an Azure ML ContainerImage for deployment.
    ...
    documentation: https://www.mlflux.org/docs/latest/models.html#azureml-deployment.
    """
