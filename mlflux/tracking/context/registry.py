...
class RunContextProviderRegistry(object):
    ...
    information about the context of an mlflux experiment run. Implementations declared though the
    entrypoints `mlflux.run_context_provider` group can be automatically registered through the
    ...
    def register_entrypoints(self):
        ...
        for entrypoint in entrypoints.get_group_all("mlflux.run_context_provider"):
            try:
...
def resolve_tags(tags=None):
    ...
    :py:class:`mlflux.tracking.context.RunContextProvider`.
