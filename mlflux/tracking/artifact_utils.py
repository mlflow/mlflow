...
from mlflux.store.artifact.dbfs_artifact_repo import DbfsRestArtifactRepository
from mlflux.store.artifact.models_artifact_repo import ModelsArtifactRepository
from mlflux.tracking._tracking_service.utils import _get_store
from mlflux.utils.uri import add_databricks_profile_info_to_artifact_uri, append_to_uri_path
...
def _upload_artifacts_to_databricks(
    ...
    try:
        ...
        dest_root = "dbfs:/databricks/mlflux/tmp-external-source/"
