...
class TrackingStoreRegistry(StoreRegistry):
    ...
    `mlflux.tracking_store` group can be automatically registered through the
    ...
    def __init__(self):
        super().__init__("mlflux.tracking_store")
    ...
    def get_store(self, store_uri=None, artifact_uri=None):
        ...
        :return: An instance of `mlflux.store.tracking.AbstractStore` that fulfills the store URI
                 requirements.
        """
