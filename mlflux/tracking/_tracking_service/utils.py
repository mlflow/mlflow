...
from mlflux.store.tracking import DEFAULT_LOCAL_FILE_AND_ARTIFACT_PATH
from mlflux.store.db.db_types import DATABASE_ENGINES
from mlflux.store.tracking.file_store import FileStore
from mlflux.store.tracking.rest_store import RestStore, DatabricksRestStore
from mlflux.tracking._tracking_service.registry import TrackingStoreRegistry
from mlflux.utils import env, rest_utils
...
def set_tracking_uri(uri: str) -> None:
    ...
    .. code-block:: python
        ...
        mlflux.set_tracking_uri("file:///tmp/my_tracking")
