...
from mlflux.protos.databricks_pb2 import RESOURCE_ALREADY_EXISTS, ErrorCode
from mlflux.store.artifact.runs_artifact_repo import RunsArtifactRepository
from mlflux.tracking import MlflowClient
from mlflux.utils.logging_utils import eprint
...
def register_model(
    ...
    .. code-block:: python
        ...
        mlflux.set_tracking_uri("sqlite:////tmp/mlruns.db")
        ...
        with mlflux.start_run() as run:
           ...
           mlflux.sklearn.log_model(rfr, artifact_path="sklearn-model")

        model_uri = "runs:/{}/sklearn-model".format(run.info.run_id)
        mv = mlflux.register_model(model_uri, "RandomForestRegressionModel")
