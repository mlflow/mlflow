"""
Internal package providing a Python CRUD interface to mlflux models and versions.
...
from mlflux.store.model_registry import SEARCH_REGISTERED_MODEL_MAX_RESULTS_DEFAULT
...
from mlflux.tracking._model_registry import utils, DEFAULT_AWAIT_MAX_SLEEP_SECONDS
...
class ModelRegistryClient(object):
    """
    Client of an mlflux Model Registry Server that creates and manages registered
    ...
    def create_registered_model(self, name, tags=None, description=None):
        """
         ...
         :param tags: A dictionary of key-value pairs that are converted into
                      :py:class:`mlflux.entities.model_registry.RegisteredModelTag` objects.
    ...
    def create_model_version(
        ...
        :param tags: A dictionary of key-value pairs that are converted into
                     :py:class:`mlflux.entities.model_registry.ModelVersionTag` objects.
        ...
        :return: Single :py:class:`mlflux.entities.model_registry.ModelVersion` object created by
                 backend.
        """
        tags = tags if tags else {}
    ...
    def search_model_versions(self, filter_string):
        ...
        :param filter_string: A filter string expression. Currently supports a single filter
                              ...
                              ``run_id = '...'``.
        :return: PagedList of :py:class:`mlflux.entities.model_registry.ModelVersion` objects.
        """
