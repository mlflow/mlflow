"""
The ``mlflux.h2o`` module provides an API for logging and loading H2O models. This module exports
...
def save_model(
    ...
    pyfunc.add_to_model(
        mlflow_model, loader_module="mlflux.h2o", data=model_data_subpath, env=conda_env_subpath
    )
...
def log_model(
    ...
    **kwargs
    ...
    """
    Log an H2O model as an mlflux artifact for the current run.
...
def _load_pyfunc(path):
    ...
    :param path: Local filesystem path to the mlflux Model with the ``h2o`` flavor.
    """
