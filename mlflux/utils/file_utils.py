...
from mlflux.exceptions import MissingConfigException
from mlflux.utils.rest_utils import cloud_storage_http_request
...
def _copy_project(src_path, dst_path=""):
    """
    Internal function used to copy mlflux project during development.

    Copies the content of the whole directory tree except patterns defined in .dockerignore.
    The mlflux is assumed to be accessible as a local directory in this case.


    :param dst_path: mlflux will be copied here
    :return: name of the mlflux project directory
    """
