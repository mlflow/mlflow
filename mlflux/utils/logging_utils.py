...
# 2018/11/20 12:36:37 INFO mlflux.sagemaker: Creating new SageMaker endpoint
...
class MlflowLoggingStream:
    """
    A Python stream for use with event logging APIs throughout mlflux (`eprint()`,
...
def disable_logging():
    """
    Disables the `MlflowLoggingStream` used by event logging APIs throughout mlflux
...
def enable_logging():
    """
    Enables the `MlflowLoggingStream` used by event logging APIs throughout mlflux
