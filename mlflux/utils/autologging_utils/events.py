...
class AutologgingEventLogger:
    ...
    def log_autolog_called(self, integration, call_args, call_kwargs):
        ...
        is invoked (e.g., when a user invokes `mlflux.sklearn.autolog()`)
        ...
        :param call_args: **DEPRECATED** The positional arguments passed to the `autolog()` call.
                          This field is empty in mlflux > 1.13.1; all arguments are passed in
        ...
        if len(call_args) > 0:
            warnings.warn(
                ...
                " deprecated in mlflux > 1.13.1, and all arguments should be passed"
