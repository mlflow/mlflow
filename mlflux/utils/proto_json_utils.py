...
def _stringify_all_experiment_ids(x):
    ...
    This is necessary for backwards- and forwards-compatibility with mlflux clients/servers
    running mlflux 0.9.0 and below, as experiment_id was changed from an int to a string.
    ...
    This code can be removed after mlflux 1.0, after users have given reasonable time to
    upgrade clients and servers to mlflux 0.9.1+.
    """
...
def _dataframe_from_json(
    ...
    :param schema: mlflux schema used when parsing the data.
