...
from mlflux.protos.databricks_pb2 import RESOURCE_DOES_NOT_EXIST, INTERNAL_ERROR
from mlflux.deployments.base import BaseDeploymentClient
from mlflux.deployments.utils import parse_target_uri

# TODO: refactor to have a common base class for all the plugin implementation in mlflux
#   mlflux/tracking/context/registry.py
#   mlflux/tracking/registry
#   mlflux/store/artifact/artifact_repository_registry.py
...
class DeploymentPlugins(PluginManager):
    def __init__(self):
        super().__init__("mlflux.deployments")
    ...
    def __getitem__(self, item):
        ...
        try:
            ...
            msg = (
                ...
                "plugin from "
                "https://mlflux.org/docs/latest/plugins.html#community-plugins using "
