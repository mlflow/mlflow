...
from mlflux.tracking import artifact_utils
from mlflux.utils.file_utils import get_local_path_or_none
...
class Project(object):
    ...
    def get_entry_point(self, entry_point):
        ...
        if file_extension in ext_to_cmd:
            ...
            command = "Rscript -e \"mlflux::mlflow_source('%s')\" --args" % quote(entry_point)
            return EntryPoint(name=entry_point, parameters={}, command=command)
        raise ExecutionException(
