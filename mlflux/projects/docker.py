...
from mlflux import tracking
from mlflux.projects.utils import get_databricks_env_vars
from mlflux.exceptions import ExecutionException
from mlflux.projects.utils import MLFLOW_DOCKER_WORKDIR_PATH
from mlflux.tracking.context.git_context import _get_git_commit
from mlflux.utils import process, file_utils
from mlflux.utils.mlflow_tags import MLFLOW_DOCKER_IMAGE_URI, MLFLOW_DOCKER_IMAGE_ID

_logger = logging.getLogger(__name__)

_GENERATED_DOCKERFILE_NAME = "Dockerfile.mlflux-autogenerated"
_MLFLOW_DOCKER_TRACKING_DIR_PATH = "/mlflux/tmp/mlruns"
_PROJECT_TAR_ARCHIVE_NAME = "mlflux-project-docker-build-context"
...
def _create_docker_build_ctx(work_dir, dockerfile_contents):
    ...
    try:
        dst_path = os.path.join(directory, "mlflux-project-contents")
