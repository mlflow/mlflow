from mlflux.entities._mlflow_object import _MLflowObject
...
class RunData(_MLflowObject):
    ...
    def __init__(self, metrics=None, params=None, tags=None):
        """
        Construct a new :py:class:`mlflux.entities.RunData` instance.
        :param metrics: List of :py:class:`mlflux.entities.Metric`.
        :param params: List of :py:class:`mlflux.entities.Param`.
        :param tags: List of :py:class:`mlflux.entities.RunTag`.
        """
