...
class RegisteredModel(_ModelRegistryEntity):
    ...
    mlflux entity for Registered Model.
    """
    ...
    def latest_versions(self):
        """List of the latest :py:class:`mlflux.entities.model_registry.ModelVersion` instances
        for each stage"""
    ...
    def from_proto(cls, proto):
        # input: mlflux.protos.model_registry_pb2.RegisteredModel
    ...
    def to_proto(self):
        # returns mlflux.protos.model_registry_pb2.RegisteredModel
