from mlflux.protos.model_registry_pb2 import ModelVersionStatus as ProtoModelVersionStatus


class ModelVersionStatus(object):
    """Enum for status of an :py:class:`mlflux.entities.model_registry.ModelVersion`."""
