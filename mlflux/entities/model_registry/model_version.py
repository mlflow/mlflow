...
class ModelVersion(_ModelRegistryEntity):
    ...
    mlflux entity for Model Version.
    """
    ...
    @property
    def run_id(self):
        """String. mlflux run ID that generated this model."""
        return self._run_id

    @property
    def run_link(self):
        """String. mlflux run link referring to the exact run that generated this model version."""
    ...
    def from_proto(cls, proto):
        # input: mlflux.protos.model_registry_pb2.ModelVersion
    ...
    def to_proto(self):
        ...
        # returns mlflux.protos.model_registry_pb2.ModelVersion
