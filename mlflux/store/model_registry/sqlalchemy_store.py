...
from mlflux.entities.model_registry.model_version_stages import (
    get_canonical_stage,
...
from mlflux.store.model_registry import (
...
from mlflux.store.model_registry.abstract_store import AbstractStore
...
class SqlAlchemyStore(AbstractStore):
    ...
    SQLAlchemy compliant backend store for tracking meta data for mlflux entities. mlflux
    ...
    This store interacts with SQL store using SQLAlchemy abstractions defined for mlflux entities.
    :py:class:`mlflux.store.model_registry.models.RegisteredModel` and
    :py:class:`mlflux.store.model_registry.models.ModelVersion`
    """
    ...
    def __init__(self, db_uri):
        ...
        :param db_uri: The SQLAlchemy database URI string to connect to the database. See
                       ...
                       for format specifications. mlflux supports the dialects ``mysql``,
        ...
        self.engine = mlflux.store.db.utils.create_sqlalchemy_engine_with_retry(db_uri)
        ...
        self.ManagedSessionMaker = mlflux.store.db.utils._get_managed_session_maker(
        ...
        # mlflux.store.db.utils._verify_schema(self.engine)
    ...
    def _verify_registry_tables_exist(engine):
        ...
        if any([table not in inspected_tables for table in expected_tables]):
            ...
            # mlflux.store.db.utils._initialize_tables(self.engine)
    ...
    def create_registered_model(self, name, tags=None, description=None):
        ...
        :param tags: A list of :py:class:`mlflux.entities.model_registry.RegisteredModelTag`
                     instances associated with this registered model.
        :param description: Description of the version.
        :return: A single object of :py:class:`mlflux.entities.model_registry.RegisteredModel`
    ...
    def update_registered_model(self, name, description):
        ...
        :return: A single updated :py:class:`mlflux.entities.model_registry.RegisteredModel` object.
        """
        with self.ManagedSessionMaker() as session:
    ...
    def list_registered_models(self, max_results, page_token):
        ...
        :return: A PagedList of :py:class:`mlflux.entities.model_registry.RegisteredModel` objects
    ...
    def get_registered_model(self, name):
        ...
        :param name: Registered model name.
        :return: A single :py:class:`mlflux.entities.model_registry.RegisteredModel` object.
        """
        with self.ManagedSessionMaker() as session:
    ...
    def get_latest_versions(self, name, stages=None):
        ...
        :return: List of :py:class:`mlflux.entities.model_registry.ModelVersion` objects.
        """
        with self.ManagedSessionMaker() as session:
            sql_registered_model = self._get_registered_model(session, name)
    ...
    def set_registered_model_tag(self, name, tag):
        ...
        :param name: Registered model name.
        :param tag: :py:class:`mlflux.entities.model_registry.RegisteredModelTag` instance to log.
        :return: None
        """
        _validate_model_name(name)
        _validate_registered_model_tag(tag.key, tag.value)
    ...
    def create_model_version(
        ...
        :param name: Registered model name.
        :param source: Source path where the mlflux model is stored.
        :param run_id: Run ID from mlflux tracking server that generated the model.
        :param tags: A list of :py:class:`mlflux.entities.model_registry.ModelVersionTag`
                     instances associated with this model version.
        :param run_link: Link to the run from an mlflux tracking server that generated this model.
        :param description: Description of the version.
        :return: A single object of :py:class:`mlflux.entities.model_registry.ModelVersion`
                 created in the backend.
        """
    ...
    def _get_sql_model_version_including_deleted(self, name, version):
        ...
        :return: A single :py:class:`mlflux.entities.model_registry.ModelVersion` object.
        """
        with self.ManagedSessionMaker() as session:
            conditions = [
                SqlModelVersion.name == name,
    ...
    def search_model_versions(self, filter_string):
        ...
        :param filter_string: A filter string expression. Currently supports a single filter
                              ...
                              ``run_id = '...'``.
        :return: PagedList of :py:class:`mlflux.entities.model_registry.ModelVersion`
                 objects.
        """
    ...
    def set_model_version_tag(self, name, version, tag):
        ...
        :param name: Registered model name.
        :param version: Registered model version.
        :param tag: :py:class:`mlflux.entities.model_registry.ModelVersionTag` instance to log.
        :return: None
        """
        _validate_model_name(name)
        _validate_model_version(version)
