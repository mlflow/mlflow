...
# https://github.com/mlflux/mlflux/blob/v0.9.1/mlflux/store/dbmodels/models.py, which
# is the first database schema that users could be running. In particular, modifications have
# been made to substitute constants from mlflux with hard-coded values (e.g. replacing
