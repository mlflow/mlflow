...
class SqlExperiment(Base):
    ...
    def to_mlflow_entity(self):
        """
        Convert DB model to corresponding mlflux entity.
...
class SqlRun(Base):
    ...
    def get_attribute_name(mlflow_attribute_name):
        """
        Resolves an mlflux attribute name to a `SqlRun` attribute name.
        """
        # Currently, mlflux Search attributes defined in `SearchUtils.VALID_SEARCH_ATTRIBUTE_KEYS`
    ...
    def to_mlflow_entity(self):
        ...
        :return: :py:class:`mlflux.entities.Run`.
        """
        run_info = RunInfo(
...
class SqlExperimentTag(Base):
    """
    DB model for :py:class:`mlflux.entities.RunTag`.
    ...
    def to_mlflow_entity(self):
        ...
        :return: :py:class:`mlflux.entities.RunTag`.
        """
...
class SqlMetric(Base):
    ...
    def to_mlflow_entity(self):
        ...
        :return: :py:class:`mlflux.entities.Metric`.
        """
        return Metric(
            key=self.key,
...
class SqlParam(Base):
    ...
    def to_mlflow_entity(self):
        ...
        :return: :py:class:`mlflux.entities.Param`.
        """
