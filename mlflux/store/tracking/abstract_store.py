...
class AbstractStore:
    ...
    def get_experiment(self, experiment_id):
        ...
        :return: A single :py:class:`mlflux.entities.Experiment` object if it exists,
    ...
    def update_run_info(self, run_id, run_status, end_time):
        ...
        :return: :py:class:`mlflux.entities.RunInfo` describing the updated run.
        """
        pass
    ...
    def log_metric(self, run_id, metric):
        ...
        :param metric: :py:class:`mlflux.entities.Metric` instance to log
        """
    ...
    def log_param(self, run_id, param):
        ...
        :param run_id: String id for the run
        :param param: :py:class:`mlflux.entities.Param` instance to log
        """
    ...
    def set_experiment_tag(self, experiment_id, tag):
        ...
        :param experiment_id: String id for the experiment
        :param tag: :py:class:`mlflux.entities.ExperimentTag` instance to set
        """
        pass
    ...
    def set_tag(self, run_id, tag):
        ...
        :param run_id: String id for the run
        :param tag: :py:class:`mlflux.entities.RunTag` instance to set
        """
    ...
    def _search_runs(
        ...
        :return: A tuple of ``runs`` and ``token`` where ``runs`` is a list of
            :py:class:`mlflux.entities.Run` objects that satisfy the search expressions,
    ...
    def log_batch(self, run_id, metrics, params, tags):
        ...
        :param run_id: String id for the run
        :param metrics: List of :py:class:`mlflux.entities.Metric` instances to log
        :param params: List of :py:class:`mlflux.entities.Param` instances to log
        :param tags: List of :py:class:`mlflux.entities.RunTag` instances to log
    ...
    def record_logged_model(self, run_id, mlflow_model):
        ...
        maintained in a mlflux.models tag in JSON format.
