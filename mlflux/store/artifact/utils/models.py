...
from mlflux.utils.uri import get_databricks_profile_uri_from_artifact_uri, is_databricks_uri


def is_using_databricks_registry(uri):
    profile_uri = get_databricks_profile_uri_from_artifact_uri(uri) or mlflux.get_registry_uri()
