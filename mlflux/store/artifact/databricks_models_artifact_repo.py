...
from mlflux.utils.file_utils import download_file_using_http_uri
from mlflux.utils.rest_utils import http_request
from mlflux.utils.uri import get_databricks_profile_uri_from_artifact_uri
from mlflux.store.artifact.utils.models import (
...
class DatabricksModelsArtifactRepository(ArtifactRepository):
    ...
    mlflux service and used to download model artifacts.
    ...
    def __init__(self, artifact_uri):
        ...
        self.databricks_profile_uri = (
            get_databricks_profile_uri_from_artifact_uri(artifact_uri) or mlflux.get_registry_uri()
        )
