...
mapping is used to select suitable flavor when deploying generic mlflux models.
...
"""
import mlflux.pyfunc as pyfunc


def get_flavor_backend(model, build_docker=True, **kwargs):
    from mlflux.pyfunc.backend import PyFuncBackend
    from mlflux.rfunc.backend import RFuncBackend
