...
import mlflux
from mlflux.data import is_uri
from mlflux.entities import ViewType
from mlflux.tracking import _get_store, fluent
...
@click.option(
    ...
    "https://mlflux.org/docs/latest/tracking.html#where-runs-are-recorded for "
...
def list_experiments(view):
    ...
    experiments = mlflux.list_experiments(view_type)
    table = [
        [
            exp.experiment_id,
            exp.name,
