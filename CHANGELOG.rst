...
- XGBoost autologging: support per-class importance plots (#4523, @dbczumar)
- Added create/delete registered model to R API (#4483, @bramrodenburg)
- Support setting tags while resuming run (#4497, @dbczumar)
- Syncing with MLFlow and adding i18n support (#4490, @sunishsheth2009)

Bug fixes and documentation updates:

- Fix metrics sorting error on UI (#3409, @harupy)
- Fix autologging event logger log_autolog_called with disable=True (#4494, @dbczumar)
- Syncing with MLFlow and adding i18n support (#4490, @sunishsheth2009)
- [DOCS][MINOR] Minor typo update (#4511, @keypointt)
- Syncing with MLFlow and adding i18n support (#4490, @sunishsheth2009)

Small bug fixes and doc updates (#4541, #4534, #4533, #4517, #4508, #4513, #4512, #4509, #4503, #4486, #4493, #4469, @harupy; #4458, @KasirajanA; #4501, @jimmyxu-db; #4521, #4515, @jerrylian-db; #4359, @shrinath-suresh; #4544, @WeichenXu123; #4549, @smurching; #4554, @derkomai; #4506, @tomasatdatabricks; #4551, #4516, @dbczumar)
