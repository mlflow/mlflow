...
- Adds support for a LightGBM flavor (#2136, @harupy)
- Adds support for a XGBoost flavor (#2124, @harupy)
- Adds support for a Gluon flavor and autologging (#1973, @cosmincatalin)
- Adds TensorFlow.Keras and Keras parameter logging (#2119, @juntai-zheng)
...
- Adds a `--host`/`-host` option to the `mlflow ui` CLI command to allow for user-input IPs to bind to (#2176, @gandroz)
- Supports pulling git submodules while using MLflow Projects (#2103, @badc0re)
- Adds `mlflow models prepare-env` command to do any preparation necessary to initialize an environment. This allows distinguishing configuration and user errors during predict/serve time (#2040, @aarondav)
...
- Improves performance in run requests (#2030, #2059, @jcuquemelle)
- The artifact image viewer nor displays "Loading..." when it is loading an image (#1958, @harupy)
...
- Update active_run() docs to clarify it cannot be used accessing current run data (#2138, @juntai-zheng)
...
- Add and update some screenshots for the model registry. More explicit steps. (#2086, @stbof)
...
Small bug fixes and doc updates (#2142, #2121, #2105, #2069, #2083, #2061, #2022, #2036, #1972, #2034, #1959, @harupy; #2202, @t-henri; #2085, @stbof; #2098, @AdamBarnhard; #2180, #2109, #1977, #2039, #2062, @smurching; #2013, @aestene; #2146, @joelcthomas; #2161, #2120, #2100, #2095, #2088, #2076, #2057, @juntai-zheng; #2077, #2058, #2027, @sueann; #2149, @zanitete; #2204, #2188, @andychow-db; #2110, #2053, @jdlesage; #2003, #1953, #2004, @Djailla; #2074, @nlml; #2116, @Silas-Asamoah; #1104, @jimthompson5802; #2072, @cclauss; #2221, #2207, #2157, #2132, #2114, #2063, #2065, #2055, @dbczumar; #2033, @cthoyt; #2048, @philip-khor; #2002, @jspoorta; #2000, @christang; #2020, @dependabot[bot])
