...
- Fix Java & R travis build failures (#1722, @dbczumar)
...
- Updated R docs and error message to reflect recent updates. (#1709, @tomasatdatabricks)
- Deprecate `runs` field in  GetExperiment.Response proto (#1647, @dbczumar)

Small bug fixes and doc updates (#1693, @max-allen-db; #1695, #1659, @smurching; #1675, @jdlesage; #1729, #1710, #1700, #1656, @apurva-koti; #1696, @aarondav; #1719, #1663, @dbczumar; #1699, @ankitmathur-db)
