...
- SHAP Explainer Logging Integration (#3989, @vivekchettiar)
- Added tensor input support for ONNX and gluon flavors. (#4041, @tomasatdatabricks)
- Support tensor-based model signatures in schema enforcement (#4084, @wentinghu)
- Eedeleon/release skinny client (#4049, @eedeleon)
...
- support MLeap for R (#3819, @yitao-li)
...
- #4055 allow infer_signature to read pandas ExtensionDtype (#4069, @caleboverman)
- [bug-fix] fix missing client parameter in `mlflow_restore_run()` (#4003, @yitao-li)
- Update type of input json data to `StringIO` (#3921, @Secbone)
