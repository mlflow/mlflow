...
- Add run context for detecting job information when using MLflow tracking APIs (#2205, @dbczumar)
- Added optional prometheus exporter (#2097, @t-henri)
- Add host option to `mlflow ui` CLI command (#2176, @gandroz)
- Support for git submodules. (#2103, @badc0re)
- Add support for LightGBM flavor (#2136, @harupy)
- Add support for XGBoost flavor (#2124, @harupy)
- Adding TensorFlow.Keras and Keras parameter logging (#2119, @juntai-zheng)
- Add Gluon autolog capabilities for simple fitting. (#1973, @cosmincatalin)
- TensorFlow autolog automatic run ending (#2094, @juntai-zheng)
- Fix artifact image viewer to support animated GIF (#2070, @harupy)
- Push orderby and pagination to sql (#2059, @jcuquemelle)
- Added fit_generator hooks for TensorFlow.Keras autolog (#2095, @juntai-zheng)
- [CLI] Add 'models prepare-env' command to explicitly prepare model environments (#2040, @aarondav)
- Enable logging pyspark ml params directly with log batch and log params. (#2064, @tomasatdatabricks)
- Add ability to mount volumes and specify environment variables when using mlflow with docker (#1994, @nlml)
- Expose mlflow.tracking.is_tracking_uri_set() (#2026, @fhoering)
- Push filter function from Python to SQL (#2030, @jcuquemelle)
- [UI] Display "Loading..." when the artifact image viewer is loading an image (#1958, @harupy)

Bug fixes and documentation updates:

- Fix handling of empty directories in fs based artifact repositories. (#1891, @tomasatdatabricks)
- Fix mlflow.keras.save_model with DBFS (#2216, @andychow-db)
- Fix several build issues for the docker image (#2107, @jimthompson5802)
- Fix mlflow_list_artifacts() for the general case (R package) (#2200, @lorenzwalthert)
- Shell-escape entrypoint commands of Kubernetes jobs (#2160, @zanitete)
- fix sqlalchemy sorting that was filtering some runs (#2195, @rom1504)
- Fix project run conda path issue (#2147, @Zangr)
- Fix spark model load from model repository. (#2175, @tomasatdatabricks)
...
- Fixes eprint statement (#2000, @christang)
...
- Tutorials & Examples OSS documentation refactoring (#2182, @juntai-zheng)
...
- Example using prophet via pyfunc (#2043, @dr3s)
- Corrected MLflow spelling (#2078, @dennyglee)
- Add and update some screenshots. More explicit steps. (#2086, @stbof)
- Fix typos in models.rst (#2048, @philip-khor)
- Fixing link to Conda installation instructions. (#1986, @vguerra)
- Update tutorial.rst (#2002, @jspoorta)
- Cleanup examples (mixed-indentation & trailing-whitespace) (#1998, @harupy)
- Fix capitalization of PyPI in README.rst (#2033, @cthoyt)

Small bug fixes and doc updates (#2142, #2121, #2105, #2069, #2083, #2061, #2022, #2036, #1972, #2034, #1959, @harupy; #2202, @t-henri; #2085, @stbof; #2098, @AdamBarnhard; #2180, #2109, #1977, #2039, #2062, @smurching; #2013, @aestene; #2146, @joelcthomas; #2161, #2120, #2100, #2088, #2076, #2057, @juntai-zheng; #2077, #2058, #2027, @sueann; #2149, @zanitete; #2204, #2188, @andychow-db; #2110, #2053, @jdlesage; #2003, #1953, #2004, @Djailla; #2074, @nlml; #2116, @Silas-Asamoah; #1104, @jimthompson5802; #2072, @cclauss; #2221, #2207, #2157, #2132, #2114, #2063, #2065, #2055, @dbczumar; #2020, @dependabot[bot])
