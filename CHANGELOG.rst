...
- ``mlflow.pytorch.log_model`` now supports logging/loading TorchScript models (#3557, @shrinath-suresh) and ``requirements_file`` & ``extra_files`` arguments for logging additional artifacts along with a model (#3436, @shrinath-suresh)
