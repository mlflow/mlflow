...
def test_create_model_version_with_model_id_and_no_run_id(store):
    ...
    with mock.patch("mlflow.store.model_registry.sqlalchemy_store.MlflowClient") as mock_client_class:
        ...
        # Verify that MlflowClient.get_logged_model was called with the correct model_id
