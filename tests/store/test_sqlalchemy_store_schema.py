...
def _assert_schema_files_equal(generated_schema_file, expected_schema_file):
    with open(generated_schema_file, "r") as generated_schema_handle:
        generated_schema = generated_schema_handle.read()
    with open(expected_schema_file, "r") as expected_schema_handle:
        expected_schema = expected_schema_handle.read()
    assert filecmp.cmp(generated_schema_file, expected_schema_file), \
        ...
        "Generated schema:\n{generated_schema}\n" \
        "Expected schema:\n{expected_schema}\n".format(
            expected_file=expected_schema_file, generated_schema=generated_schema,
...
def expected_schema_file():
    ...
    yield os.path.join(current_dir, os.pardir, "resources", "db", "latest_schema.sql")
...
def test_sqlalchemy_store_detects_schema_mismatch(tmpdir, db_url):
