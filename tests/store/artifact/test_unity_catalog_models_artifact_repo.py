...
def test_uc_models_artifact_repo_with_stage_uri_raises(model_uri, expected_error_msg):
    with mock.patch("mlflow.utils._legacy_databricks_cli_utils.get_config"), pytest.raises(
        MlflowException,
...
def test_uc_models_artifact_repo_download_artifacts_uses_temporary_creds_aws():
    ...
    with mock.patch("mlflow.utils._legacy_databricks_cli_utils.get_config"), mock.patch.object(
