...
def test_delete_artifacts(local_artifact_repo):
    with TempDir() as local_dir:
        ...
        assert not os.path.exists(os.path.join(local_artifact_repo._artifact_dir, "nested"))
        assert not os.path.exists(os.path.join(local_artifact_repo._artifact_dir, "a.txt"))
        assert not os.path.exists(os.path.join(local_artifact_repo._artifact_dir, "b.txt"))
