...
def test_query_span_metrics_with_json_encoded_span_type_filter(store: SqlAlchemyStore):
    exp_id = store.create_experiment("test_span_with_json_encoded_type_filter")
