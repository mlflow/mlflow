...
def test_scorer_operations(store: SqlAlchemyStore):
    ...
    def mock_call(self, trace):
        return {"score": 0.5}

    mock_scorer.__call__ = mock_call

    experiment_id = store.create_experiment("test_scorer_experiment")

    with mock.patch("mlflow.genai.scorers.base.Scorer.model_validate", return_value=mock_scorer):
        store.register_scorer(experiment_id, "accuracy_scorer", '{"name": "accuracy_scorer1"}')
        store.register_scorer(experiment_id, "accuracy_scorer", '{"name": "accuracy_scorer2"}')
        store.register_scorer(experiment_id, "accuracy_scorer", '{"name": "accuracy_scorer3"}')

        store.register_scorer(experiment_id, "safety_scorer", '{"name": "safety_scorer1"}')
        store.register_scorer(experiment_id, "safety_scorer", '{"name": "safety_scorer2"}')

        store.register_scorer(experiment_id, "relevance_scorer", '{"name": "relevance_scorer1"}')
    ...
    for scorer in scorers:
        if scorer.scorer_name == "accuracy_scorer":
            ...
            assert scorer._serialized_scorer == '{"name": "accuracy_scorer3"}'
            ...
            assert scorer._serialized_scorer == '{"name": "safety_scorer2"}'
            ...
            assert scorer._serialized_scorer == '{"name": "relevance_scorer1"}'
    ...
    assert accuracy_scorer_versions[0]._serialized_scorer == '{"name": "accuracy_scorer1"}'
    assert accuracy_scorer_versions[1].scorer_version == 2
    assert accuracy_scorer_versions[1]._serialized_scorer == '{"name": "accuracy_scorer2"}'
    assert accuracy_scorer_versions[2].scorer_version == 3
    assert accuracy_scorer_versions[2]._serialized_scorer == '{"name": "accuracy_scorer3"}'
    ...
    assert accuracy_v1._serialized_scorer == '{"name": "accuracy_scorer1"}'
    ...
    assert accuracy_v2._serialized_scorer == '{"name": "accuracy_scorer2"}'
    ...
    assert accuracy_v3._serialized_scorer == '{"name": "accuracy_scorer3"}'
    ...
    assert accuracy_latest_after_partial_delete._serialized_scorer == '{"name": "accuracy_scorer3"}'
    ...
    assert safety_latest_after_delete._serialized_scorer == '{"name": "safety_scorer2"}'
    ...
    assert relevance_latest_after_delete._serialized_scorer == '{"name": "relevance_scorer1"}'
    ...
    scorer_after_update = store.get_scorer(experiment_id, "accuracy_scorer")
    ...
    assert final_scorer.sample_rate == 0.3
