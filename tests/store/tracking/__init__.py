...
class AbstractStoreTest(object):
    ...
    def test_record_logged_model(self):
        ...
        m2 = Model(
            artifact_path="some/other/path", run_id=run_id, flavors={"R": {
                "property": "value"
            }})
        ...
        m3 = Model(
            artifact_path="some/other/path2", run_id=run_id, flavors={"R2": {
                "property": "value"
            }})
        ...
        self._verify_logged(
            ...
            metrics=[],
            tags=[
                RunTag(MLFLOW_LOGGED_MODELS, json.dumps([m.to_dict(),
                                                         m2.to_dict(),
                                                         m3.to_dict()]))
            ])
