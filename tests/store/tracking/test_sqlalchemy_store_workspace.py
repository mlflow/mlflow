...
def test_search_datasets_public_api_is_workspace_scoped(workspace_tracking_store):
    with WorkspaceContext("team-a"):
        ...
        workspace_tracking_store.create_dataset(name="dataset-a", experiment_ids=[exp_a_id])

    with WorkspaceContext("team-b"):
        exp_b_id = workspace_tracking_store.create_experiment("search-exp-b")
        workspace_tracking_store.create_dataset(name="dataset-b", experiment_ids=[exp_b_id])
