...
class SageMakerBackend(BaseBackend):
    ...
    def create_endpoint_config(self, config_name, production_variants, tags, region_name, async_inference_config): 
        """
        ...
        new_config = EndpointConfig(
            config_name=config_name, production_variants=production_variants, tags=tags, async_inference_config=async_inference_config
        )
