...
def test_parse_json_input_records_oriented():
    ...
    records_content, _ = pyfunc_scoring_server._split_data_and_inference_config(records_content)
...
def test_parse_json_input_split_oriented():
    ...
    split_content, _ = pyfunc_scoring_server._split_data_and_inference_config(split_content)
...
def test_records_oriented_json_to_df():
    ...
    """
    jstr, _ = pyfunc_scoring_server._split_data_and_inference_config(jstr)
...
def test_parse_with_schema(pandas_df_with_all_types):
    ...
    json_str, _ = pyfunc_scoring_server._split_data_and_inference_config(json_str)
    ...
    bad_df, _ = pyfunc_scoring_server._split_data_and_inference_config(bad_df)
    ...
    assert all(df["bad_integer"] == [2147483647, 2147483647, 2147483647])
