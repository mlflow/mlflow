...
def test_trace_to_proto_v4_and_from_proto_v4():
    ...
    proto_trace_v4 = trace.to_proto_v4()

    assert proto_trace_v4.trace_info.trace_id == trace.info.trace_id
    assert len(proto_trace_v4.spans) == len(trace.data.spans)

    reconstructed_trace = Trace.from_proto_v4(proto_trace_v4)
