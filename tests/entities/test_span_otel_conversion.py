...
class TestSpanOTelConversion:
    """Test suite for Span <-> OTel protobuf conversion."""

    @pytest.fixture
    def sample_otel_span(self):
    ...
    def test_status_conversion(self, status_code, status_desc, expected_code, expected_desc):
        ...
        assert mlflow_status.description == (
            status_desc if status_code == OTelStatusCode.ERROR else ""
        )
    ...
    def test_proto_status_conversion(self, proto_code, expected_mlflow_code, expected_otel_code):
    ...
    def test_attribute_conversion(self, attributes):
    ...
    def test_span_to_otel_proto_conversion(self, sample_otel_span):
    ...
    def test_span_from_otel_proto_conversion(self):
    ...
    def test_roundtrip_conversion(self, sample_otel_span):
    ...
    def test_span_event_otel_conversion(self, event_attrs):
