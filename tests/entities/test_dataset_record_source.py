...
def test_dataset_record_source_creation():
    source1 = DatasetRecordSource(
        source_type="TRACE",
        source_data={"trace_id": "trace123", "span_id": "span456"}
    )
...
def test_dataset_record_source_to_from_proto():
    source = DatasetRecordSource(
        source_type="CODE",
        source_data={"file": "example.py", "line": 42}
    )
...
def test_dataset_record_source_equality():
    ...
    source3 = DatasetRecordSource(
        source_type="TRACE",
        source_data={"trace_id": "trace456"}
    )
    
    source4 = DatasetRecordSource(
        source_type="HUMAN",
        source_data={"trace_id": "trace123"}
    )
