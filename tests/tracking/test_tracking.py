...
def test_log_artifact(tmp_path):
    # Create artifacts
    path0 = tmp_path.joinpath("file0")
    path1 = tmp_path.joinpath("file1")
    path0.write_text("0")
    path1.write_text("1")
    ...
    for parent_dir in artifact_parent_dirs:
        with start_run():
            ...
            mlflow.log_artifacts(tmp_path, parent_dir)
        ...
        dir_comparison = filecmp.dircmp(tmp_path, expected_artifact_output_dir)
