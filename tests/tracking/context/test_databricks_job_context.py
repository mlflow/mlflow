...
def test_databricks_job_run_context_tags():
    ...
    with patch_job_id as job_id_mock, patch_job_run_id as job_run_id_mock, patch_job_type as job_type_mock, patch_webapp_url as webapp_url_mock:  # pylint: disable=line-too-long
