...
def test_databricks_notebook_run_context_in_context():
    with mock.patch("mlflux.utils.databricks_utils.is_in_databricks_notebook") as in_notebook_mock:
...
def test_databricks_notebook_run_context_tags():
    patch_notebook_id = mock.patch("mlflux.utils.databricks_utils.get_notebook_id")
    patch_notebook_path = mock.patch("mlflux.utils.databricks_utils.get_notebook_path")
...
def test_databricks_notebook_run_context_tags_nones():
    patch_notebook_id = mock.patch(
        "mlflux.utils.databricks_utils.get_notebook_id", return_value=None
    )
    patch_notebook_path = mock.patch(
        "mlflux.utils.databricks_utils.get_notebook_path", return_value=None
    )
