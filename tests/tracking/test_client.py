...
from tests.tracing.conftest import is_async  # noqa: F401
...
def test_start_and_end_trace(tracking_uri, with_active_run, is_async):
...
def test_log_trace_with_databricks_tracking_uri(
    databricks_tracking_uri, mock_store_for_tracing, monkeypatch, is_async
):
