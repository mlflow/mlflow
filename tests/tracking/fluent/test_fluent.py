...
def test_start_run_defaults(empty_active_run_stack):  # pylint: disable=unused-argument
    ...
    with experiment_id_patch, databricks_notebook_patch, user_patch, source_name_patch, source_type_patch, source_version_patch, create_run_patch:  # pylint: disable=line-too-long
...
def test_start_run_defaults_databricks_notebook(
    ...
    with experiment_id_patch, databricks_notebook_patch, user_patch, source_version_patch, notebook_id_patch, notebook_path_patch, webapp_url_patch, create_run_patch:  # pylint: disable=line-too-long
        active_run = start_run()
        MlflowClient.create_run.assert_called_once_with(
            experiment_id=mock_experiment_id, tags=expected_tags
        )
...
def test_start_run_with_parent():
    ...
    with databricks_notebook_patch, active_run_stack_patch, create_run_patch, user_patch, source_name_patch:  # pylint: disable=line-too-long
