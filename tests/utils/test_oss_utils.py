...
def test_get_oss_host_creds():
    # When the scheme is "uc" and the new scheme is not "_DATABRICKS_UNITY_CATALOG_SCHEME"
...
def test_get_databricks_host_creds():
    # When the scheme is "uc" and the new scheme is "_DATABRICKS_UNITY_CATALOG_SCHEME"
