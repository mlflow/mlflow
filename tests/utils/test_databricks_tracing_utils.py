...
def test_assessment_to_proto():
    ...
    assert proto_v4.trace_identifier.trace_id == "trace123"
    assert proto_v4.trace_identifier.trace_location.uc_schema.catalog_name == "catalog"
    assert proto_v4.trace_identifier.trace_location.uc_schema.schema_name == "schema"
    ...
    assert proto_v4_exp.trace_identifier.trace_id == "trace789"
    assert proto_v4_exp.trace_identifier.trace_location.uc_schema.catalog_name == "main"
    assert proto_v4_exp.trace_identifier.trace_location.uc_schema.schema_name == "default"
