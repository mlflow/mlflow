...
def test_trace_location_from_proto():
...
def test_trace_info_to_proto():
    ...
    trace_info = TraceInfo(
        trace_id=trace_id,
        trace_location=TraceLocation.from_uc_schema(catalog_name="catalog", schema_name="schema"),
        request_time=0,
        state=TraceState.OK,
...
def test_trace_info_from_proto_handles_uc_schema_location():
    ...
    proto = pb.TraceInfo(
        ...
        trace_location=trace_location_to_proto(
            TraceLocation.from_uc_schema(catalog_name="catalog", schema_name="schema")
        ),
