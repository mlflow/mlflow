...
def test_model_save_with_cloudpickle_format_adds_cloudpickle_to_conda_environment(
    ...
    pip_deps = [
        dependency for dependency in saved_conda_env_parsed["dependencies"]
...
@pytest.mark.large
def test_load_pyfunc_succeeds_for_older_models_with_pyfunc_data_field(sklearn_knn_model,
                                                                      model_path):
    """
