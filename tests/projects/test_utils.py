...
from mlflow.projects.utils import (_get_storage_dir, _is_valid_branch_name, _is_zip_uri,
                                   _fetch_project, _parse_subdirectory, get_or_create_run,
                                   fetch_and_validate_project, load_project)
from mlflow.utils.mlflow_tags import MLFLOW_PROJECT_ENTRY_POINT, MLFLOW_SOURCE_NAME
from tests.projects.utils import (assert_dirs_equal, GIT_PROJECT_URI, TEST_PROJECT_DIR,
                                  TEST_PROJECT_NAME)
...
def test_fetch_create_and_log(tmpdir):
    ...
    mock_fetched_project = _project_spec.Project(None, {entry_point_name: entry_point}, None,
                                                 "my_project")
