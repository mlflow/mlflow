...
def find_python_env_yaml(directory):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Path("lightgbm", "lightgbm_sklearn"), ["python", "train.py"]),
        ...
        (Path("xgboost", "xgboost_sklearn"), ["python", "train.py"]),
