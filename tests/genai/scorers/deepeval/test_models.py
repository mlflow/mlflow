...
def test_native_model_forwards_kwargs_to_complete_prompt():
    with patch("mlflow.genai.scorers.llm_backend.ScorerLLMClient.complete_prompt", return_value="output") as mock_complete:
        model = create_deepeval_model("databricks", model_kwargs={"temperature": 0.0, "max_tokens": 512})
