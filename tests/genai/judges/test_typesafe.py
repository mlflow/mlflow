...
def test_generic_structured_chat_rejects_typesafe():
    class Output(pydantic.BaseModel):
        value: str

    with pytest.raises(MlflowException, match="do not support generic structured chat"):
        get_chat_completions_with_structured_output(
            model_uri="typesafe:/jev-latest",
            messages=[ChatMessage(role="user", content="Extract a value")],
