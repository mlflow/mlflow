...
class TestOptimizerIntegration:
    ...
    def test_optimizer_hierarchy(self):
    ...
    def test_simba_optimizer_workflow(self, mock_judge, sample_traces_with_assessments):
    ...
    def test_multiple_optimizers_independence(self):
    ...
    def test_judge_integration(self, mock_judge, sample_traces_with_assessments):
    ...
    def test_error_propagation(self, mock_judge):
        """Test that errors are properly propagated through the system."""
        optimizer = SIMBAAlignmentOptimizer()
        
        # Test with empty traces
        with pytest.raises(Exception):  # Should raise MlflowException
            optimizer.align(mock_judge, [])
    
    def test_trace_processing_consistency(self, mock_judge, sample_traces_with_assessments):
