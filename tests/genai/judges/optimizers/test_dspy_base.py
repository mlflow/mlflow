...
def test_extract_request_from_trace(sample_trace_with_assessment):
...
def test_extract_response_from_trace(sample_trace_with_assessment):
...
def test_align_success(mock_judge, sample_traces_with_assessments):
