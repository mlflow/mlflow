...
def test_registry_invokes_skill_tool_with_skill_set(skill_set):
    ...
    result = registry.invoke(tool_call=tool_call, trace=None, skill_set=skill_set)
...
def test_registry_invokes_trace_tool_with_trace(trace):
    ...
    result = registry.invoke(tool_call=tool_call, trace=trace, skill_set=None)
