...
class TestParseDatabricksModelResponse:
    """Test _parse_databricks_model_response function."""
    ...
    def test_parse_invalid_reasoning_response(self, invalid_content):
...
class TestInvokeDatabricksModel:
    """Test _invoke_databricks_model function."""

    @mock.patch("mlflow.utils.databricks_utils.get_databricks_host_creds")
    @mock.patch("mlflow.genai.judges.utils.requests.post")
    def test_successful_invocation(self, mock_post, mock_get_creds):
    ...
    @mock.patch("mlflow.utils.databricks_utils.get_databricks_host_creds")
    @mock.patch("mlflow.genai.judges.utils.requests.post")
    def test_bad_request_error_no_retry(self, mock_post, mock_get_creds):
    ...
    def test_retry_logic_with_transient_errors(self, mock_sleep, mock_post, mock_get_creds):
    ...
    @mock.patch("mlflow.utils.databricks_utils.get_databricks_host_creds")
    @mock.patch("mlflow.genai.judges.utils.requests.post")
    def test_json_decode_error(self, mock_post, mock_get_creds):
    ...
    @mock.patch("mlflow.genai.judges.utils.requests.post")
    @mock.patch("mlflow.genai.judges.utils.time.sleep")
    def test_connection_error_with_retries(self, mock_sleep, mock_post, mock_get_creds):
...
class TestTelemetryRecording:
    """Test telemetry recording functions."""
    ...
    def test_record_success_telemetry_with_databricks_agents(
        self, mock_job_run_id, mock_job_id, mock_workspace_id, mock_experiment_id
    ):
    ...
    def test_record_success_telemetry_without_databricks_agents(self):
...
class TestInvokeJudgeModelDatabricks:
    """Test invoke_judge_model with Databricks provider integration."""
    ...
    def test_invoke_judge_model_databricks_success_not_in_databricks(
        self, mock_invoke_db, mock_in_db
    ):
    ...
    def test_invoke_judge_model_databricks_success_in_databricks(
        self, mock_success_telemetry, mock_invoke_db, mock_in_db
    ):
    ...
    def test_invoke_judge_model_databricks_failure_in_databricks(
        self, mock_failure_telemetry, mock_invoke_db, mock_in_db
    ):
