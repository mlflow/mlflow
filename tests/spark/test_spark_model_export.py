...
def test_hadoop_filesystem(tmpdir):
    ...
    from mlflow.sparkml import _HadoopFileSystem as FS
...
def test_model_export(spark_model_iris, model_path, spark_conda_env):
    ...
    print(os.listdir(SPARKML_DFS_TMP))
    assert not os.listdir(SPARKML_DFS_TMP)
    ...
    for should_start_run in [False, True]:
        for dfs_tmp_dir in [None, os.path.join(str(tmpdir), "test")]:
            ...
            try:
                ...
                x = dfs_tmp_dir or SPARKML_DFS_TMP
