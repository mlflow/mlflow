...
def test_run_access_controls_across_workspaces(workspace_setup, monkeypatch):
    ...
    with User(ADMIN_USERNAME, ADMIN_PASSWORD, monkeypatch):
        client.set_workspace_permission(workspace_a, username, "experiments", "MANAGE")
        client.set_workspace_permission(workspace_b, username, "experiments", "MANAGE")
    ...
    with User(ADMIN_USERNAME, ADMIN_PASSWORD, monkeypatch):
        client.set_workspace_permission(workspace_a, limited_user, "experiments", "READ")
...
def test_registered_model_access_controls_across_workspaces(workspace_setup, monkeypatch):
    ...
    with User(ADMIN_USERNAME, ADMIN_PASSWORD, monkeypatch):
        client.set_workspace_permission(workspace_a, username, "experiments", "MANAGE")
        client.set_workspace_permission(workspace_a, username, "registered_models", "MANAGE")
        client.set_workspace_permission(workspace_b, username, "experiments", "MANAGE")
        client.set_workspace_permission(workspace_b, username, "registered_models", "MANAGE")
    ...
    limited_user, limited_password = create_user(tracking_uri)
    with User(ADMIN_USERNAME, ADMIN_PASSWORD, monkeypatch):
        client.set_workspace_permission(workspace_a, limited_user, "registered_models", "READ")
        client.set_workspace_permission(workspace_a, limited_user, "experiments", "READ")
