...
`,
      ...
      ((t.stemmer = (function () {
        var e = {
          ...
          n = { icate: 'ic', ative: '', alize: 'al', iciti: 'ic', ical: 'ic', full: '', ness: '' },
          r = '[^aeiou]',
          i = '[aeiouy]',
          s = r + '[^aeiouy]*',
          o = i + '[aeiou]*',
          ...
          W = /^(.+?)(icate|ative|alize|iciti|ical|full|ness)$/,
          B = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|meant|ent|ou|ism|ate|iti|ous|ive|ize)$/,
          z = /^(.+?)(s|t)(ion)$/,
          _ = /^(.+?)e$/,
          U = /ll$/,
          J = new RegExp('^' + s + i + '[^aeiouwxy]$'),
