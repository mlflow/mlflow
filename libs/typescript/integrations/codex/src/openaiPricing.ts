...
export const OPENAI_MODEL_RATES: Readonly<Record<string, OpenAIModelRate>> = {
  ...
  'chatgpt-image-latest': { input: 5, output: 10, cacheRead: 1.25 },
  ...
  'gpt-5.5-cyber': { input: 12.5, output: 75, cacheRead: 1.25 },
  ...
  'gpt-rosalind-research': { input: 5, output: 25, cacheRead: 0.5 },
